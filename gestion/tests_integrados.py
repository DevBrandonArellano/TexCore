...
class UnifiedBusinessLogicTestCase(APITestCase):
    ...
    def test_empaquetado_consumo_insumos_v2(self):
        ...
        2. El endpoint de etiqueta ZPL devuelve una etiqueta válida con el código de lote.

        Nota: el consumo automático de insumos que este test verificaba originalmente
        se eliminó de RegistroLoteService en la Fase 3 del proyecto (ver comentario más
        abajo) — ya no se ejercita aquí.
        """
