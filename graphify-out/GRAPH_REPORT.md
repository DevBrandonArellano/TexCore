...
## Corpus Check
- 576 files · ~775,567 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6795 nodes · 17383 edges · 413 communities (341 shown, 72 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 5026 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2125cdc7`
...
Cohesion: 0.02
Nodes (146): react, TransformationView(), AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage() (+138 more)

### Community 1 - "Maquina"
Cohesion: 0.03
Nodes (90): Group, InventoryDashboard(), fakeBlob, mockBodegas, mockProductos, navigateToReportes(), renderDashboard(), toastErrorMock (+82 more)

### Community 2 - "OrdenProduccion"
Cohesion: 0.11
Nodes (67): AuditLog, AuditoriaMovimiento, DetalleHistorialDespacho, DetalleHistorialDespachoPedido, HistorialDespacho, OrdenCompraSugerida, Registra cada modificación realizada a un MovimientoInventario.     Permite traz, Registra la necesidad calculada de un material para cumplir con la producción o (+59 more)

### Community 3 - "Bodega"
Cohesion: 0.09
Nodes (23): Batch, FaseReceta, ProcessStep, AreaSerializer, BatchSerializer, DetalleFormulaSerializer, DosificacionSerializer, FormulaColorSerializer (+15 more)

### Community 4 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.07
Nodes (45): ApprovalRequests(), BuscadorLotes(), ROLES_SUPERVISOR, PackagingFormValues, packagingSchema, AreaMovementsTable(), InventoryFormProps, InventoryHistory() (+37 more)

### Community 5 - "NotaVentaRequest"
Cohesion: 0.03
Nodes (79): BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Command, BaseCommand, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_ (+71 more)

### Community 6 - "AuditLog"
Cohesion: 0.03
Nodes (38): get_user_role(), CustomUserFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProductoViewSetMultiTenancyTestCase, ProveedorViewSetMultiTenancyTestCase (+30 more)

### Community 7 - "BodegaFactory"
Cohesion: 0.05
Nodes (25): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, ParoMaquinaFactory, KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase (+17 more)

### Community 8 - "JefeAreaDashboard.tsx"
Cohesion: 0.04
Nodes (15): StockBodegaFactory, LoteProduccionViewSetTestCase, _make_service_token(), Pruebas complementarias de internal_api/views/reporting_views.py — cubre las 14, MovimientoMermaCreateTestCase, TestCase, MovimientoDestroyTestCase, TestCase (+7 more)

### Community 9 - "LoteProduccion"
Cohesion: 0.13
Nodes (57): Group, AuditoriaDialogProps, EditarMovimientoDialogProps, EliminarMovimientoDialogProps, ItemIncompleto, ScannedItem, DetalleHistorial, HistorialDespacho (+49 more)
...
Cohesion: 0.04
Nodes (26): EventoEtiqueta, Registro inmutable del ciclo de vida de cada etiqueta física impresa para un lot, EventoEtiquetaFactory, OrdenProduccionFactory, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Trans, ISTQB STT — Transiciones legales en la máquina de estados., El modelo actual permite pendiente → finalizada (no tiene validación de estado). (+18 more)

### Community 12 - "App.tsx"
Cohesion: 0.03
Nodes (53): App(), AppContent(), mockAuthState, AdminSistemasDashboard(), showApiError(), AuditoriaDialog(), LOG_1, mockGet (+45 more)

### Community 13 - "ClienteFactory"
Cohesion: 0.10
Nodes (31): COLORS, Props, ESTADO_BADGE, ManageLineas(), ManageLineasProps, ESTADO_BADGE, ManageMaquinas(), ManageMaquinasProps (+23 more)

### Community 14 - "SedeFactory"
Cohesion: 0.04
Nodes (30): AreaFactory, ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, MaquinaFactory, MaquinaOeeActionTestCase, ParoMaquinaModelTestCase, ParoMaquinaViewSetTestCase, TestCase (+22 more)
...
Cohesion: 0.06
Nodes (41): Environment, PlainTextResponse, Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo. (+33 more)
...
Cohesion: 0.04
Nodes (57): Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente en, CostoHoraMaquina, LoteProduccion, Tarifa vigente de un operario; vigente_hasta NULL = sin fecha de fin., Costo operativo por hora de maquina (amortizacion + energia + mantto)., TarifaOperario, CostoLoteService, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-CosteoLoteProduccion (F0-002) (+49 more)

### Community 19 - "TintoreroRBACTestCase"
Cohesion: 0.04
Nodes (24): ClienteFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de Eq, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_cr, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3)., EP Clase Inválida + BVA: -0.001 viola el CheckConstraint de BD.         La restr (+16 more)

### Community 20 - "cn"
Cohesion: 0.12
Nodes (13): Template Method: secuencia fija revertir → descargar.         Se usa al modifica, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator., DescargaQuimicosStockInsuficienteTestCase, APITestCase, BVA límite exacto: stock 10 kg, requiere 10 kg → éxito, stock final 0., BVA límite - 0.01: stock 9.99 kg, requiere 10 kg → ValidationError., STT rollback: fórmula con 2 químicos; el primero tiene stock de sobra,         e, La descarga debe validar disponibilidad ANTES de descontar. (+5 more)
...
Cohesion: 0.05
Nodes (39): Bodega, Decimal, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en lo, Registra la recepción de un lote de materia prima del proveedor.          Crea e, Si el movimiento de Kardex falla, ni MP ni stock persisten., Ajusta stock de salida/entrada/químicos cuando el peso neto de un lote cambia. (+31 more)
...
Cohesion: 0.15
Nodes (4): APIView, UserProfileView, CustomUserSerializer, Ejecutivos tienen acceso a todo el dashboard de stock: asignar todas las bodegas
...
### Community 52 - ".get"
Cohesion: 0.04
Nodes (45): DjangoModelFactory, BodegaFactory, DetalleFormulaFactory, FaseRecetaFactory, FormulaColorFactory, Meta, ProductoFactory, Factories para tests de TexCore — usa factory_boy.  Convención: - Cada factory c (+37 more)
...
### Community 59 - "_audit"
Cohesion: 0.09
Nodes (23): 10 de Julio de 2026, 13 de Julio de 2026, 1 de Julio de 2026, 22 de Julio de 2026, 22 de Julio de 2026 (2), 22 de Julio de 2026, 22 de Julio de 2026 (3), 23 de Julio de 2026 (+15 more)
...
Cohesion: 0.23
Nodes (13): _audit(), _build_balance_masas_payload(), _build_reporte_avance_payload(), _get_printing_url(), _now_iso(), _proxy_pdf(), Request, Vistas de generación de PDFs de producción para internal_api.  Arquitectura:   - (+5 more)
...
Cohesion: 0.11
Nodes (11): ProduccionKPIService, date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0)         p, Calcula KPIs de producción filtrados opcionalmente por sede.      Uso:         s, Punto de entrada único — Fachada sobre los métodos privados., ProduccionKPIServiceTendenciaTest (+3 more)
...
Cohesion: 0.12
Nodes (5): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 2700, JWTServiceAuthenticationExtraTestCase, TestCase, APITestCase, TestPdfProduccionViews
...
Cohesion: 0.10
Nodes (15): 1. Estado Actual del Sistema, 2. Decisión Arquitectónica, 3. Directrices de Implementación Técnica (Frontend), 4. Impacto en el Backend (Django), 5. Flujo de Trabajo Esperado para el Usuario Final, 6. Instrucciones para el Agente de IA (Directiva de Generación de Código), Documento de Contexto y Decisión Arquitectónica: TexCore — Sistema de gestión de órdenes de producción, 📊 Análisis, Normas y Trazabilidad (+7 more)
...
Cohesion: 0.06
Nodes (26): clear_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), Proveedor, make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la d, Factory para crear clases de permiso basadas en grupos de Django.      Otorga ac, ProductoSerializer (+18 more)
...
Cohesion: 0.03
Nodes (64): AREA_1, AREA_3, BODEGA_1, BODEGA_3, CLIENTE_1, crearSedeSinSeleccionarla(), FORMULA_1, GROUP_1 (+56 more)

### Community 87 - "dependencies"
Cohesion: 0.23
Nodes (11): ReetiquetarModal(), SUPERVISOR_ROLES, ReimprimirModal(), abrirPdfParaImprimir(), BrowserPrintApi, BrowserPrintDevice, getDefaultZebraDevice(), printLabel() (+3 more)
...
Cohesion: 0.05
Nodes (74): BaseAuthentication, AuditLogger, AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, Registra en log estructurado (RFC 5424) cada acceso a la API interna     con ide, JWTServiceAuthentication, Request, JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación. (+66 more)
...
Cohesion: 0.13
Nodes (23): get_current_ip(), get_current_user(), AuditableModelMixin, _get_object_sede_id(), Mixin para auditar cambios. Guarda estados y emite AuditLogs en save/delete., Validaciones de negocio que requieren contexto de auditoría.         Se llama au, Obtiene sede_id del objeto para filtrar logs de entidades eliminadas.     Priori, audit_user_delete() (+15 more)
...
Cohesion: 0.07
Nodes (11): Crea el despacho (HistorialDespacho + detalles + MovimientoInventario VENTA)., Revierte un pago deshaciendo el abono registrado.          Validaciones:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueErro, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - Múlt, Caso 4: Reversión es transaccional          Verifica:         - Si falla un paso, Caso 1: Revertir pago restaura deuda del cliente          Verifica:         - De, STT: pedido1 ANULADO (1000) + pedido2 activo (500); pago de 500.         El pago, P0-005: pago + reconciliación en una sola transacción, con lock         pesimist (+3 more)
...
Cohesion: 0.04
Nodes (47): 10. RENDIMIENTO Y BASE DE DATOS, 11. MATRIZ DE HALLAZGOS, 13. MÉTRICAS DE DEUDA TÉCNICA, 1. RESUMEN EJECUTIVO, 2. ALCANCE Y METODOLOGÍA, 4. HALLAZGOS DE SEGURIDAD — OWASP TOP 10, 6. CONSISTENCIA DEL PROYECTO, 8. GOBIERNO DE TI — COBIT 2019 (+39 more)
...
Cohesion: 0.67
Nodes (3): 21 de Julio de 2026, Fase 0 — Corrección de regla de negocio: creación de OP es exclusiva del Jefe de Planta, R4 — OEE completo: modelo ParoMaquina (Seis Grandes Pérdidas), OeeService, KPI y UI
...
Cohesion: 0.07
Nodes (102): AreaProcessStep, ComponenteMezclaOP, ConsumoLoteDetalle, ConsumoMateriaPrima, CostoLoteProduccion, DescargaQuimicoOP, DetalleFormula, EtapaProduccion (+94 more)
...
Cohesion: 0.25
Nodes (4): Aislamiento por área/sede: admins y jefe de planta ven todo; el         jefe de, Registra una transformación (un paso de máquina) en la OP.          Solo Jefe de, Lista las transformaciones de la OP en orden de secuencia., Devuelve el flujo completo de la OP: pasos, mermas y siguiente área.
...
### Community 262 - "0038_merge_20260316_1447.py"
Cohesion: 0.40
...
### Community 263 - "0039_cliente_sede_producto_sede_and_more.py"
Cohesion: 0.40
...
### Community 281 - "0057_remove_cliente_cli_activo_idx_and_more.py"
Cohesion: 0.40
...
### Community 286 - "0061_add_transformacion_fields.py"
Cohesion: 0.50
...
### Community 293 - "0069_costeo_lote_produccion.py"
Cohesion: 0.50
...
### Community 296 - "0072_etapaproduccion_transferenciainterarea.py"
Cohesion: 0.50
...
Cohesion: 0.03
Nodes (83): AbstractUser, Command, BaseCommand, Management command to seed production master roles and permissions for a clean T, Command, BaseCommand, Pobla clientes, pedidos de venta y pagos para probar el dashboard de Ventas (eje, Cliente (+75 more)
...
### Community 325 - ".duracion_minutos"
Cohesion: 0.40
...
### Community 328 - ".get_porcentaje_pagado"
Cohesion: 0.17
...
### Community 358 - "TestValidateEndpoint_LoteValido"
Cohesion: 0.67
Nodes (3): Patron DjangoReportRepository, Servicio Satélite: reporting_excel, Variables de Entorno

## Knowledge Gaps
- **1592 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1587 more)
...
- **Why does `CustomUserFactory` connect `AuditLog` to `AuditRepository`, `vitest`, `RFC5424Formatter`, `BodegaFactory`, `RangoFechaParams`, `TestServiceTokenView`, `JefeAreaDashboard.tsx`, `CustomUserFactory`, `JWTTokenManager`, `SedeFactory`, `TintoreroRBACTestCase`, `.get`, `cn`, `reporting_views.py`, `CustomUserSerializer`, `reporting_proxy.py`, `.calcular_costo`, `custom_jwt_views.py`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `PedidoVenta` connect `.test_kardex_con_filtro_proveedor_y_campos_adicionales` to `OrdenProduccion`, `Bodega`, `NotaVentaRequest`, `JefeAreaDashboard.tsx`, `CustomUserFactory`, `StockBodega`, `TintoreroRBACTestCase`, `sidebar.tsx`, `AuditRepository`, `RFC5424Formatter`, `DjangoApiClient`, `class-variance-authority`, `@radix-ui/react-checkbox`, `custom_jwt_views.py`, `@radix-ui/react-dialog`, `ProduccionKPIService`, `get_current_user`, `recharts`, `test_vendedores.py`, `JWTTokenManager`, `TestReportingEndpoints`, `ExcelFormatter`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `LoteProduccion` connect `StockBodega` to `OrdenProduccion`, `Bodega`, `NotaVentaRequest`, `JefeAreaDashboard.tsx`, `CustomUserFactory`, `InventoryDashboard.tsx`, `sidebar.tsx`, `RFC5424Formatter`, `DjangoApiClient`, `class-variance-authority`, `.test_kardex_con_filtro_proveedor_y_campos_adicionales`, `.get`, `@radix-ui/react-checkbox`, `produccion_kpi_service.py`, `ProduccionKPIService`, `DjangoReportRepository`, `devDependencies`, `recharts`, `test_vendedores.py`, `JWTTokenManager`, `ExcelFormatter`, `CustomUserSerializer`?**
