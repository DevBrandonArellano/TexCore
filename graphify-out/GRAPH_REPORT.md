...
## Corpus Check
- 646 files · ~410,115 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6518 nodes · 15217 edges · 506 communities (345 shown, 161 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 4120 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cc822e3a`
...
- ApprovalRequests.test.tsx
- AreaMovementsTable.test.tsx
- InventoryHistory.test.tsx
- popover.tsx
- verificar_auditoria.py
- 0020_create_tintorero_group.py
- FrontendLogView
- KardexSerializer
- .format
- deploy.sh script
...
- Migration
- 0064_backfill_producto_salida.py
- InternalApiConfig
...
- 0003_producto_calidad_producto_pais_origen_and_more.py
- 0004_cliente_saldo_pendiente_cliente_tiene_beneficio_and_more.py
- 0005_customuser_bodegas_asignadas.py
- 0007_remove_cliente_saldo_pendiente_and_more.py
- 0008_producto_precio_base.py
- 0009_loteproduccion_peso_bruto_and_more.py
- 0010_pagocliente.py
- 0011_ordenproduccion_fecha_fin_planificada_and_more.py
- 0012_ordenproduccion_operario_asignado.py
- 0013_ordenproduccion_area.py
- 0014_maquina_operarios.py
- 0015_create_reporting_sps.py
- 0016_create_seller_reporting_sps.py
- 0017_add_credit_terms_and_due_date.py
- 0018_update_deudores_sp.py
- 0019_formulas_quimicas_v2.py
- 0021_proveedor.py
- 0022_descarga_quimico_op.py
- 0022_update_seller_reporting_sps_iva.py
- 0023_detallepedido_subtotal_detallepedido_total_con_iva_and_more.py
- 0024_remove_formulacolor_productos_auditlog_fasereceta_and_more.py
- 0025_loteproduccion_cantidad_metros.py
- 0026_cliente_is_active.py
- 0029_deudores_sp_rename_documento_to_ruc.py
- 0030_pedidoventa_fecha_pedido_datetime.py
- 0031_ventas_sp_fecha_como_texto.py
- 0032_ventas_sp_include_full_fecha_fin.py
- 0033_reportes_orden_por_id.py
- 0035_revert_sp_sin_nro.py
- 0036_merge_20260312_1702.py
- 0037_gerencial_reporting_sps.py
- 0038_merge_20260316_1447.py
- 0039_cliente_sede_producto_sede_and_more.py
- 0040_add_cliente_producto_sede_db.py
- 0041_add_sede_to_proveedor_and_formula.py
- 0042_pedidoventa_idx_pedido_vendedor_fecha_incl.py
- 0043_pedidoventa_valor_retencion.py
- 0044_ventas_sp_incluye_retencion.py
- 0045_sp_ordenamiento.py
- 0046_sps_gerencial_y_sedes.py
- 0047_sps_gerencial_filtro_sede.py
- 0048_auditlog_object_sede_id.py
- 0049_auditlog_content_object_index.py
- 0050_ordenproduccion_peso_neto_positivo.py
- 0051_remove_auditlog_idx_audit_object_fecha.py
- 0052_pedidoventa_anulacion.py
- 0053_merge_migrate_heads.py
- 0054_merge_20260505_1955.py
- 0055_add_critical_indexes.py
- 0058_alter_producto_tipo.py
- 0059_loteproduccion_clasificacion_calidad_and_more.py
- 0060_ordenproduccion_prioridad.py
- 0060_rename_producto_and_bodega.py
- 0061_add_transformacion_fields.py
- 0062_componentemezclaop.py
- 0063_consumolotedetalle.py
- 0065_merge_20260603_1339.py
- 0066_maquina_bodega_entrada_maquina_bodega_salida_and_more.py
- 0067_pagocliente_es_anticipo_pedidoventa_monto_pagado.py
- 0068_materia_prima_trazabilidad.py
- 0069_costeo_lote_produccion.py
- 0070_alter_materiaprimalote_bodega_recepcion.py
- 0071_areaprocessstep_ordenproduccionsubproceso.py
- 0072_etapaproduccion_transferenciainterarea.py
- 0073_transformacion_producto.py
...
- ._derivar_producto_entrada
- 0074_lineaproduccion.py
- .duracion_minutos
- .genealogia
...
- 0005_cascade_stock_lote.py
- 0006_add_historial_despacho.py
- 0007_movimientoinventario_estado_and_more.py
- 0008_remove_movimientoinventario_estado_and_more.py
- 0009_stock_bodega_report_sp.py
- 0010_alter_sp_getkardexbodega.py
- 0011_movimientoinventario_calidad_and_more.py
- 0012_alter_sp_getkardexbodega_optional_product.py
- 0013_update_kardex_sp_filters.py
- 0014_detallehistorialdespachopedido_and_more.py
- 0015_ordencomprasugerida_requerimientomaterial.py
- 0016_create_mrp_sp.py
- 0017_reporting_sps.py
- 0018_additional_indexes.py
- 0019_sp_stock_cero_bodega.py
- 0020_produccion_reporting_sps.py
- 0020_remove_movimientoinventario_idx_mov_tipo_fecha_and_more.py
- 0021_fix_sp_get_inventario_aging.py
- 0022_sp_get_inventario_aging_bucket_filter.py
- 0023_merge_20260415_1345.py
- 0023_merge_20260421_1448.py
- 0024_merge_20260423_1619.py
- 0025_fix_produccion_reporting_sps_auth_user.py
- 0026_fix_produccion_reporting_sps_customuser.py
- 0027_alter_movimientoinventario_tipo_movimiento.py
- 0028_historialdespacho_items_no_despachados.py
- 0029_detallehistorialdespacho_movimiento_venta.py
- 0030_estandarizar_decimales_tres_lugares.py
- 0031_protocolo_tres_fases.py
- .validate
...
1. `CustomUserFactory` - 252 edges
2. `cn()` - 221 edges
3. `Producto` - 207 edges
4. `PedidoVenta` - 203 edges
5. `LoteProduccion` - 195 edges
6. `Bodega` - 193 edges
7. `Sede` - 157 edges
8. `CustomUser` - 151 edges
9. `OrdenProduccion` - 150 edges
10. `SedeFactory` - 144 edges

## Surprising Connections (you probably didn't know these)
- `DetalleHistorialDespachoPedidoSerializer` --uses--> `AuditLog`  [INFERRED]
  inventory/serializers.py → gestion/models.py
- `DetalleHistorialDespachoSerializer` --uses--> `AuditLog`  [INFERRED]
  inventory/serializers.py → gestion/models.py
...
## Communities (506 total, 161 thin omitted)

### Community 0 - "Producto"
Cohesion: 0.02
Nodes (170): input-otp, react, TransformationView(), AccordionContent(), AccordionItem(), AccordionTrigger(), Alert(), AlertDescription() (+162 more)

### Community 1 - "Maquina"
Cohesion: 0.04
Nodes (25): DescargaQuimicosOPTestCase, FormulaQuimicaTestCase, APITestCase, Suite de pruebas para el modulo de Formulas Quimicas.     Cubre: calculo de dos, Para kg_tela=100 y relacion_bano=10:             volumen = 1000 L, Para kg_tela=100 y relacion_bano=10:             sal (60%): cantidad = (100 * 6, Verifica que kg_tela <= 0 o relacion_bano <= 0 retornen 400., Crear una formula con el mismo quimico dos veces debe retornar 400         con (+17 more)

### Community 2 - "OrdenProduccion"
Cohesion: 0.11
Nodes (91): Area, AreaProcessStep, AuditableModelMixin, Batch, ComponenteMezclaOP, ConsumoLoteDetalle, ConsumoMateriaPrima, CostoLoteProduccion (+83 more)

### Community 3 - "Bodega"
Cohesion: 0.11
Nodes (70): ApprovalRequests(), StockItem, Group, StockItem, AuditoriaDialogProps, AlertaStock, EditarMovimientoDialogProps, ItemIncompleto (+62 more)

### Community 4 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.14
Nodes (53): AuditLog, AuditoriaMovimiento, DetalleHistorialDespachoPedido, OrdenCompraSugerida, Registra cada modificación realizada a un MovimientoInventario.     Permite tra, Registra la necesidad calculada de un material para cumplir con la producción o, Totaliza los requerimientos por producto y sede que superan el stock actual,, RequerimientoMaterial (+45 more)

### Community 5 - "NotaVentaRequest"
Cohesion: 0.09
Nodes (9): KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase, ProduccionResumenTendenciaTestCase, Pruebas de gestion/views/kpi_views.py.  Vistas: KPIAreaView, KpiEjecutivoView,, Contrato JSON del dashboard ejecutivo + parseo de sede_id., Caja blanca de la autorización por área., KPIs reales de calidad y rendimiento para el Jefe de Área.      Reemplaza el p (+1 more)

### Community 6 - "AuditLog"
Cohesion: 0.07
Nodes (26): Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente, ConsumoMezclaService, SRP: gestiona el consumo de múltiples lotes de entrada para producir un lote de, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Pa, Registra la recepción de un lote de materia prima del proveedor.          Crea e, Orquesta el registro de un lote de producción.     - Consume producto_entrada d, RegistroLoteService, Si el movimiento de Kardex falla, ni MP ni stock persisten. (+18 more)

### Community 7 - "BodegaFactory"
Cohesion: 0.19
Nodes (11): DetallePedido, EtiquetaRequest, NotaVentaContexto, BaseModel, Schemas Pydantic del printing_service. ISP: un schema por caso de uso, sin lógi, Un renglón del pedido con su peso, precio y condición de IVA., Schema enriquecido con cálculos ya realizados por DocumentService.     Es el ob, DTO de entrada para generación de etiqueta ZPL. (+3 more)

### Community 8 - "JefeAreaDashboard.tsx"
Cohesion: 0.10
Nodes (9): OrdenProduccionViewSet, Jefe de Planta crea orden básica: código, peso, área, Jefe de Área completa los detalles de la orden:         - Selecciona producto (, Calcula detalladamente los materiales y químicos necesarios para completar la OP, ISP: Endpoint específico para tintorero para consultar stock de químicos disponi, Aislamiento por área/sede: admins y jefe de planta ven todo; el         jefe de, Registra una transformación (un paso de máquina) en la OP.          Solo Jefe, Lista las transformaciones de la OP en orden de secuencia. (+1 more)

### Community 9 - "LoteProduccion"
Cohesion: 0.04
Nodes (52): AdminSedeDashboard(), Group, ManageBodegas(), ManageClientes(), ManageClientesProps, CLIENTE_1, CLIENTE_2, SelectCtx (+44 more)
...
Cohesion: 0.12
Nodes (8): Request, JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación., ServicePrincipal, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. C, Tests para JWTServiceAuthentication. EP + BVA., IsInternalServiceTestCase, Pruebas de internal_api/permissions.py — IsInternalService y HasScope.  Técnic

### Community 12 - "App.tsx"
Cohesion: 0.03
Nodes (53): sonner, App(), AppContent(), mockAuthState, AdminSistemasDashboard(), showApiError(), AuditoriaDialog(), LOG_1 (+45 more)

### Community 13 - "ClienteFactory"
Cohesion: 0.05
Nodes (45): ALERTA_1, BODEGA_1, BODEGA_2, BODEGA_3, LOTE_1, mockGet, mockUseAuth, PRODUCTO_1 (+37 more)

### Community 14 - "SedeFactory"
Cohesion: 0.10
Nodes (16): BaseCommand, Command, Ingreso directo de stock con Kardex (COMPRA) para químicos/insumos., Un OrdenProduccionSubproceso por cada AreaProcessStep del área (estado pendiente, Replica las transiciones del OrdenProduccionSubprocesoViewSet., Transfiere un lote terminado entre áreas (con lote) + registra TransferenciaInte, Crea el despacho (HistorialDespacho + detalles + MovimientoInventario VENTA)., El tintorero crea la FormulaColor (en_pruebas -> aprobada) que usará la OP. (+8 more)

### Community 15 - "LoteProduccionFactory"
Cohesion: 0.06
Nodes (16): Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., ComponenteMezclaOPFactory, ConsumoMezclaServiceConsumir, ConsumoMezclaServiceRevertir, TestCase, TDD — ConsumoMezclaService. COBIT DSS06 + ISO 27001 A.12.4., STT: mezcla consumida → revertir → stock restaurado. (+8 more)

### Community 16 - "ProductoFactory"
Cohesion: 0.03
Nodes (133): AbstractUser, BaseAuthentication, BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Command (+125 more)
...
Cohesion: 0.02
Nodes (83): mockBodegas, mockGet, mockPost, mockProductos, mockProveedores, mockPut, toastErrorMock, toastSuccessMock (+75 more)
...
Cohesion: 0.11
Nodes (15): MermaStockService, SRP: gestiona el stock de merma vendible por máquina.     ISO 27001 A.12.4: cada, Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, MermaStockServiceRegistrarTest, MermaStockServiceRevertirTest (+7 more)

### Community 25 - ".calcular_costo"
Cohesion: 0.11
Nodes (16): LoteInfo, Información del lote retornada cuando la validación es exitosa., Respuesta del endpoint /validate., ValidateResponse, Valida un código de lote escaneado.          Args:             codigo: Código, client_lote_no_encontrado(), client_lote_valido(), client_sin_stock() (+8 more)

### Community 26 - "InventoryDashboard.tsx"
Cohesion: 0.10
Nodes (19): Auditoría y Mejoras del Rol Jefe de Área, Brechas pendientes (roadmap de la auditoría), Bug crítico en `reetiquetar` (RBAC por grupos), Correcciones Implementadas, Fuentes (industria), Fundamento Industrial (base de la auditoría), R1 — Bug de rechazo de lote (motivo obligatorio), R2 — KPI real de rendimiento y calidad (+11 more)
...
Cohesion: 0.04
Nodes (39): DjangoModelFactory, EventoEtiqueta, Registro inmutable del ciclo de vida de cada etiqueta física impresa para un lot, BodegaFactory, ConsumoLoteDetalleFactory, DetalleFormulaFactory, EventoEtiquetaFactory, FaseRecetaFactory (+31 more)

### Community 32 - "OrdenProduccionFactory"
Cohesion: 0.10
Nodes (27): ESTADO_BADGE, ManageLineasProps, ESTADO_BADGE, ManageMaquinasProps, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent() (+19 more)
...
### Community 34 - ".handle"
Cohesion: 0.06
Nodes (9): AreaProcessStepViewSetTestCase, ComponenteMezclaOPViewSetTestCase, ConsumoLoteDetalleViewSetTestCase, EtapaProduccionViewSetTestCase, OrdenProduccionCreateTestCase, TestCase, Pruebas complementarias de gestion/views/production_views.py — cubre los ViewSe, RegistrarTransformacionTestCase (+1 more)
...
Cohesion: 0.05
Nodes (19): Revierte un pago deshaciendo el abono registrado.          Validaciones:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueE, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - M, Caso 4: Reversión es transaccional          Verifica:         - Si falla un p, Caso 1: Revertir pago restaura deuda del cliente          Verifica:         -, _crear_pedido(), EP rol permitido: vendedor revierte pagos de SUS clientes., EP monto inválido: pago > deuda → 400 y no se persiste. (+11 more)

### Community 40 - "PrintAuditLog"
Cohesion: 0.11
...
### Community 42 - "LoteValidationService"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (40): CostoHoraMaquina, LoteProduccion, Tarifa vigente de un operario; vigente_hasta NULL = sin fecha de fin., Costo operativo por hora de maquina (amortizacion + energia + mantto)., TarifaOperario, CostoLoteService, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-CosteoLoteProduccion (F0-002), Calcula y persiste el desglose de costos de un lote de producción. (+32 more)
...
Cohesion: 0.16
Nodes (14): Base, ScanAuditLog, AuditRepository, IAuditRepository, Protocol, Contrato de auditoría para scanning_service.     LSP: DjangoApiClient y mocks de, Persiste un registro de auditoría. Nunca propaga excepciones., Implementación SQLite de IAuditRepository.     SRP: solo persiste; no construye (+6 more)
...
Cohesion: 0.08
Nodes (21): BODEGA_1, FORMULA_1, KPI_1, LOTE_1, makeQueryClient(), MAQUINA_1, MAQUINA_2, mockDelete (+13 more)

### Community 52 - ".get"
Cohesion: 0.08
Nodes (22): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, TransformacionService, TrazabilidadService — reconstruye el flujo completo de producción de una OP.  Ar, Servicio de lectura que estructura la trazabilidad de una OP., Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor (+14 more)

### Community 53 - "main.py"
Cohesion: 0.14
Nodes (4): MateriaPrimaLoteViewSetTestCase, TestCase, Pruebas de gestion/views/materia_prima_views.py — MateriaPrimaLoteViewSet y Tra, TraceabilityViewSetTestCase

### Community 54 - "Diseño: Microservicios Independientes — TexCore"
Cohesion: 0.11
Nodes (23): PrintAuditLog, Base, AuditRepository, IAuditRepository, Protocol, Contrato de auditoría para printing_service., Persiste un registro de auditoría. Nunca propaga excepciones., Implementación SQLite de IAuditRepository.     SRP: solo persiste; no construye (+15 more)
...
### Community 59 - "_audit"
Cohesion: 0.06
Nodes (20): ClienteFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_c, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3)., EP Clase Inválida + BVA: -0.001 viola el CheckConstraint de BD.         La rest (+12 more)

### Community 60 - "MRPEngine"
Cohesion: 0.06
Nodes (31): Arquitectura Backend, Arquitectura Frontend, Configuración y Seguridad, Fase 10: Robustecimiento de Lógica de Negocio mediante TDD (Completado — Mayo 2026), Fase 11: Refactorización Arquitectónica y Tareas Asíncronas (Completado — Mayo 2026), Fase 12: Control de Mermas y Excelencia Operativa (En Progreso), Fase 13: Independencia Total de Microservicios — API Interna JWT RS256 (Completado — Mayo 2026), Fase 13: Independencia Total de Servicios Satélites — API Interna JWT RS256 (Completado — Mayo 2026) (+23 more)
...
### Community 66 - "CookieJWTAuthenticationTestCase"
Cohesion: 0.08
...
### Community 69 - "ProduccionKPIService"
Cohesion: 0.07
...
### Community 70 - "DjangoReportRepository"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (21): OrdenProduccionFactory, DescargaQuimicosValidacionesTestCase, TestCase, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Tran, ISTQB STT — Transiciones legales en la máquina de estados., El modelo actual permite pendiente → finalizada (no tiene validación de estado)., Tests de creación de OrdenProduccion con validaciones de campos. (+13 more)
...
Cohesion: 0.05
Nodes (18): AreaFactory, ProveedorFactory, SedeFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProductoViewSetMultiTenancyTestCase, ProveedorViewSetMultiTenancyTestCase (+10 more)
...
### Community 82 - "test_vendedores.py"
Cohesion: 0.09
...
### Community 83 - "_fecha_a_texto"
Cohesion: 0.05
Nodes (21): get_user_role(), APIView, UserProfileView, CustomUserFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, Pruebas de gestion/views/core_views.py — SedeViewSet, AreaViewSet, CustomUserVi (+13 more)
...
Cohesion: 0.06
Nodes (34): Bodega, DescargaQuimicosService, Decimal, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se us, Template Method: secuencia fija revertir → descargar.         Se usa al modific, Servicio de descarga automática de químicos al crear/modificar/eliminar órdenes, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en l, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator. (+26 more)
...
### Community 92 - "_prepare_df_for_excel"
Cohesion: 0.11
...
Cohesion: 0.20
Nodes (10): 1. Microservicio de Escaneo (`scanning_service`), 2. Configuración de Nginx como API Gateway, 3. Modelos de Historial de Despacho, 4. Actualización del Proceso de Despacho, 5. Integración del Frontend, 6. Orquestación con Docker Compose, 7. Documentación, `DetalleHistorialDespacho` (+2 more)

### Community 94 - "ExtractClientIpTestCase"
Cohesion: 0.08
...
Cohesion: 0.14
Nodes (11): ManageLineas(), LINEA_1, MAQUINA_1, MAQUINA_2, mockDelete, mockGet, mockPatch, mockPost (+3 more)

### Community 97 - "test_gerencial.py"
Cohesion: 0.25
...
Cohesion: 0.13
Nodes (19): Base, ReportAuditLog, AuditRepository, get_audit_repo(), IAuditRepository, Protocol, AuditRepository de reporting_excel: persiste eventos de auditoría en SQLite. DIP, Contrato de auditoría para reporting_excel. (+11 more)
...
Cohesion: 0.15
Nodes (13): 16 de Junio de 2026, 1 de Junio de 2026, 23 de Junio de 2026, 24 de Junio de 2026, 3 de Junio de 2026, 8 de Junio de 2026, Correcciones de UI/UX en Dashboards JefeArea y JefePlanta, Docker `.env` y Actualización de Suite de Pruebas, Corrección de Configuración del Entorno de Desarrollo — .env, manage.py, Docker Windows y deploy.ps1 (+5 more)

### Community 102 - "_get_object_sede_id"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (13): 1. Backend — Modelo (`gestion/models.py`), 2. Backend — Service Layer (`gestion/services/evento_etiqueta_service.py`), 3. Backend — Views (`gestion/views/production_views.py`, `LoteProduccionViewSet`), 4. Microservicio `printing_service` (F2 + F5), 5. Frontend — Types (`frontend/src/lib/types.ts`), 6. Frontend — Components, `BuscadorLotes.tsx` (nuevo, F3), `EventoEtiquetaService` (+5 more)

### Community 104 - "SubprocesoStateMachineTestCase"
Cohesion: 0.24
Nodes (6): _get_required_env(), APIView, Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., ReportingProxyView, GetRequiredEnvTestCase, Pruebas complementarias de inventory/reporting_proxy.py — ramas que test_report
...
Cohesion: 0.19
Nodes (6): Command, BaseCommand, MRPEngine, Devuelve los detalles de una fórmula usando caché en memoria., Ejecuta el cálculo completo del MRP de forma optimizada:         1. Limpia dato, run_mrp()

### Community 108 - ".registrar_entrada"
Cohesion: 0.13
...
### Community 110 - "scanning_views.py"
Cohesion: 0.20
Nodes (8): mockDelete, mockGet, mockPatch, mockPost, mockPut, MOVIMIENTO_1, toastErrorMock, toastSuccessMock

### Community 111 - "TestReportingEndpoints"
Cohesion: 0.25
Nodes (5): date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0), Punto de entrada único — Fachada sobre los métodos privados.

### Community 112 - "PrecisionDecimalInventoryTestCase"
Cohesion: 0.19
Nodes (9): EventoEtiqueta, EventoEtiquetaService, EventoEtiquetaService: orquesta la numeración y creación de eventos de etiqueta., Copia idéntica: mantiene la version de datos vigente, solo avanza la secuencia., Cambio de datos: anula la última etiqueta vigente y emite una nueva version., _snapshot_actual(), EventoEtiquetaModelTests, EtapaProduccionViewSet (+1 more)

### Community 113 - "_prepare_df"
Cohesion: 0.12
Nodes (16): Arquitectura, Auditoría Local (ISO 27001 A.12.4), Autenticación con Backend (Fase 13), Despliegue, Endpoints (15 total), Estructura, Gerencial — `GET /gerencial/...`, Inventario — `GET /exports/{recurso}` (+8 more)

### Community 114 - "ExcelFormatter"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (5): BasePermission, HasScope, Verifica que el ServicePrincipal tiene el scope requerido.     Uso: permission_, HasScopeTestCase, TestCase
...
Cohesion: 0.19
Nodes (3): TestCase, Pruebas de inventory/transform_view.py — TransformacionAPIView.  Transforma st, TransformacionAPIViewTestCase
...
Cohesion: 0.15
Nodes (8): clear_cascade_justification(), get_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), CascadeJustificationTestCase, TestCase, EP: valor presente vs ausente tras clear., BodegaViewSet
...
### Community 125 - "build_print_record"
Cohesion: 0.13
Nodes (7): EP parcial: pedido 1000, pago 600 → monto_pagado 600, no pagado., BVA exacto: pago == valor → monto_pagado == valor y esta_pagado., STT FIFO: pedido1 (500) + pedido2 (1000); pago 800 →         pedido1 pagado com, El API de pedidos expone monto_pagado y porcentaje_pagado., STT reversión: revertir el único abono deja monto_pagado en 0., EP no marcado: pago > deuda sin es_anticipo → 400 (previene typos)., EP marcado: es_anticipo=True permite pago > deuda.

### Community 126 - "export_top_clientes_gerencial"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (35): Environment, Configuración centralizada del printing_service. Elimina dependencias de cwd (f, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., generate_etiqueta_pdf() (+27 more)
...
Cohesion: 0.12
Nodes (17): 1. Registrar un lote nuevo (evento ORIGINAL), 2. Reimprimir (copia idéntica), 3. Reetiquetar (cambio de datos), 6. Autenticación In-Situ de Supervisor (`Supervisor Override`) y Control de Pesaje, Arquitectura Implementada, Autenticación In-Situ para Reetiquetado, Control de Tolerancia de Pesaje (Overfill / Underfill Warning), Documentación: Gestión de Etiquetas (Reetiquetado, Búsqueda por Fechas e Impresión Real) (+9 more)
...
Cohesion: 0.27
Nodes (6): AuditMiddleware, get_current_ip(), Middleware para capturar la IP y el usuario de la petición actual,     guardánd, AuditMiddlewareCallTestCase, Pruebas del middleware de auditoría — gestion/middleware.py.  Foco de segurida, Caja blanca: rama feliz (response) y rama de excepción (re-raise).
...
### Community 135 - ".revertir_descarga_op"
Cohesion: 0.20
...
### Community 137 - "HistorialDespachoUnitTests"
Cohesion: 0.15
...
### Community 138 - "TestBuildScanRecord_ValoresLimite"
Cohesion: 0.15
...
### Community 146 - "AreaMovementsTable.test.tsx"
Cohesion: 0.17
...
### Community 147 - "InventoryHistory.test.tsx"
Cohesion: 0.17
...
### Community 149 - "verificar_auditoria.py"
Cohesion: 0.15
...
Cohesion: 0.17
Nodes (7): AreaSerializer, AreaNombreValidatorTestCase, DosificacionSerializerTestCase, TestCase, Pruebas de validación de gestion/serializers.py.  Cubre validadores a nivel de, validate_nombre: ALPHANUMERIC_ACCENTS_REGEX., validate_kg_tela / validate_relacion_bano: deben ser > 0.

### Community 153 - ".format"
Cohesion: 0.17
Nodes (7): TestCase, Suite de pruebas para verificar el Control de Acceso basado en Roles (RBAC)., Verifica que sin login no haya acceso a nada, Matrix test para /api/inventory/historial-despachos/         Permitidos: admin_, Matrix test para /api/inventory/stock/         Permitidos: Casi todos excepto o, Matrix test para /api/inventory/process-despacho/ (Endpoint crítico de escritura, RBACMatrixTestCase

### Community 155 - "Resumen de Errores Solucionados"
Cohesion: 0.14
...
### Community 159 - "0006_create_default_groups.py"
Cohesion: 0.18
...
### Community 160 - "OptionalPagination"
Cohesion: 0.17
...
### Community 161 - "ProduccionService"
Cohesion: 0.10
Nodes (16): Arquitectura del Entorno de Desarrollo, Arquitectura del Entorno de Producción, Diagnóstico General de Docker, Django Crash al arrancar (`ImproperlyConfigured`), `docker-compose` vs `docker compose` — Error en deploy.ps1, Documentación de la Configuración de Docker en TexCore, Errores de `bash\r` o `sh\r` en Windows, Proceso de Inicio del Backend (`entrypoint.sh`) (+8 more)

### Community 162 - "OpsEstado"
Cohesion: 0.18
Nodes (10): Cómo ejecutar la suite, Defectos detectados y corregidos durante el refuerzo, Estado de cobertura, Leyenda de técnicas ISTQB, Matriz, Matriz de Trazabilidad de Pruebas — TexCore (Backend), Seguridad y autenticación, Serializers (validación de entrada) (+2 more)

### Community 163 - "devDependencies"
Cohesion: 0.22
Nodes (9): Capas de la Arquitectura, Circuit Breaker en DjangoApiClient, Endpoints del scanning_service, Estructura Interna, Flujo Interno de DjangoApiClient (patron cache de request), GET /health, Microservicio: scanning_service, POST /validate (+1 more)

### Community 164 - "run_backend_tests.sh"
Cohesion: 0.18
...
### Community 166 - "0064_backfill_producto_salida.py"
Cohesion: 0.18
Nodes (9): Aplicar migraciones:, 📊 Arquitectura Resultante, 🔧 Comandos de Despliegue, Construir y levantar servicios:, Implementación del Módulo de Despacho con Microservicios, Notas Técnicas, 🎯 Objetivo, 📋 Próximos Pasos (Documentados en ROADMAP.md) (+1 more)

### Community 167 - "InternalApiConfig"
Cohesion: 0.17
...
### Community 175 - "cmdk"
Cohesion: 0.20
Nodes (10): 4. HALLAZGOS DE SEGURIDAD — OWASP TOP 10, [SEC-01] 🔴 CRÍTICO — Path Traversal en reporting_proxy, [SEC-02] 🔴 CRÍTICO — Secrets con valores por defecto hardcodeados, [SEC-03] 🔴 CRÍTICO — Tokens JWT sin mecanismo de revocación, [SEC-04] 🔴 CRÍTICO — Sin Rate Limiting en autenticación, [SEC-05] 🔴 CRÍTICO — IP Spoofing en middleware de auditoría, [SEC-06] 🔴 CRÍTICO — CORS completamente abierto en microservicio, [SEC-07] 🟠 ALTA — Race Condition en transferencia de stock (+2 more)

### Community 176 - "embla-carousel-react"
Cohesion: 0.16
Nodes (4): get_current_user(), Validaciones de negocio que requieren contexto de auditoría.         Se llama a, GetCurrentUserTestCase, Caja blanca: usuario existe / no existe en BD / sin usuario en contexto.

### Community 177 - "@hookform/resolvers"
Cohesion: 0.19
...
### Community 182 - "@radix-ui/react-accordion"
Cohesion: 0.22
...
### Community 183 - "@radix-ui/react-aspect-ratio"
Cohesion: 0.22
...
### Community 184 - "@radix-ui/react-avatar"
Cohesion: 0.17
...
### Community 185 - "@radix-ui/react-checkbox"
Cohesion: 0.13
Nodes (15): Análisis del Sistema de Despacho - TexCore, Archivos Clave de Referencia, Arquitectura General, Configuracion de Servicios, Dependencias entre Servicios, Diagrama de Componentes, Docker Compose (produccion), Flujo Completo de Despacho (end-to-end) (+7 more)

### Community 186 - "@radix-ui/react-collapsible"
Cohesion: 0.22
...
### Community 187 - "@radix-ui/react-context-menu"
Cohesion: 0.22
...
### Community 188 - "@radix-ui/react-dialog"
Cohesion: 0.44
...
### Community 189 - "@radix-ui/react-dropdown-menu"
Cohesion: 0.07
Nodes (18): Tarifa vigente a la fecha; vigente_hasta NULL = contrato abierto., Costo/hora vigente a la fecha; vigente_hasta NULL = sin fecha fin., LoteProduccion, Registra el consumo de uno o más lotes de MP en un lote producido.          cons, Operario $10/h y máquina $5/h; 2 horas → $20 + $10., STT: MP $500 + químicos $100 + operario $20 + máquina $10 = $630., EP sin catálogo de tarifas: operario y máquina quedan en 0., BVA: tarifa con vigente_hasta NULL (contrato abierto) SÍ aplica. (+10 more)
...
Cohesion: 0.09
Nodes (21): _apply_pragmas(), Base, get_session_factory(), init_db(), _make_engine(), _make_session_factory(), async_sessionmaker, AsyncSession (+13 more)

### Community 192 - "@radix-ui/react-navigation-menu"
Cohesion: 0.20
Nodes (4): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 270, JWTServiceAuthenticationExtraTestCase, TestCase, Pruebas complementarias de internal_api/authentication.py — ramas que test_auth
...
### Community 195 - "@radix-ui/react-radio-group"
Cohesion: 0.22
Nodes (9): Acceso, Contribución, Datos de prueba, Documentación, Estructura del Proyecto, Inicio Rápido, Stack Tecnológico, Testing (+1 more)

### Community 196 - "@radix-ui/react-scroll-area"
Cohesion: 0.42
...
### Community 197 - "@radix-ui/react-slider"
Cohesion: 0.29
Nodes (7): scripts, build, dev, preview, test, test:coverage, test:watch

### Community 198 - "@radix-ui/react-slot"
Cohesion: 0.25
...
### Community 199 - "@radix-ui/react-switch"
Cohesion: 0.25
...
### Community 200 - "@radix-ui/react-tabs"
Cohesion: 0.25
...
### Community 201 - "@radix-ui/react-toggle"
Cohesion: 0.25
...
### Community 202 - "@radix-ui/react-toggle-group"
Cohesion: 0.25
...
### Community 203 - "@radix-ui/react-tooltip"
Cohesion: 0.25
...
### Community 204 - "react-day-picker"
Cohesion: 0.25
...
### Community 212 - "tailwindcss-animate"
Cohesion: 0.29
...
### Community 213 - "@tanstack/react-query-devtools"
Cohesion: 0.29
...
### Community 221 - "@types/react"
Cohesion: 0.33
Nodes (6): 4.1 Capa 1: Autenticacion de Usuarios Finales (SimpleJWT + Cookies httpOnly), 4.2 Roles y Permisos (RBAC via Django Groups), 4.3 Capa 2: Autenticacion Servicio-a-Servicio (JWT RS256), 4.4 Modelo de Auditoria, 4.5 Proteccion contra IP Spoofing, 4. Autenticacion y Seguridad

### Community 222 - "@types/react-router-dom"
Cohesion: 0.33
...
### Community 224 - "@vitejs/plugin-react"
Cohesion: 0.33
Nodes (6): Aislamiento de Red Docker, Credenciales de Microservicios, Headers HTTP (Nginx), Rate Limiting (Nginx), Seguridad, SSL/TLS

### Community 225 - "vitest"
Cohesion: 0.33
...
### Community 226 - "aspect-ratio.tsx"
Cohesion: 0.33
...
Cohesion: 0.15
Nodes (8): calcularCantidad(), FormulaQuimica(), FORMULA_1, FORMULA_2, QUIMICO_1, QUIMICO_2, SelectCtx, toastErrorMock
...
### Community 232 - "0004_cliente_saldo_pendiente_cliente_tiene_beneficio_and_more.py"
Cohesion: 0.33
...
### Community 233 - "0005_customuser_bodegas_asignadas.py"
Cohesion: 0.25
...
### Community 234 - "0007_remove_cliente_saldo_pendiente_and_more.py"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (4): FormulaColorViewSet, Calcula la dosificacion de cada insumo quimico de la formula dado un peso, Crea una nueva version de la formula copiando todos sus detalles.         La ve, Genera el archivo o estructura de datos para enviarse a la cocina de colores
...
### Community 237 - "0010_pagocliente.py"
Cohesion: 0.15
Nodes (13): 10 de Julio de 2026, 13 de Julio de 2026, 1 de Julio de 2026, 20 de Julio de 2026, 2 de Julio de 2026, Auditoría del Rol Jefe de Área — KPIs reales, rechazo con motivo y fix RBAC de reetiquetado, Corrección de 3 bugs: 500 en Dashboard Jefe de Planta, "Mínimo (kg)" en NaN (tintorero) y máquinas en blanco (jefe de área), Fase 4d completada — Conversión de smoke tests a tests de comportamiento reales (frontend): 36/36 archivos, +496 tests, cobertura 37.4% → 74.83% (+5 more)

### Community 238 - "0011_ordenproduccion_fecha_fin_planificada_and_more.py"
Cohesion: 0.40
...
### Community 239 - "0012_ordenproduccion_operario_asignado.py"
Cohesion: 0.40
...
### Community 240 - "0013_ordenproduccion_area.py"
Cohesion: 0.40
...
### Community 241 - "0014_maquina_operarios.py"
Cohesion: 0.40
...
### Community 242 - "0015_create_reporting_sps.py"
Cohesion: 0.40
...
### Community 243 - "0016_create_seller_reporting_sps.py"
Cohesion: 0.40
...
### Community 244 - "0017_add_credit_terms_and_due_date.py"
Cohesion: 0.40
...
### Community 245 - "0018_update_deudores_sp.py"
Cohesion: 0.40
...
### Community 246 - "0019_formulas_quimicas_v2.py"
Cohesion: 0.40
...
### Community 247 - "0021_proveedor.py"
Cohesion: 0.40
...
### Community 248 - "0022_descarga_quimico_op.py"
Cohesion: 0.40
Nodes (5): Comandos de Diagnostico, Generar Par de Claves RSA, Migraciones, Registrar Credenciales de Microservicios, Scripts y Comandos de Gestion

### Community 249 - "0022_update_seller_reporting_sps_iva.py"
Cohesion: 0.40
...
### Community 250 - "0023_detallepedido_subtotal_detallepedido_total_con_iva_and_more.py"
Cohesion: 0.40
...
### Community 251 - "0024_remove_formulacolor_productos_auditlog_fasereceta_and_more.py"
Cohesion: 0.40
...
### Community 252 - "0025_loteproduccion_cantidad_metros.py"
Cohesion: 0.40
...
Cohesion: 0.20
Nodes (6): AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, Pruebas de internal_api/audit.py — AuditLogger.log.  Técnicas ISTQB aplicadas:, APIView, Endpoint interno para validación de lotes por scanning_service. SRP: solo expon, GET /api/internal/v1/lotes/{codigo_barras}/validate/      Retorna información, ValidateLoteView
...
### Community 259 - "0035_revert_sp_sin_nro.py"
Cohesion: 0.40
...
### Community 273 - "0049_auditlog_content_object_index.py"
Cohesion: 0.50
...
### Community 274 - "0050_ordenproduccion_peso_neto_positivo.py"
Cohesion: 0.50
...
### Community 275 - "0051_remove_auditlog_idx_audit_object_fecha.py"
Cohesion: 0.50
...
### Community 276 - "0052_pedidoventa_anulacion.py"
Cohesion: 0.50
...
### Community 277 - "0053_merge_migrate_heads.py"
Cohesion: 0.50
...
### Community 284 - "0060_ordenproduccion_prioridad.py"
Cohesion: 0.50
...
### Community 289 - "0065_merge_20260603_1339.py"
Cohesion: 0.67
...
### Community 292 - "0068_materia_prima_trazabilidad.py"
Cohesion: 0.25
...
Cohesion: 0.20
Nodes (6): PlainTextResponse, EP: datos válidos de etiqueta → ZPL generado (strategy mockeado)., EP: fallo interno del strategy → 500 Internal Server Error., F2: motivo/tipo_evento/version/usuario se propagan al registro de auditoría., TestZplEndpoint, StreamingResponse

### Community 309 - ".genealogia"
Cohesion: 0.04
Nodes (41): make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la, Factory para crear clases de permiso basadas en grupos de Django.      Otorga, PagoReversionService, Servicio de Reversión de Pagos del Cliente Artefacto RUP: Módulo de Servicio C, Servicio de reversión de pagos.     Responsable único: deshacer un pago y resta, OpsEstado, ProduccionKPIs (+33 more)

### Community 310 - ".requisitos_materiales"
Cohesion: 0.09
Nodes (21): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., get_validation_service(), AuditRepository, BackgroundTasks (+13 more)
...
### Community 316 - "TestDocumentService_FormatearFecha"
Cohesion: 0.50
Nodes (3): APIView, API View to register a production lot and handle all related inventory movements, RegistrarLoteProduccionView

### Community 317 - ".rechazar"
Cohesion: 0.12
Nodes (10): LoteProduccionViewSet, ZPL local simple, usado si el microservicio de impresión no responde., GET /lotes-produccion/{id}/generate-pdf-label/ — F5: etiqueta en PDF,         f, GET /lotes-produccion/{id}/etiquetas/ — historial de eventos de etiqueta del lot, POST /lotes-produccion/{id}/reimprimir/ — reimpresión idéntica gobernada., POST /lotes-produccion/{id}/reetiquetar/ — reetiquetado con cambio de datos., GET /api/lotes-produccion/{id}/obtener-costo/ — F0-002.          Calcula (o re, Ajusta stock de salida/entrada/químicos cuando el peso neto de un lote cambia. (+2 more)

### Community 321 - "KardexSerializer"
Cohesion: 0.11
Nodes (20): DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, DetalleHistorialDespacho, HistorialDespacho, MovimientoInventario (+12 more)

### Community 322 - "OpsEstado"
Cohesion: 0.50
...
### Community 323 - "StockKPIs"
Cohesion: 0.50
Nodes (4): crearSedeSinSeleccionarla(), mockEndpoints(), mockFullSedeData(), renderAt()

### Community 329 - "test_views_extra.py"
Cohesion: 0.12
Nodes (5): AuditLogViewSetTestCase, OrdenCompraSugeridaViewSetTestCase, TestCase, Pruebas complementarias de inventory/views.py — AuditLogViewSet, RequerimientoM, RequerimientoMaterialViewSetTestCase

### Community 332 - "LotesProduccionPagination"
Cohesion: 0.50
Nodes (3): LotesProduccionPagination, F3: paginación real, opt-in — solo se activa si el cliente envía ?page=.     Pr, PageNumberPagination

## Knowledge Gaps
- **1569 isolated node(s):** `Auditoría del Rol Jefe de Área — KPIs reales, rechazo con motivo y fix RBAC de reetiquetado`, `Optimización de Estación de Empaque, Reetiquetado Supervisado con In-Situ Override, KPIs y Control de Pesaje`, `Gestión de Líneas de Producción (Células de Manufactura Flexibles) para Jefe de Área`, `Fase 4d completada — Conversión de smoke tests a tests de comportamiento reales (frontend): 36/36 archivos, +496 tests, cobertura 37.4% → 74.83%`, `Plan de cobertura QA (Fases 0-2): +150 tests backend, 3 bugs reales corregidos, cobertura 80.8% → 89.6%` (+1564 more)
...
- **Why does `LoteProduccion` connect `ExecutiveKPIService` to `Maquina`, `OrdenProduccion`, `ManageOrdenesProduccion.tsx`, `AuditLog`, `AdminSistemasDashboard.tsx`, `ProductoFactory`, `cn`, `reporting_views.py`, `KardexSerializer`, `axios.ts`, `compilerOptions`, `logger.ts`, `0067_pagocliente_es_anticipo_pedidoventa_monto_pagado.py`, `DeudoresVendedorView`, `embla-carousel-react`, `.genealogia`, `test_views_extra.py`, `get_session_factory`, `KardexSerializer`, `get_current_user`, `react-hook-form`, `test_audit_middleware.py`, `MateriaPrimaRegistroTestCase`, `0005_customuser_bodegas_asignadas.py`, `PrecisionDecimalInventoryTestCase`, `0026_cliente_is_active.py`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `PedidoVenta` connect `ProductoFactory` to `Maquina`, `OrdenProduccion`, `ManageOrdenesProduccion.tsx`, `AuditLog`, `AdminSistemasDashboard.tsx`, `KardexSerializer`, `axios.ts`, `DescargaQuimicosStockInsuficienteTestCase`, `logger.ts`, `AuditRepository`, `0068_materia_prima_trazabilidad.py`, `DeudoresVendedorView`, `ExecutiveKPIService`, `.genealogia`, `test_views_extra.py`, `_audit`, `KardexSerializer`, `FrontendLogViewTestCase`, `MateriaPrimaRegistroTestCase`, `navigation-menu.tsx`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `CustomUserSerializer` connect `axios.ts` to `OrdenProduccion`, `ExecutiveKPIService`, `get_current_user`, `LoteProduccionFactory`, `ProductoFactory`, `auth_views.py`, `_fecha_a_texto`, `.genealogia`, `custom_jwt_views.py`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 70 inferred relationships involving `CustomUserFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`CustomUserFactory` has 70 INFERRED edges - model-reasoned connections that need verification._
- **Are the 167 inferred relationships involving `Producto` (e.g. with `BodegaAdmin` and `BodegueroInline`) actually correct?**
  _`Producto` has 167 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 161 inferred relationships involving `LoteProduccion` (e.g. with `BodegaAdmin` and `BodegueroInline`) actually correct?**
  _`LoteProduccion` has 161 INFERRED edges - model-reasoned connections that need verification._