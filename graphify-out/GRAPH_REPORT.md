...
## Corpus Check
- 583 files · ~823,549 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7008 nodes · 17919 edges · 443 communities (359 shown, 84 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 5196 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80ce637f`
...
- 0001_initial.py
- .test_crear_op_descarga_automatica
- .test_eliminar_op_requiere_justificacion
- .test_modificar_op_ajusta_descarga
- .test_stock_quimicos_endpoint_con_alertas
...
2. `LoteProduccion` - 238 edges
3. `cn()` - 221 edges
4. `Producto` - 219 edges
5. `PedidoVenta` - 210 edges
6. `SedeFactory` - 202 edges
7. `Bodega` - 188 edges
8. `OrdenProduccion` - 186 edges
9. `Sede` - 164 edges
10. `CustomUser` - 156 edges
...
## Communities (443 total, 84 thin omitted)
...
Cohesion: 0.05
Nodes (43): claseSeveridadEficiencia(), JefePlantaDashboard(), logger, toastErrorMock, toastSuccessMock, RFC-5424, UsuarioBasico, logger (+35 more)

### Community 2 - "FormulaColor"
Cohesion: 0.06
Nodes (94): AreaProcessStep, ComponenteMezclaOP, ConsumoLoteDetalle, EtapaProduccion, EventoEtiqueta, Maquina, OrdenProduccionSubproceso, ParoMaquina (+86 more)

### Community 3 - "AdminSistemasDashboard.tsx"
Cohesion: 0.07
Nodes (64): AbstractUser, BaseAuthentication, CustomUser, AuditLogger, AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, Registra en log estructurado (RFC 5424) cada acceso a la API interna     con ide, JWTServiceAuthentication, DRF Authentication backend para JWT de servicio (RS256).     Retorna None si no (+56 more)

### Community 4 - "MovimientoInventario"
Cohesion: 0.03
Nodes (64): Command, BaseCommand, Pobla clientes, pedidos de venta y pagos para probar el dashboard de Ventas (eje, Cliente, PagoReversionService, Servicio de Reversión de Pagos del Cliente Artefacto RUP: Módulo de Servicio Cas, Servicio de reversión de pagos.     Responsable único: deshacer un pago y restau, ClienteImprovementsTestCase (+56 more)

### Community 5 - "ConsumoMezclaServiceConsumir"
Cohesion: 0.03
Nodes (34): get_user_role(), APIView, UserProfileView, CustomUserFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, Pruebas de gestion/views/core_views.py — SedeViewSet, AreaViewSet, CustomUserVie (+26 more)

### Community 6 - "ComponenteMezclaOPFactory"
Cohesion: 0.04
Nodes (30): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, ParoMaquinaFactory, KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase (+22 more)

### Community 7 - "LoteProduccion"
Cohesion: 0.03
Nodes (42): DjangoModelFactory, Template Method: secuencia fija revertir → descargar.         Se usa al modifica, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator., DetalleFormulaFactory, EventoEtiquetaFactory, FaseRecetaFactory, FormulaColorFactory, Meta (+34 more)

### Community 8 - "MaquinaFactory"
Cohesion: 0.02
Nodes (91): AREA_1, AREA_3, BODEGA_1, BODEGA_3, CLIENTE_1, crearSedeSinSeleccionarla(), FORMULA_1, GROUP_1 (+83 more)

### Community 9 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.05
Nodes (90): StockItem, ManageProductosProps, StockItem, TransformationView(), TransformationViewProps, EliminarMovimientoDialog(), EliminarMovimientoDialogProps, RegistrarMermaDialog() (+82 more)

### Community 10 - "UnifiedBusinessLogicTestCase"
Cohesion: 0.03
Nodes (52): App(), AppContent(), mockAuthState, AdminSistemasDashboard(), showApiError(), AuditoriaDialog(), LOG_1, mockGet (+44 more)

### Community 11 - "HasScope"
Cohesion: 0.13
Nodes (55): AuditLog, AuditoriaMovimiento, DetalleHistorialDespachoPedido, OrdenCompraSugerida, Registra cada modificación realizada a un MovimientoInventario.     Permite traz, Registra la necesidad calculada de un material para cumplir con la producción o, Totaliza los requerimientos por producto y sede que superan el stock actual,, RequerimientoMaterial (+47 more)

### Community 12 - "VendedorDashboard.tsx"
Cohesion: 0.13
Nodes (61): ApprovalRequests(), Group, ManageAreas(), ManageBodegas(), ManageClientes(), ManageFormulas(), ManageProductos(), ManageProveedores() (+53 more)

### Community 13 - "AreaFactory"
Cohesion: 0.04
Nodes (14): StockBodegaFactory, LoteProduccionViewSetTestCase, MovimientoMermaCreateTestCase, TestCase, Pruebas de control de Merma en MovimientoInventarioViewSet.create() — `tipo_movi, MovimientoDestroyTestCase, TestCase, MovimientoReversionServiceTestCase (+6 more)

### Community 14 - "Command"
Cohesion: 0.16
Nodes (8): clear_cascade_justification(), get_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), CascadeJustificationTestCase, Pruebas del middleware de auditoría — gestion/middleware.py.  Foco de seguridad:, EP: valor presente vs ausente tras clear., ProveedorViewSet

### Community 15 - "EjecutivosDashboard.tsx"
Cohesion: 0.05
Nodes (24): Continuidad de cadena: entrada = salida de la transformación previa., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, ProductoFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProductoViewSetMultiTenancyTestCase (+16 more)

### Community 16 - "StockBodega"
Cohesion: 0.04
Nodes (29): ClienteFactory, SedeFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de Eq, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_cr, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3). (+21 more)

### Community 17 - "LineaProduccionViewSetTestCase"
Cohesion: 0.06
Nodes (33): Bodega, Decimal, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en lo, Registra la recepción de un lote de materia prima del proveedor.          Crea e, Si el movimiento de Kardex falla, ni MP ni stock persisten., Ajusta stock de salida/entrada/químicos cuando el peso neto de un lote cambia. (+25 more)

### Community 18 - "CookieJWTAuthentication"
Cohesion: 0.07
Nodes (29): Agrupación por dominio (validada contra el archivo actual), Agrupación por dominio (validada, sin ciclos de FK reales), Archivos críticos de referencia para la implementación, Archivos existentes a editar, Archivos existentes a editar, Archivos existentes a editar, Archivos nuevos a crear (todos en `gestion/views/`), Archivos nuevos a crear (todos en `inventory/views/`) (+21 more)

### Community 19 - "ServiceTokenRefreshViewTestCase"
Cohesion: 0.03
Nodes (38): Prueba que el despacho falle si no se proporcionan lotes., Prueba que el despacho falle si se proporciona un código de lote inválido., Prueba que el endpoint GET /api/inventory/historial-despachos/         retorne l, Prueba que el despacho sea atómico: si falla un lote, se revierten todos los cam, Prueba que un movimiento de inventario (Entrada) puede registrar proveedor, país, Prueba la transferencia de stock entre dos bodegas incluyendo el campo observaci, Prueba que el Kardex se puede filtrar por proveedor_id y devuelve nombres y códi, Valida el cálculo del saldo acumulado y el funcionamiento de filtros en el Karde (+30 more)

### Community 20 - "HistorialDespachoViewSet"
Cohesion: 0.08
Nodes (93): BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Command, BaseCommand, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_ (+85 more)

### Community 21 - "ProductoFactory"
Cohesion: 0.04
Nodes (55): AdminSedeDashboard(), ManageClientesProps, CLIENTE_1, CLIENTE_2, SelectCtx, toastErrorMock, ClienteComprasModal(), ClienteComprasModalProps (+47 more)

### Community 22 - "pdf_produccion_views.py"
Cohesion: 0.08
Nodes (32): NotaVentaRequest, DTO de entrada para generación de nota de venta.     SRP: solo transporta datos, DocumentService, DetallePedido, Servicio que encapsula la lógica de negocio para documentos comerciales.     Mét, Subtotal = suma de (peso * precio_unitario) para todos los detalles., IVA = 15% solo sobre los detalles con incluye_iva=True., Total = subtotal + iva - retención. (+24 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.03
Nodes (41): Producto, FormulaQuimicaTestCase, APITestCase, Suite de pruebas para el modulo de Formulas Quimicas.     Cubre: calculo de dosi, Para kg_tela=100 y relacion_bano=10:             volumen = 1000 L             co, Para kg_tela=100 y relacion_bano=10:             sal (60%): cantidad = (100 * 60, Verifica que kg_tela <= 0 o relacion_bano <= 0 retornen 400., Crear una formula con el mismo quimico dos veces debe retornar 400         con u (+33 more)

### Community 24 - ".consumir_materia_prima"
Cohesion: 0.06
Nodes (17): LoteProduccion, Copia idéntica: mantiene la version de datos vigente, solo avanza la secuencia., Cambio de datos: anula la última etiqueta vigente y emite una nueva version., _snapshot_actual(), PrintingServiceNotaVentaPdfTestCase, PrintingServiceUrlResolutionTestCase, PrintingServiceZplTestCase, TestCase (+9 more)
...
Cohesion: 0.10
Nodes (10): Tests de endpoints e integración para printing_service. Cubre: config, main, hea, P0: /pdf/reporte-avance y /pdf/reporte-balance eran llamados por     internal_ap, EP: todos los templates presentes → status ok., EP: templates faltantes → 503 Service Unavailable con lista de ausentes., EP: datos válidos de nota de venta → PDF generado (strategy mockeado)., EP: fallo interno del strategy → 500 Internal Server Error., F5: fallback universal — etiqueta en PDF para impresoras no-Zebra., TestHealthEndpoint (+2 more)

### Community 27 - "Documentación Técnica: Sistema de Reversión de Pagos del Cliente"
Cohesion: 0.11
Nodes (15): Command, BaseCommand, Ingreso directo de stock con Kardex (COMPRA) para químicos/insumos., Un OrdenProduccionSubproceso por cada AreaProcessStep del área (estado pendiente, Replica las transiciones del OrdenProduccionSubprocesoViewSet., Transfiere un lote terminado entre áreas (con lote) + registra TransferenciaInte, El tintorero crea la FormulaColor (en_pruebas -> aprobada) que usará la OP., jefe_planta crea las OPs; jefe_area asigna máquina + operario y genera subproces (+7 more)

### Community 28 - "NotaVentaRequest"
Cohesion: 0.11
Nodes (17): LoteInfo, Información del lote retornada cuando la validación es exitosa., Respuesta del endpoint /validate., ValidateResponse, Valida un código de lote escaneado.          Args:             codigo: Código de, client_lote_no_encontrado(), client_lote_valido(), client_sin_stock() (+9 more)
...
Cohesion: 0.09
Nodes (28): Base, DeclarativeBase, PrintAuditLog, Base, PrintAuditLog: modelo ORM del registro de auditoría de documentos generados. SRP, AuditRepository, get_audit_repo(), IAuditRepository (+20 more)
...
Cohesion: 0.07
Nodes (17): InventoryDashboard(), fakeBlob, mockBodegas, mockProductos, navigateToReportes(), renderDashboard(), toastErrorMock, toastSuccessMock (+9 more)
...
Cohesion: 0.09
Nodes (13): Tarifa vigente a la fecha; vigente_hasta NULL = contrato abierto., Costo/hora vigente a la fecha; vigente_hasta NULL = sin fecha fin., Operario $10/h y máquina $5/h; 2 horas → $20 + $10., STT: MP $500 + químicos $100 + operario $20 + máquina $10 = $630., EP sin catálogo de tarifas: operario y máquina quedan en 0., BVA: tarifa con vigente_hasta NULL (contrato abierto) SÍ aplica., EP expirada: tarifa que venció antes del lote no se usa., STT margen: precio $1000, costo $630 → margen $370 (37%). (+5 more)
...
Cohesion: 0.08
Nodes (19): HistorialDespacho, DespachoReversionService, Revierte registros de DescargaQuimicoOP asociados a los pedidos del despacho., Servicio para revertir despachos con auditoría completa.     Restaura stock de b, Revierte un despacho existente:         1. Restaura stock en cada bodega origen, DespachoReversionFKTestCase, TestCase, EP legado: detalle sin FK (datos pre-migración) usa el string. (+11 more)
...
Cohesion: 0.12
Nodes (5): _get_required_env(), Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., GetRequiredEnvTestCase, TestCase, ReportingProxyViewExtraTestCase
...
Cohesion: 0.08
Nodes (26): _apply_pragmas(), Base, get_session_factory(), _make_engine(), _make_session_factory(), async_sessionmaker, AsyncSession, DeclarativeBase (+18 more)

### Community 49 - "EjecutivosDashboard.reportes.test.tsx"
Cohesion: 0.08
Nodes (17): Request, JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación.      `sede_i, ServicePrincipal, Pruebas complementarias de internal_api/authentication.py — ramas que test_authe, HasScopeTestCase, IsInternalServiceTestCase, TestCase (+9 more)
...
Cohesion: 0.25
Nodes (5): date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0)         p, Punto de entrada único — Fachada sobre los métodos privados.

### Community 53 - ".revertir_pago"
Cohesion: 0.50
Nodes (5): audit_user_save(), _get_pending_skip(), _mark_created_and_skip_next_update(), Registra creación y actualización de usuarios en auditoría., _should_skip_update()
...
Cohesion: 0.19
Nodes (3): _audit(), Resuelve la sede a aplicar en un reporte interno como DEFENSA EN PROFUNDIDAD., resolve_sede_scope()

### Community 58 - "VendedorDashboard.detalle.test.tsx"
Cohesion: 0.06
Nodes (48): Environment, Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, build_print_record(), Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, generate_balance_masas_pdf(), generate_etiqueta_pdf(), generate_nota_venta_pdf(), generate_reporte_avance_pdf() (+40 more)
...
Cohesion: 0.14
Nodes (6): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 2700, JWTServiceAuthenticationExtraTestCase, TestCase, TestCase, Round-trip del claim de sede firmado en el JWT de servicio., ServiceTokenSedeClaimTestCase
...
Cohesion: 0.18
Nodes (6): ExecutiveKPIService, Cuenta productos con stock actual < stock_mínimo.         Filtra por sede a trav, Agrega KPIs de MRP, stock y cartera en un único objeto.      Uso:         servic, Punto de entrada único — Fachada., ExecutiveKPIServiceTest, SimpleTestCase
...
Cohesion: 0.10
Nodes (26): ESTADO_BADGE, ManageLineasProps, ESTADO_BADGE, ManageMaquinasProps, AlertDialog(), AlertDialogAction(), AlertDialogCancel(), AlertDialogContent() (+18 more)
...
Cohesion: 0.08
Nodes (13): AreaSerializer, DosificacionSerializer, Serializer de entrada para el endpoint de calculo de dosificacion., AreaNombreValidatorTestCase, DosificacionSerializerTestCase, TestCase, Pruebas de validación de gestion/serializers.py.  Cubre validadores a nivel de c, validate_nombre: ALPHANUMERIC_ACCENTS_REGEX. (+5 more)

### Community 75 - "TexCore — Estándares de Desarrollo"
Cohesion: 0.26
Nodes (9): AuditRepository, Implementación SQLite de IAuditRepository.     SRP: solo persiste; no construye, _make_scan_record(), _make_session_factory(), Tests unitarios de AuditRepository — scanning_service. No requieren BD real: la, Crea una session_factory mock con comportamiento configurable., TestAuditRepository_FalloBaseDeDatos, TestAuditRepository_RegistroValido (+1 more)

### Community 76 - "TransformacionProductoMermaTest"
Cohesion: 0.13
Nodes (14): EtiquetaRequest, DTO de entrada para generación de etiqueta ZPL., LabelService, Genera las imágenes de código de barras y QR de una etiqueta de lote., Code128 (misma simbología que ^BCN en ZPL) como PNG en base64.         `write_te, QR (misma corrección de errores 'M' que ^BQN,2,5 en ZPL) como PNG en base64., Construye el contexto para el template PDF, con las imágenes ya         generada, EP — campos requeridos vs. opcionales de EtiquetaRequest. (+6 more)
...
### Community 79 - "_audit"
Cohesion: 0.24
Nodes (6): AuditMiddleware, get_current_ip(), Middleware para capturar la IP y el usuario de la petición actual,     guardándo, AuditMiddlewareCallTestCase, TestCase, Caja blanca: rama feliz (response) y rama de excepción (re-raise).

### Community 80 - "development"
Cohesion: 0.11
Nodes (14): init_db(), Crea las tablas y aplica permisos de archivo.     ISO 27001 A.10: chmod 0o600 —, Escape backslash, double quote, and right bracket as per RFC 5424 §6.3.3, RFC 5424 Syslog Formatter     Format: <PRI>VERSION TIMESTAMP HOSTNAME APP-NAME P, RFC5424Formatter, lifespan(), log_requests_rfc5424(), FastAPI (+6 more)
...
Cohesion: 0.11
Nodes (5): MovimientoInventarioViewSet, Revierte el efecto de stock del movimiento (vía MovimientoReversionService), Permite editar un movimiento de inventario existente.         Solo se permiten e, Retorna el historial de cambios de un movimiento específico., Compara requerimientos de los pedidos contra stock de los lotes escaneados.
...
Cohesion: 0.16
Nodes (19): _audit(), BalanceMasasPdfView, _build_balance_masas_payload(), _build_reporte_avance_payload(), _get_printing_url(), _now_iso(), _proxy_pdf(), APIView (+11 more)

### Community 100 - "main.py"
Cohesion: 0.19
Nodes (6): Command, BaseCommand, MRPEngine, Devuelve los detalles de una fórmula usando caché en memoria., Ejecuta el cálculo completo del MRP de forma optimizada:         1. Limpia datos, run_mrp()
...
Cohesion: 0.11
Nodes (19): 16 de Junio de 2026, 1 de Junio de 2026, 23 de Junio de 2026, 24 de Junio de 2026, 3 de Junio de 2026, 5 de Junio de 2026, 8 de Junio de 2026, Bodegas Intermedias por Máquina, Proxy de Reportes JWT y Mejoras de Dashboard (Fase 14 — Extensión) (+11 more)
...
Cohesion: 0.03
Nodes (33): Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor, BodegaFactory, ComponenteMezclaOPFactory, OrdenProduccionFactory, DescargaQuimicosValidacionesTestCase, TestCase, Pruebas de validaciones de entrada de DescargaQuimicosService.descargar_para_op (+25 more)
...
Cohesion: 0.04
Nodes (24): AreaFactory, ConsumoLoteDetalleFactory, MaquinaFactory, MaquinaOeeActionTestCase, ParoMaquinaModelTestCase, ParoMaquinaViewSetTestCase, TestCase, Pruebas de ParoMaquina — downtime de máquina con reason codes (Seis Grandes Pérd (+16 more)
...
Cohesion: 0.10
Nodes (12): get_current_user(), _get_object_sede_id(), Validaciones de negocio que requieren contexto de auditoría.         Se llama au, Obtiene sede_id del objeto para filtrar logs de entidades eliminadas.     Priori, audit_user_delete(), _create_audit_for_model(), _delete_audit_for_model(), Registra eliminación de usuarios en auditoría. (+4 more)

### Community 119 - "TransformacionAPIViewTestCase"
Cohesion: 0.13
Nodes (14): _get_model_audit_data(), _get_user_audit_data(), Extrae datos auditables de cualquier modelo (solo campos normales, no M2M)., Extrae datos auditables del usuario (solo PKs para FKs)., _FakeField, _FakeMeta, _FakeModeloConCampoRoto, _FakeUsuarioConCampoRoto (+6 more)

### Community 120 - "Servicio Satélite de Impresión — TexCore"
Cohesion: 0.09
Nodes (20): build_scan_record(), get_audit_repo(), Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., get_validation_service(), AuditRepository, BackgroundTasks, Request (+12 more)

### Community 121 - "produccion_kpi_service.py"
Cohesion: 0.19
Nodes (6): ProduccionKPIService, Calcula KPIs de producción filtrados opcionalmente por sede.      Uso:         s, ProduccionKPIServiceTendenciaTest, ProduccionKPIServiceTest, SimpleTestCase, TestCase
...
Cohesion: 0.13
Nodes (7): EP parcial: pedido 1000, pago 600 → monto_pagado 600, no pagado., BVA exacto: pago == valor → monto_pagado == valor y esta_pagado., STT FIFO: pedido1 (500) + pedido2 (1000); pago 800 →         pedido1 pagado comp, El API de pedidos expone monto_pagado y porcentaje_pagado., STT reversión: revertir el único abono deja monto_pagado en 0., EP no marcado: pago > deuda sin es_anticipo → 400 (previene typos)., EP marcado: es_anticipo=True permite pago > deuda.
...
Cohesion: 0.08
Nodes (10): Crea el despacho (HistorialDespacho + detalles + MovimientoInventario VENTA)., Revierte un pago deshaciendo el abono registrado.          Validaciones:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueErro, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - Múlt, Caso 4: Reversión es transaccional          Verifica:         - Si falla un paso, Caso 1: Revertir pago restaura deuda del cliente          Verifica:         - De, P0-005: pago + reconciliación en una sola transacción, con lock         pesimist, Artefacto RUP: Eliminación de Pago con Reversión         Caso de Uso: CU-Reversi (+2 more)

### Community 140 - "RegistrarTransformacion.test.tsx"
Cohesion: 0.11
Nodes (10): _crear_pedido(), EP rol permitido: vendedor revierte pagos de SUS clientes., EP monto inválido: pago > deuda → 400 y no se persiste., BVA límite exacto: pago == deuda → 201 y pedido queda pagado., BVA límite inferior: monto == 0 → 400., EP monto inválido: monto negativo → 400., STT: error post-save → rollback total, sin pago huérfano sin reconciliar., STT: pedido1 ANULADO (1000) + pedido2 activo (500); pago de 500.         El pago (+2 more)
...
Cohesion: 0.22
Nodes (4): Emite log estructurado para trazabilidad ISO 27001 A.12.4.          Args:, AuditLoggerTestCase, TestCase, Pruebas de internal_api/audit.py — AuditLogger.log.  Técnicas ISTQB aplicadas: -
...
Cohesion: 0.25
Nodes (3): Valida que el path del reporte sea seguro.     Previene Path Traversal y acceso, _validate_report_path(), ValidateReportPathTestCase
...
Cohesion: 0.03
Nodes (70): Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente en, Migration, ClienteManager, CostoHoraMaquina, LoteProduccion, Meta, OrdenProduccion, Tarifa vigente de un operario; vigente_hasta NULL = sin fecha de fin. (+62 more)

### Community 245 - "📊 Monitoreo y Mantenimiento"
Cohesion: 0.12
Nodes (12): _register_inventory_signals(), DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, DetalleHistorialDespacho, HistorialDespacho (+4 more)

### Community 246 - "🔧 Paso 1: Instalación de Dependencias Base"
Cohesion: 0.29
Nodes (4): HistorialDespachoUnitTests, TestCase, Prueba el endpoint del ViewSet, Un usuario no autenticado no debe poder acceder al historial
...
Cohesion: 0.14
Nodes (9): MovimientoInventarioUpdateSerializer, Serializer para actualizar movimientos de inventario.     Solo permite editar ca, Serializer para validar los datos de entrada de una transferencia entre bodegas., Valida que la bodega de origen y destino no sean la misma., TransferenciaSerializer, MovimientoUpdateSerializerTestCase, TestCase, Pruebas de validación de inventory/serializers.py.  Cubre MovimientoInventarioUp (+1 more)
...
### Community 314 - "@radix-ui/react-checkbox"
Cohesion: 0.67
...
### Community 329 - "Documento de Contexto y Decisión Arquitectónica: TexCore — Sistema de gestión de órdenes de producción"
Cohesion: 0.50
...
## Knowledge Gaps
- **1633 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1628 more)
...
- **Why does `LoteValidationService` connect `RFC5424Formatter` to `Análisis del Rol de Vendedor - Sistema TexCore`, `react-resizable-panels`, `Servicio Satélite de Impresión — TexCore`, `ValidateResponse`, `NotaVentaRequest`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `LoteProduccion` connect `7. Flujos de Negocio Criticos` to `FormulaColor`, `AdminSistemasDashboard.tsx`, `ConsumoMezclaServiceConsumir`, `CHANGELOG.md`, `LoteProduccion`, `HasScope`, `AreaFactory`, `LineaProduccionViewSetTestCase`, `ServiceTokenRefreshViewTestCase`, `HistorialDespachoViewSet`, `EjecutivosDashboard.test.tsx`, `Documentación Técnica: Sistema de Reversión de Pagos del Cliente`, `compilerOptions`, `EjecutivosDashboard.reportes.test.tsx`, `RFC5424Formatter`, `Esquema de Base de Datos y Modelo de Negocio`, `.hash_secret`, `react-resizable-panels`, `Análisis de Errores Críticos (P0)`, `ExecutiveKPIService`, `AuditRepository`, `ImageWithFallback.tsx`, `ReportService`, `📊 Monitoreo y Mantenimiento`, `package.json`, `🔧 Paso 1: Instalación de Dependencias Base`, `produccion_kpi_service.py`, `SubprocesoStateMachineTestCase`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `CustomUserFactory` connect `ConsumoMezclaServiceConsumir` to `Módulo de Inventario`, `ComponenteMezclaOPFactory`, `LoteProduccion`, `HasScope`, `AreaFactory`, `EjecutivosDashboard.tsx`, `StockBodega`, `LineaProduccionViewSetTestCase`, `HistorialDespachoViewSet`, `_make_pedido`, `Plan de Estabilización, Consolidadación y Despliegue a Producción — TexCore`, `EjecutivosDashboard.reportes.test.tsx`, `LoteValidationService`, `Command`, `TestServiceTokenView`, `ImageWithFallback.tsx`, `ReportService`, `DespachReversionAPITestCase`, `📊 Monitoreo y Mantenimiento`, `SubprocesoStateMachineTestCase`?**
...
- **Are the 196 inferred relationships involving `LoteProduccion` (e.g. with `BodegaAdmin` and `BodegueroInline`) actually correct?**
  _`LoteProduccion` has 196 INFERRED edges - model-reasoned connections that need verification._
- **Are the 177 inferred relationships involving `Producto` (e.g. with `BodegaAdmin` and `BodegueroInline`) actually correct?**
  _`Producto` has 177 INFERRED edges - model-reasoned connections that need verification._
- **Are the 179 inferred relationships involving `PedidoVenta` (e.g. with `BodegaAdmin` and `BodegueroInline`) actually correct?**
  _`PedidoVenta` has 179 INFERRED edges - model-reasoned connections that need verification._