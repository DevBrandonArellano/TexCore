# Graph Report - TexCore  (2026-08-31)

## Corpus Check
- 706 files · ~1,023,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7652 nodes · 16504 edges · 484 communities (381 shown, 103 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1819 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a278382c`
...
## Communities (484 total, 103 thin omitted)

### Community 0 - "cn"
Cohesion: 0.02
Nodes (114): Decimal, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, MateriaPrimaService, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-TrazabilidadMateriaPrima (F0-0, Registro de entradas de MP del proveedor y consumo en producción., Registra la recepción de un lote de materia prima del proveedor.          Crea e, DetalleHistorialDespachoAdmin (+106 more)

### Community 1 - "InventoryDashboard.tsx"
Cohesion: 0.04
Nodes (79): AdminSistemasDashboard(), InventoryDashboard(), ManageAreas(), ManageAreasProps, AREA_1, SEDE_1, SEDE_2, toastErrorMock (+71 more)

### Community 2 - "FormulaColor"
Cohesion: 0.03
Nodes (33): get_user_role(), APIView, UserProfileView, CustomUserFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, Pruebas de gestion/views/core_views.py — SedeViewSet, AreaViewSet, CustomUserVie (+25 more)

### Community 3 - "AdminSistemasDashboard.tsx"
Cohesion: 0.04
Nodes (95): AbstractUser, BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Carga ~1,000,000 registros para estresar el aplicativo TexCore.  Usa bulk_create (+87 more)

### Community 4 - "MovimientoInventario"
Cohesion: 0.02
Nodes (101): Command, BaseCommand, make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la d, Factory para crear clases de permiso basadas en grupos de Django.      Otorga ac, AnulacionPedidoSerializer, ModificacionPedidoSerializer, ConsumoMezclaService (+93 more)

### Community 5 - "ConsumoMezclaServiceConsumir"
Cohesion: 0.09
Nodes (48): BaseAuthentication, JWTServiceAuthentication, Request, DRF Authentication backend para JWT de servicio (RS256).     Retorna None si no, IsInternalService, BasePermission, Permite acceso solo si el request fue autenticado como ServicePrincipal., URLs de la API interna. Namespace: internal_api. (+40 more)

### Community 6 - "ComponenteMezclaOPFactory"
Cohesion: 0.13
Nodes (22): EmpaquetadoDashboard(), PackagingFormValues, packagingSchema, toLocalDatetimeInput(), AlertasInventarioPanel, AlertasInventarioPanelImpl(), AlertasInventarioPanelProps, Alert() (+14 more)

### Community 7 - "LoteProduccion"
Cohesion: 0.04
Nodes (37): DjangoModelFactory, DetalleFormulaFactory, EventoEtiquetaFactory, FaseRecetaFactory, FormulaColorFactory, Meta, Factories para tests de TexCore — usa factory_boy.  Convención: - Cada factory c, TransformacionProductoFactory (+29 more)

### Community 8 - "MaquinaFactory"
Cohesion: 0.05
Nodes (23): OrdenProduccionEstadoSerializer, Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., OrdenProduccionFactory, ConsumoMezclaServiceConsumir, ConsumoMezclaServiceRevertir, TestCase, TDD — ConsumoMezclaService. COBIT DSS06 + ISO 27001 A.12.4. (+15 more)

### Community 9 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.02
Nodes (35): BodegaFactory, StockBodegaFactory, DescargaQuimicosValidacionesTestCase, TestCase, Pruebas de validaciones de entrada de DescargaQuimicosService.descargar_para_op, LoteProduccionViewSetTestCase, MovimientoReversionService, Revierte el efecto de stock de un MovimientoInventario y deja un     movimiento (+27 more)
...
Cohesion: 0.05
Nodes (22): LoteProduccionFactory, ParoMaquinaFactory, KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase, ParsearRangoFechasTestCase, ProduccionHistorialProductoViewTestCase, ProduccionPorProductoImprimirViewTestCase (+14 more)
...
Cohesion: 0.05
Nodes (26): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, TransformacionService, ProductoFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase (+18 more)

### Community 14 - "Command"
Cohesion: 0.10
Nodes (62): ApprovalRequests(), ManageBodegas(), ManageClientes(), ManageFormulas(), ManageProductos(), ManageQuimicos(), ManageQuimicosProps, Group (+54 more)
...
Cohesion: 0.07
Nodes (89): AuditoriaDialogProps, EditarMovimientoDialogProps, EliminarMovimientoDialogProps, GuiaRemisionModal(), GuiaRemisionModalProps, MOTIVOS_TRASLADO, DetalleHistorial, HistorialDespacho (+81 more)
...
Cohesion: 0.03
Nodes (46): GroupSerializer, Meta, SedeSerializer, BatchSerializer, DetalleFormulaEscrituraSerializer, FaseRecetaEscrituraSerializer, FaseRecetaSerializer, FormulaColorSerializer (+38 more)

### Community 20 - "HistorialDespachoViewSet"
Cohesion: 0.08
Nodes (13): Prueba que el despacho falle si no se proporcionan lotes., Prueba que el despacho falle si se proporciona un código de lote inválido., Prueba que el Kardex se puede filtrar por proveedor_id y devuelve nombres y códi, Suite única de pruebas para validar el funcionamiento del sistema TexCore.     C, Verifica el registro de múltiples pagos y saldo a favor., Verifica que un cliente moroso NO pueda generar nuevos pedidos a crédito., Verifica que un vendedor pueda registrar un pago para su cliente a través de la, Verifica que solo vendedores/admins puedan cambiar el beneficio del cliente. (+5 more)

### Community 21 - "ProductoFactory"
Cohesion: 0.07
Nodes (51): AdminSedeDashboard(), ClienteComprasModal(), ClienteComprasModalProps, ClienteDeudorModal(), ClienteDeudorModalProps, PedidosEstadoModal(), PedidosEstadoModalProps, ProductoHistorialModal() (+43 more)

### Community 22 - "pdf_produccion_views.py"
Cohesion: 0.10
Nodes (12): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., MaquinaConMermaFactory, MermaStockServiceRegistrarTest, MermaStockServiceRevertirTest, TestCase, TDD — MermaStockService.registrar(). ISO 27001 A.12.4 + COBIT MEA01., STT: merma registrada → lote rechazado → stock revertido. (+4 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.03
Nodes (72): AppContent(), getData(), AuditoriaDialog(), LOG_1, mockGet, AlertasStockView(), BodegueroDashboard(), EditarMovimientoDialog() (+64 more)

### Community 24 - ".consumir_materia_prima"
Cohesion: 0.02
Nodes (126): react, AccordionContent(), AccordionItem(), AccordionTrigger(), AlertDialogOverlay(), Avatar(), AvatarFallback(), AvatarImage() (+118 more)
...
Cohesion: 0.05
Nodes (61): InventoryDashboardProps, calcularSaldoAcumulado(), normalizeBodegaKey(), StockItem, TransferFormData, validateTransfer(), KardexView, KardexViewImpl() (+53 more)

### Community 27 - "Documentación Técnica: Sistema de Reversión de Pagos del Cliente"
Cohesion: 0.05
Nodes (31): Environment, PlainTextResponse, get_pdf_strategy(), get_zpl_strategy(), PdfOutputStrategy, Genera PDF a partir de un template HTML con WeasyPrint., Genera texto ZPL a partir de un template Jinja2., ZplOutputStrategy (+23 more)

### Community 28 - "NotaVentaRequest"
Cohesion: 0.06
Nodes (41): claseSeveridadEficiencia(), JefePlantaDashboard(), logger, toastErrorMock, toastSuccessMock, RFC-5424, UsuarioBasico, logger (+33 more)
...
Cohesion: 0.06
Nodes (25): AreaSerializer, DosificacionSerializer, Serializer de entrada para el endpoint de calculo de dosificacion., calcular_dosificacion_gr_l(), calcular_dosificacion_pct(), DosificacionCalculator, Decimal, Servicio de calculo de dosificacion para formulas de tintoreria.  Metodos de cal (+17 more)

### Community 31 - "OrdenProduccionFactory"
Cohesion: 0.15
Nodes (10): ProduccionKPIService, Calcula KPIs de producción filtrados opcionalmente por sede.      Uso:         s, ProduccionKPIServiceHistorialProductoTest, ProduccionKPIServicePorProductoTest, ProduccionKPIServiceTendenciaTest, ProduccionKPIServiceTest, SimpleTestCase, TestCase (+2 more)
...
Cohesion: 0.07
Nodes (49): Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., generate_balance_masas_pdf(), generate_etiqueta_pdf() (+41 more)

### Community 38 - "Plan de Estabilización, Consolidadación y Despliegue a Producción — TexCore"
Cohesion: 0.05
Nodes (39): class-variance-authority, clsx, embla-carousel-react, dependencies, class-variance-authority, clsx, embla-carousel-react, input-otp (+31 more)
...
Cohesion: 0.13
Nodes (12): _fecha_hasta_exclusiva(), get_kardex(), get_lotes_produccion(), get_resumen_movimientos(), get_rotacion(), get_tendencia_produccion(), get_top_clientes_gerencial(), get_top_clientes_vendedor() (+4 more)
...
Cohesion: 0.07
Nodes (36): generate_nota_venta_pdf(), Genera la nota de venta en PDF.     - **data**: Datos completos del pedido inclu, DetallePedido, NotaVentaRequest, Un renglón del pedido con su peso, precio y condición de IVA., DTO de entrada para generación de nota de venta.     SRP: solo transporta datos, DocumentService, DetallePedido (+28 more)
...
Cohesion: 0.13
Nodes (18): Base, ReportAuditLog, AuditRepository, get_audit_repo(), IAuditRepository, Protocol, AuditRepository de reporting_excel: persiste eventos de auditoría en SQLite. DIP, Contrato de auditoría para reporting_excel. (+10 more)
...
Cohesion: 0.06
Nodes (32): MateriaPrimaLoteSerializer, Entrada del endpoint registrar_entrada — la creación real la hace el servicio., RegistrarMateriaPrimaSerializer, CostoLoteProduccionSerializer, CostoLoteService, Tarifa vigente a la fecha; vigente_hasta NULL = contrato abierto., Costo/hora vigente a la fecha; vigente_hasta NULL = sin fecha fin., Calcula y persiste el desglose de costos de un lote de producción. (+24 more)
...
Cohesion: 0.14
Nodes (14): date, KardexParams, BaseModel, RangoFechaParams, Schemas Pydantic para parámetros de los reportes. ISP: un schema por caso de uso, Parámetros comunes para reportes con rango de fechas y sede opcional., Parámetros para reportes por vendedor., StockParams (+6 more)
...
Cohesion: 0.15
Nodes (11): dataframe_to_excel_bytes(), _fecha_a_texto(), _prepare_df_for_excel(), DataFrame, Convierte cualquier fecha a texto limpio: dd-mm-yyyy (solo fecha), Todo a string limpio ASCII. Fechas como dd-mm-yyyy (solo fecha)., Genera Excel con xlsxwriter. Escribe Fecha explícitamente como string ASCII., Elimina caracteres no imprimibles que causan iconos de error en Excel. (+3 more)
...
Cohesion: 0.07
Nodes (30): 10 de Julio de 2026, 13 de Julio de 2026, 1 de Julio de 2026, 20 de Julio de 2026, 21 de Julio de 2026, 22 de Julio de 2026, 22 de Julio de 2026, 22 de Julio de 2026 (2) (+22 more)
...
Cohesion: 0.09
Nodes (17): EventoEtiqueta, RegistrarLoteProduccionSerializer, LoteProduccion, Copia idéntica: mantiene la version de datos vigente, solo avanza la secuencia., Cambio de datos: anula la última etiqueta vigente y emite una nueva version., _snapshot_actual(), _crear_lote(), _crear_orden() (+9 more)

### Community 85 - "EmpaquetadoDashboard.test.tsx"
Cohesion: 0.13
Nodes (8): _fake_request(), TestCase, Request mínimo: resolve_sede_scope solo usa .user y .query_params.get., Caja blanca de la resolución de sede en las vistas internas., ResolveSedeScopeTestCase, _audit(), Resuelve la sede a aplicar en un reporte interno como DEFENSA EN PROFUNDIDAD., resolve_sede_scope()

### Community 86 - "main.py"
Cohesion: 0.07
Nodes (7): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 2700, JWTServiceAuthenticationExtraTestCase, TestCase, Pruebas complementarias de internal_api/authentication.py — ramas que test_authe, TestPdfProduccionViews, Round-trip del claim de sede firmado en el JWT de servicio., ServiceTokenSedeClaimTestCase
...
Cohesion: 0.09
Nodes (26): BuildBalanceMasasPayloadTestCase, BuildReporteAvancePayloadTestCase, APITestCase, Función pura (sin ORM en su firma): mapea registros ya materializados     (dicts, Función pura: reconcilia stock actual + movimientos del mes por producto.     Cu, _audit(), BalanceMasasPdfView, _build_balance_masas_payload() (+18 more)

### Community 110 - "EditarMovimientoDialog.test.tsx"
Cohesion: 0.11
Nodes (10): TestCase, IDOR: un no-admin CON sede que envía ?sede_id ajeno es sobrescrito por         s, IDOR: un no-admin SIN sede que envía ?sede_id ajeno queda con el         parámet, Si falta bodega_id en un reporte restringido, debe dar 400, Sin autenticación no hay acceso, Un bodeguero DEBE poder acceder a reportes de su bodega asignada, Un bodeguero NO DEBE poder acceder a reportes de una bodega no asignada, Un administrador puede acceder a CUALQUIER bodega (+2 more)
...
Cohesion: 0.13
Nodes (14): Arquitectura, Auditoría Local (ISO 27001 A.12.4), Autenticación con Backend (Fase 13), Despliegue, Endpoint, Estructura, `GET /health`, Patrón SOLID en los Routers (DIP) (+6 more)

### Community 131 - "PrecisionDecimalInventoryTestCase"
Cohesion: 0.05
Nodes (22): AreaFactory, ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, MaquinaFactory, MaquinaOeeActionTestCase, ParoMaquinaModelTestCase, ParoMaquinaViewSetTestCase, TestCase (+14 more)

### Community 132 - "Diagramas de Secuencia — Usuarios Principales del Sistema TexCore"
Cohesion: 0.11
Nodes (15): Any, OutputStrategy, Protocol, Response, Strategy Pattern para formatos de salida del printing_service. OCP: agregar un n, Contrato para estrategias de generación de documentos., Renderiza el template con el contexto dado y retorna la Response HTTP., Saneamiento de valores de texto antes de interpolarlos en un template ZPL. SRP: (+7 more)
...
Cohesion: 0.08
Nodes (18): DefaultContentNegotiation, async_export_report(), Tarea asíncrona para generar reportes pesados sin bloquear a Gunicorn.      Igua, Tarea asíncrona para el cálculo completo del MRP (Material Requirements Planning, run_mrp_calculation(), AsyncExportReportTestCase, TestCase, Pruebas de gestion/tasks.py — tareas asíncronas Celery.  async_export_report: co (+10 more)

### Community 145 - "CONTEXTO — Análisis Exhaustivo de TexCore para Revisión Fable 5"
Cohesion: 0.05
Nodes (21): PrintingServiceGuiaRemisionPdfTestCase, PrintingServiceHistorialDespachosPdfTestCase, PrintingServiceLabelPdfTestCase, PrintingServiceNotaVentaPdfTestCase, PrintingServiceProduccionPorProductoPdfTestCase, PrintingServiceUrlResolutionTestCase, PrintingServiceZplTestCase, TestCase (+13 more)
...
Cohesion: 0.05
Nodes (41): ManageClientesProps, DeudorExtendido, VentasTabProps, AnularPedidoModal, ClienteDetailDialog, ClienteDetailDialogImpl(), ClienteDetailDialogProps, HistorialPedidoModal (+33 more)
...
Cohesion: 0.32
Nodes (3): HistorialDespachoFiltrosFechaTestCase, TestCase, Pruebas complementarias de HistorialDespachoViewSet.get_queryset — filtros por f
...
### Community 316 - "@radix-ui/react-collapsible"
Cohesion: 0.40
...
### Community 317 - ".test_despacho_atomicidad"
Cohesion: 0.04
Nodes (47): clear_cascade_justification(), get_cascade_justification(), get_current_ip(), get_current_user(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), AuditLog, _get_object_sede_id() (+39 more)
...
### Community 323 - "@radix-ui/react-select"
Cohesion: 0.40
...
### Community 325 - "@radix-ui/react-separator"
Cohesion: 0.40
...
### Community 326 - "@radix-ui/react-slider"
Cohesion: 0.40
...
### Community 327 - "@radix-ui/react-switch"
Cohesion: 0.40
...
### Community 328 - "@radix-ui/react-toggle"
Cohesion: 0.40
...
### Community 355 - "deploy_production.ps1"
Cohesion: 0.50
...
### Community 356 - "react-resizable-panels"
Cohesion: 0.50
...
### Community 370 - "deploy_production.sh script"
Cohesion: 0.67
...
## Knowledge Gaps
- **1854 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1849 more)
...
- **Why does `TestFechaATexto` connect `coverage_html_cb_6fb7b396.js` to `Recursos Algorítmicos y Técnicas de Optimización en TexCore`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `ExcelFormatter` connect `Recursos Algorítmicos y Técnicas de Optimización en TexCore` to `coverage_html_cb_6fb7b396.js`, `Endpoints`?**
...
- **What connects `ASGI config for TexCore project.  It exposes the ASGI callable as a module-level`, `RFC 5424 Syslog Formatter — TexCore Backend (Django) ===========================`, `Formatter RFC 5424 para Django/Python logging.      Produce una línea por regist` to the rest of the system?**
  _2741 weakly-connected nodes found - possible documentation gaps or missing edges._