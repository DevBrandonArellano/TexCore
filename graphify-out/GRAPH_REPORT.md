# Graph Report - TexCore  (2026-08-25)

## Corpus Check
- 684 files · ~854,478 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7442 nodes · 15922 edges · 473 communities (375 shown, 98 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1706 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65813097`
...
- .test_despacho_validacion_lote_sin_stock
- .test_despacho_validacion_lote_con_stock
- 0002_detallehistorialdespacho_pedido.py

## God Nodes (most connected - your core abstractions)
1. `CustomUserFactory` - 372 edges
2. `cn()` - 221 edges
3. `SedeFactory` - 202 edges
4. `ProductoFactory` - 149 edges
5. `AreaFactory` - 113 edges
6. `OrdenProduccionFactory` - 107 edges
7. `StockBodega` - 101 edges
8. `Sede` - 85 edges
9. `MaquinaFactory` - 85 edges
10. `Producto` - 84 edges
...
## Communities (473 total, 98 thin omitted)

### Community 0 - "cn"
Cohesion: 0.02
Nodes (127): react, AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage(), BreadcrumbEllipsis() (+119 more)

### Community 1 - "InventoryDashboard.tsx"
Cohesion: 0.03
Nodes (34): get_user_role(), ClienteFactory, CustomUserFactory, ChemicalViewSetTestCase, ProductoViewSetTestCase, ProveedorViewSetTestCase, TestCase, Pruebas de gestion/views/catalog_views.py — ChemicalViewSet, ProductoViewSet, Pr (+26 more)
...
Cohesion: 0.11
Nodes (15): OeeService, Decimal, OeeService: calcula el Overall Equipment Effectiveness (OEE) por máquina o área., RUP - Capa de Servicio: ProduccionKPIService ===================================, KPIAreaView, KpiEjecutivoView, PlantaPulsoDiarioView, ProduccionResumenView (+7 more)
...
Cohesion: 0.03
Nodes (87): AuditLog, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, Vistas de generación de PDFs de producción para internal_api.  Arquitectura:   -, DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin (+79 more)

### Community 6 - "ComponenteMezclaOPFactory"
Cohesion: 0.04
Nodes (36): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, Meta, ParoMaquinaFactory, Factories para tests de TexCore — usa factory_boy.  Convención: - Cada factory c, TransformacionProductoFactory (+28 more)

### Community 7 - "LoteProduccion"
Cohesion: 0.12
Nodes (49): ApprovalRequests(), ManageProductosProps, ManageProveedoresProps, Group, SedesSidebarImpl(), getSedeStats(), StockView, StockViewProps (+41 more)

### Community 9 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.04
Nodes (25): EventoEtiquetaFactory, OrdenProduccionFactory, DescargaQuimicosValidacionesTestCase, TestCase, Pruebas de validaciones de entrada de DescargaQuimicosService.descargar_para_op, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Trans, ISTQB STT — Transiciones legales en la máquina de estados. (+17 more)

### Community 10 - "UnifiedBusinessLogicTestCase"
Cohesion: 0.05
Nodes (82): AbstractUser, BodegaAdmin, BodegueroInline, LineaProduccionAdmin, TransformacionProductoAdmin, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Carga ~1,000,000 registros para estresar el aplicativo TexCore.  Usa bulk_create, Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente en (+74 more)

### Community 11 - "HasScope"
Cohesion: 0.05
Nodes (44): claseSeveridadEficiencia(), JefePlantaDashboard(), logger, toastErrorMock, toastSuccessMock, RFC-5424, UsuarioBasico, logger (+36 more)

### Community 12 - "VendedorDashboard.tsx"
Cohesion: 0.10
Nodes (13): TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de Eq, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_cr, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3)., EP Clase Inválida + BVA: -0.001 viola el CheckConstraint de BD.         La restr, Tests del comportamiento de auditoría del Cliente.     Verifica que se requiera (+5 more)
...
Cohesion: 0.08
Nodes (19): EventoEtiqueta, LoteProduccion, Copia idéntica: mantiene la version de datos vigente, solo avanza la secuencia., Cambio de datos: anula la última etiqueta vigente y emite una nueva version., _snapshot_actual(), _crear_lote(), _crear_orden(), EventoEtiquetaModelTests (+11 more)

### Community 15 - "EjecutivosDashboard.tsx"
Cohesion: 0.09
Nodes (77): InventoryDashboardProps, StockItem, KardexView, KardexViewProps, RegistrarEntradaView, RegistrarEntradaViewProps, ReportesView, ReportesViewImpl() (+69 more)
...
Cohesion: 0.04
Nodes (31): BodegaFactory, StockBodegaFactory, MovimientoReversionService, Revierte el efecto de stock de un MovimientoInventario y deja un     movimiento, Revierte una entrada: resta de la bodega donde había entrado., Revierte una salida: devuelve a la bodega de donde había salido., MovimientoMermaCreateTestCase, TestCase (+23 more)

### Community 19 - "ServiceTokenRefreshViewTestCase"
Cohesion: 0.03
Nodes (105): AdminSistemasDashboard(), InventoryDashboard(), ManageAreas(), ManageAreasProps, AREA_1, SEDE_1, SEDE_2, toastErrorMock (+97 more)

### Community 20 - "HistorialDespachoViewSet"
Cohesion: 0.03
Nodes (49): clear_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), ParoMaquina, Registro de downtime de máquina, con reason code = las Seis Grandes Pérdidas, make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la d, Factory para crear clases de permiso basadas en grupos de Django.      Otorga ac (+41 more)
...
Cohesion: 0.06
Nodes (59): AdminSedeDashboard(), ManageClientesProps, ClienteComprasModal(), ClienteComprasModalProps, ClienteDeudorModal(), ClienteDeudorModalProps, DeudorExtendido, fmt() (+51 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.07
Nodes (26): DjangoModelFactory, DetalleFormulaFactory, FaseRecetaFactory, FormulaColorFactory, DescargaQuimicosStockInsuficienteTestCase, APITestCase, Tests P0-006: La descarga de químicos NO debe dejar stock negativo. Artefacto RU, BVA límite exacto: stock 10 kg, requiere 10 kg → éxito, stock final 0. (+18 more)

### Community 24 - ".consumir_materia_prima"
Cohesion: 0.03
Nodes (81): AppContent(), AuditoriaDialog(), LOG_1, mockGet, AlertasStockView(), BodegueroDashboard(), DespachoDashboard(), GuiaRemisionModal() (+73 more)

### Community 26 - "Auditoría y Mejoras del Rol Jefe de Área"
Cohesion: 0.14
Nodes (7): _fake_request(), Request mínimo: resolve_sede_scope solo usa .user y .query_params.get., Caja blanca de la resolución de sede en las vistas internas., ResolveSedeScopeTestCase, _audit(), Resuelve la sede a aplicar en un reporte interno como DEFENSA EN PROFUNDIDAD., resolve_sede_scope()
...
Cohesion: 0.04
Nodes (44): ConsumoMateriaPrima, MateriaPrimaLote, Through-table: LoteProduccion <-> MateriaPrimaLote (inmutable post-registro), ConsumoMateriaPrimaSerializer, MateriaPrimaLoteSerializer, Meta, Entrada del endpoint registrar_entrada — la creación real la hace el servicio., RegistrarMateriaPrimaSerializer (+36 more)
...
Cohesion: 0.10
Nodes (15): LoteProduccion, Registra el consumo de uno o más lotes de MP en un lote producido.          cons, ConsumoMateriaPrimaTestCase, MateriaPrimaRegistroTestCase, TestCase, EP inválida: costo < 0 → ValidationError., EP duplicado: mismo (proveedor, lote, fecha) viola unique_together., Consumo de MP en producción — EP + BVA + trazabilidad STT. (+7 more)

### Community 35 - "get_session_factory"
Cohesion: 0.06
Nodes (37): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., AuditRepository, BackgroundTasks, Router HTTP para validación de lotes. DIP: get_validation_service y get_audit_re (+29 more)

### Community 36 - "dependencies"
Cohesion: 0.05
Nodes (39): axios, class-variance-authority, embla-carousel-react, dependencies, axios, class-variance-authority, embla-carousel-react, @hookform/resolvers (+31 more)

### Community 37 - "Documentación: Descarga Automática de Químicos en Tintorería"
Cohesion: 0.07
Nodes (22): HistorialDespacho, Revierte registros de DescargaQuimicoOP asociados a los pedidos del despacho., Revierte un despacho existente:         1. Restaura stock en cada bodega origen, DespachoReversionFKTestCase, TestCase, EP legado: detalle sin FK (datos pre-migración) usa el string., EP sin nada: ni FK ni string válido → la reversión debe FALLAR con         error, La reversión debe usar la FK al movimiento original, no un string. (+14 more)
...
Cohesion: 0.10
Nodes (15): JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación.      `sede_i, ServicePrincipal, HasScope, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. COB, Verifica que el ServicePrincipal tiene el scope requerido.     Uso: permission_c, HasScopeTestCase, IsInternalServiceTestCase (+7 more)

### Community 42 - "logger.ts"
Cohesion: 0.06
Nodes (33): CostoLoteProduccionSerializer, LoteProduccionSerializer, RegistrarLoteProduccionSerializer, ConsumoMezclaService, SRP: gestiona el consumo de múltiples lotes de entrada para producir un lote de, CostoLoteService, Calcula y persiste el desglose de costos de un lote de producción., EventoEtiquetaService (+25 more)
...
Cohesion: 0.09
Nodes (20): Environment, Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, generate_zpl_label(), get_zpl_strategy(), AuditRepository, BackgroundTasks, Router para generación de etiquetas ZPL. DIP: get_zpl_strategy y get_audit_repo, Strategy Pattern para formatos de salida del printing_service. OCP: agregar un n (+12 more)
...
Cohesion: 0.11
Nodes (36): build_print_record(), Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, generate_balance_masas_pdf(), generate_etiqueta_pdf(), generate_guia_remision_pdf(), generate_historial_despachos_pdf(), generate_nota_venta_pdf(), generate_reporte_avance_pdf() (+28 more)

### Community 49 - "EjecutivosDashboard.reportes.test.tsx"
Cohesion: 0.09
Nodes (23): DetallePedido, NotaVentaContexto, NotaVentaRequest, Un renglón del pedido con su peso, precio y condición de IVA., DTO de entrada para generación de nota de venta.     SRP: solo transporta datos, Schema enriquecido con cálculos ya realizados por DocumentService.     Es el obj, DocumentService, DetallePedido (+15 more)
...
Cohesion: 0.06
Nodes (40): _apply_pragmas(), Base, get_session_factory(), init_db(), _make_engine(), _make_session_factory(), async_sessionmaker, AsyncSession (+32 more)
...
Cohesion: 0.09
Nodes (27): Base, DeclarativeBase, PrintAuditLog, Base, PrintAuditLog: modelo ORM del registro de auditoría de documentos generados. SRP, AuditRepository, get_audit_repo(), IAuditRepository (+19 more)
...
Cohesion: 0.08
Nodes (26): 10 de Julio de 2026, 13 de Julio de 2026, 1 de Julio de 2026, 21 de Julio de 2026, 22 de Julio de 2026, 22 de Julio de 2026 (2), 22 de Julio de 2026 (3), 22 de Julio de 2026 (+18 more)
...
Cohesion: 0.10
Nodes (29): ESTADO_BADGE, ManageLineasProps, ESTADO_BADGE, ManageMaquinasProps, mockGet, NIVEL_CON_PASOS_Y_SIGUIENTE, NIVEL_SIN_PASOS, TrazabilidadProducto() (+21 more)

### Community 69 - "test_exports.py"
Cohesion: 0.07
Nodes (19): AuditMiddleware, _extract_client_ip(), get_cascade_justification(), _is_trusted_proxy(), Verifica si una IP pertenece a una red de proxy de confianza., Extrae la IP real del cliente de forma segura.     Solo confía en X-Forwarded-Fo, Middleware para capturar la IP y el usuario de la petición actual,     guardándo, AuditMiddlewareCallTestCase (+11 more)

### Community 70 - "auth_views.py"
Cohesion: 0.02
Nodes (73): Command, BaseCommand, Command, BaseCommand, ConsumoLoteDetalleSerializer, ParoMaquinaSerializer, Downtime de máquina con reason code (Seis Grandes Pérdidas — OEE for Operators)., AnulacionPedidoSerializer (+65 more)

### Community 71 - "DespachoDashboard.test.tsx"
Cohesion: 0.05
Nodes (21): AreaFactory, ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, MaquinaFactory, MaquinaOeeActionTestCase, ParoMaquinaModelTestCase, ParoMaquinaViewSetTestCase, TestCase (+13 more)
...
Cohesion: 0.07
Nodes (26): _apply_pragmas(), get_session_factory(), init_db(), _make_engine(), _make_session_factory(), async_sessionmaker, AsyncSession, Módulo de infraestructura de base de datos de auditoría — printing_service. SRP: (+18 more)
...
Cohesion: 0.05
Nodes (17): ProveedorFactory, SedeFactory, AreaViewSetTestCase, ChemicalViewSetExtraTestCase, ProveedorViewSetMultiTenancyTestCase, TestCase, Pruebas complementarias de gestion/views/catalog_views.py — ramas que test_catal, Pruebas para AreaViewSet.      Cubre la ausencia de paginación (pagination_class (+9 more)
...
### Community 90 - "ExecutiveKPIService"
Cohesion: 0.16
Nodes (7): Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., ConsumoMezclaServiceConsumir, ConsumoMezclaServiceRevertir, TestCase, TDD — ConsumoMezclaService. COBIT DSS06 + ISO 27001 A.12.4., STT: mezcla consumida → revertir → stock restaurado.
...
### Community 94 - "pdf.py"
Cohesion: 0.18
Nodes (9): ProduccionKPIs, date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0)         p, Un punto de la serie temporal de producción diaria., Contrato de salida del servicio. Inmutable para garantizar consistencia     entr, Punto de entrada único — Fachada sobre los métodos privados. (+1 more)
...
Cohesion: 0.13
Nodes (11): Escape backslash, double quote, and right bracket as per RFC 5424 §6.3.3, RFC 5424 Syslog Formatter     Format: <PRI>VERSION TIMESTAMP HOSTNAME APP-NAME P, RFC5424Formatter, lifespan(), log_requests_rfc5424(), FastAPI, Request, App factory del reporting_excel — versión independiente (v2.0). Autenticación: J (+3 more)

### Community 104 - "ReportingProxyViewExtraTestCase"
Cohesion: 0.13
Nodes (10): Arquitectura de Capas, Diagrama de flujo de una solicitud PDF, DIP — Inyección de dependencias vía FastAPI `Depends`, Fragilidad operacional eliminada (config.py), Integración con Django, Patrones de Diseño Aplicados y su Justificación, Servicio Satélite de Impresión (`printing_service`), SRP — Separación de responsabilidades (+2 more)
...
### Community 111 - "Area"
Cohesion: 0.13
Nodes (16): _make_detalle(), _make_nota(), DetallePedido, Tests del printing_service — lógica de cálculo de NotaVentaRequest. Aplica técni, ISTQB BVA — total = subtotal + iva - retención., BVA: retención que absorbe todo el valor., ISTQB EP — clases de equivalencia para detalles con y sin IVA., BVA: 1 detalle exacto — caso mínimo con datos. (+8 more)
...
### Community 127 - "SubprocesoStateMachineTestCase"
Cohesion: 0.18
Nodes (6): CookieJWTAuthentication, Backend de autenticación que lee el JWT desde una cookie httponly     en lugar d, CookieJWTAuthenticationTestCase, TestCase, Pruebas del backend de autenticación JWT por cookie — gestion/auth_backends.py., JWTAuthentication
...
Cohesion: 0.19
Nodes (8): async_export_report(), Tarea asíncrona para generar reportes pesados sin bloquear a Gunicorn.     Llama, Tarea asíncrona para el cálculo completo del MRP (Material Requirements Planning, run_mrp_calculation(), AsyncExportReportTestCase, TestCase, Pruebas de gestion/tasks.py — tareas asíncronas Celery.  async_export_report: pr, RunMrpCalculationTestCase
...
Cohesion: 0.16
Nodes (10): _get_required_env(), APIView, Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., Valida que el path del reporte sea seguro.     Previene Path Traversal y acceso, ReportingProxyView, _validate_report_path(), GetRequiredEnvTestCase, TestCase (+2 more)
...
### Community 201 - "10. Decisiones de Arquitectura (ADRs)"
Cohesion: 0.06
Nodes (39): calcularSaldoAcumulado(), normalizeBodegaKey(), TransferFormData, validateTransfer(), KardexViewImpl(), StockViewImpl(), TransferViewImpl(), useKardex() (+31 more)

### Community 202 - "8. Infraestructura y Despliegue"
Cohesion: 0.12
Nodes (6): BodegaViewSetQuerysetTestCase, BodegaViewSetWriteTestCase, TestCase, Pruebas de gestion/views/inventory_views.py — BodegaViewSet.  Cubre el filtrado, Caja blanca de get_queryset: admin ve todo, bodeguero solo asignadas., get_permissions: escritura exige admin_sistemas/admin_sede.
...
### Community 215 - "10.2 Configurar Backups Automáticos"
Cohesion: 0.15
Nodes (13): 21 de Agosto de 2026, 24 de Agosto de 2026, 25 de Agosto de 2026, Agosto 2026, Bugs reales de despacho encontrados probando el flujo end-to-end (con logs reales, no simulados), Despacho parcial robusto — estado real, no todo-o-nada, Ejecutado el plan de división de los 4 archivos "dios" del backend (4 fases, completo), Ejecutado el plan de división de los 6 dashboards "dios" del frontend (6 fases, completo) (+5 more)
...
### Community 219 - "ResolveSedeScopeTestCase"
Cohesion: 0.31
Nodes (4): LoteProduccionZplFallbackSanitizationTestCase, Medio: _build_zpl_fallback interpola producto_desc/empresa (texto libre,     edi, Elimina '^' (prefijo de comando de formato ZPL) y '~' (prefijo de         comand, ZPL local simple, usado si el microservicio de impresión no responde.

### Community 220 - "PedidoVentaOptimizationTest"
Cohesion: 0.16
Nodes (8): OpsEstado, ProduccionKPIService, Distribución de Órdenes de Producción por estado., Calcula KPIs de producción filtrados opcionalmente por sede.      Uso:         s, ProduccionKPIServiceTendenciaTest, ProduccionKPIServiceTest, SimpleTestCase, TestCase
...
Cohesion: 0.07
Nodes (21): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, TransformacionService, ProductoFactory, ProductoViewSetMultiTenancyTestCase, FlujoPreparacionIntegracionTest, TestCase (+13 more)
...
Cohesion: 0.32
Nodes (5): DosificacionCalculator, Calculadora de dosificacion para un bano de tintoreria completo.      Recibe una, Args:             formula_color: Instancia de gestion.models.FormulaColor., DosificacionCalculatorTestCase, TestCase
...
Cohesion: 0.17
Nodes (10): Bodega, DescargaQuimicosService, Decimal, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, Template Method: secuencia fija revertir → descargar.         Se usa al modifica, Servicio de descarga automática de químicos al crear/modificar/eliminar órdenes, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en lo, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator. (+2 more)
...
Cohesion: 0.25
Nodes (8): 📊 Análisis, Normas y Trazabilidad, Arquitectura de Base de Datos, Arquitectura del Proyecto, Diagramas UML, Historias de Usuarios, Módulos del Sistema, Requerimientos, TexCore — Índice de Documentación

### Community 271 - "Docker — Configuración específica por plataforma"
Cohesion: 0.25
Nodes (5): BODEGAS, mockPost, PRODUCTOS, toastErrorMock, toastSuccessMock
...
Cohesion: 0.25
Nodes (6): InventoryFormProps, InventoryHistory(), InventoryHistoryProps, MOVIMIENTO_1, MOVIMIENTO_2, Movimiento
...
Cohesion: 0.07
Nodes (21): F7: listado impreso del historial de despachos (rol Despacho)., F7: Guía de Remisión informativa (no autorizada por el SRI)., IsDespachoReader, IsDespachoWriter, Permiso para PROCESAR despachos (escritura).     Permitidos: admin_sistemas, adm, Permiso para VER el historial de despachos.     Permitidos: admin_sistemas, admi, DespachoEstadoService, DespachoEstadoService — determina el estado real de un PedidoVenta según lo efec (+13 more)
...
### Community 360 - "sonner"
Cohesion: 0.29
Nodes (4): App(), mockAuthState, queryClient, root

### Community 362 - "0001_initial.py"
Cohesion: 0.40
...
## Knowledge Gaps
- **1728 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1723 more)
...
- **Why does `CustomUserFactory` connect `InventoryDashboard.tsx` to `test_vendedores.py`, `ComponenteMezclaOPFactory`, `TestJWTTokenManager`, `ManageOrdenesProduccion.tsx`, `UnifiedBusinessLogicTestCase`, `Command`, `CookieJWTAuthentication`, `ProductoFactory`, `EjecutivosDashboard.test.tsx`, `ValidateResponse`, `compilerOptions`, `FormulaQuimica.tsx`, `VendedorDashboard.detalle.test.tsx`, `DespachoDashboard.test.tsx`, `8. Infraestructura y Despliegue`, `Esquema de Base de Datos y Modelo de Negocio`, `🛠 Detalle por Rol`, `7. TESTING — ESTÁNDAR ISTQB`, `ExecutiveKPIService`, `ResolveSedeScopeTestCase`, `7.2 Desde Otra Máquina en la Red`, `MRPEngine`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `StockBodega` connect `ConsumoMezclaServiceConsumir` to `ComponenteMezclaOPFactory`, `ManageOrdenesProduccion.tsx`, `UnifiedBusinessLogicTestCase`, `Command`, `CookieJWTAuthentication`, `HistorialDespachoViewSet`, `EjecutivosDashboard.test.tsx`, `OrdenProduccionFactory`, `ServiceCredential`, `Documentación: Descarga Automática de Químicos en Tintorería`, `compilerOptions`, `logger.ts`, `auth_views.py`, `5. CALIDAD DE CÓDIGO — PRINCIPIOS SOLID Y DRY`, `ExecutiveKPIService`, `7.2 Desde Otra Máquina en la Red`, `main.py`, `3. Puntos Críticos de Comparación`, `Autenticacion JWT RS256 entre Servicios`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `OperarioDashboard.test.tsx`, `LoteProduccion`, `ManageBodegas.test.tsx`, `HasScope`, `EjecutivosDashboard.tsx`, `vite.config.ts`, `pdf_produccion_views.py`, `.consumir_materia_prima`, `Modelos de Inventario para Despacho`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 97 inferred relationships involving `CustomUserFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`CustomUserFactory` has 97 INFERRED edges - model-reasoned connections that need verification._
