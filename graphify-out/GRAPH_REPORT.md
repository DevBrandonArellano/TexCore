# Graph Report - TexCore  (2026-07-14)

## Corpus Check
- 633 files · ~394,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6257 nodes · 15464 edges · 473 communities (327 shown, 146 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 4434 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `87a705e9`
...
## Communities (473 total, 146 thin omitted)

### Community 0 - "Producto"
Cohesion: 0.02
Nodes (144): input-otp, react, AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage() (+136 more)

### Community 1 - "Maquina"
Cohesion: 0.03
Nodes (42): Producto, Continuidad de cadena: entrada = salida de la transformación previa., DescargaQuimicosOPTestCase, FormulaQuimicaTestCase, APITestCase, Suite de pruebas para el modulo de Formulas Quimicas.     Cubre: calculo de dos, Para kg_tela=100 y relacion_bano=10:             volumen = 1000 L, Para kg_tela=100 y relacion_bano=10:             sal (60%): cantidad = (100 * 6 (+34 more)

### Community 2 - "OrdenProduccion"
Cohesion: 0.07
Nodes (65): AreaProcessStep, ComponenteMezclaOP, ConsumoLoteDetalle, DescargaQuimicoOP, EtapaProduccion, OrdenProduccionSubproceso, Define las etapas secuenciales de producción dentro de un área.     Cada etapa, Registra la transferencia de producto de una área a la siguiente.     Cuando un (+57 more)

### Community 3 - "Bodega"
Cohesion: 0.14
Nodes (52): ApprovalRequests(), Group, AuditoriaDialogProps, AlertaStock, EditarMovimientoDialogProps, ItemIncompleto, ScannedItem, DetalleHistorial (+44 more)

### Community 4 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.12
Nodes (65): AuditLog, Bodega, _register_inventory_signals(), AuditoriaMovimiento, DetalleHistorialDespacho, DetalleHistorialDespachoPedido, HistorialDespacho, OrdenCompraSugerida (+57 more)

### Community 5 - "NotaVentaRequest"
Cohesion: 0.07
Nodes (33): AppContent(), AuditoriaDialog(), LOG_1, mockGet, AlertasStockView(), BodegueroDashboard(), EditarMovimientoDialog(), DespachoDashboard() (+25 more)

### Community 6 - "AuditLog"
Cohesion: 0.05
Nodes (43): Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Pa, MateriaPrimaService, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-TrazabilidadMateriaPrima (F0-0, Cadena completa de trazabilidad: producto final ← MP ← proveedor., Registro de entradas de MP del proveedor y consumo en producción., Registra la recepción de un lote de materia prima del proveedor.          Crea e, TraceabilityService, Tests Sprint 6 (F0-001): Trazabilidad de Materia Prima. Artefacto RUP: Suite de (+35 more)
...
Cohesion: 0.07
Nodes (19): LoteProduccion, Registra el consumo de uno o más lotes de MP en un lote producido.          cons, GET /api/lotes-produccion/{id}/obtener-costo/ retorna el desglose., 50 kg × $10 = $500 de MP consumida en el lote., ConsumoMateriaPrimaTestCase, _crear_lote_produccion(), _fixtures(), MateriaPrimaRegistroTestCase (+11 more)
...
Cohesion: 0.04
Nodes (72): BaseAuthentication, BasePermission, LoteProduccion, AuditLogger, AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, Registra en log estructurado (RFC 5424) cada acceso a la API interna     con ide, JWTServiceAuthentication, Request (+64 more)

### Community 12 - "App.tsx"
Cohesion: 0.02
Nodes (126): AdminSedeDashboard(), AdminSistemasDashboard(), Group, showApiError(), AREA_1, AREA_3, BODEGA_1, BODEGA_3 (+118 more)

### Community 13 - "ClienteFactory"
Cohesion: 0.04
Nodes (37): DjangoModelFactory, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator., BodegaFactory, DetalleFormulaFactory, FaseRecetaFactory, FormulaColorFactory, DescargaQuimicosStockInsuficienteTestCase, APITestCase (+29 more)

### Community 14 - "SedeFactory"
Cohesion: 0.13
Nodes (12): Command, BaseCommand, Ingreso directo de stock con Kardex (COMPRA) para químicos/insumos., Replica las transiciones del OrdenProduccionSubprocesoViewSet., El tintorero crea la FormulaColor (en_pruebas -> aprobada) que usará la OP., OP-SIM-001 finalizada: abastecimiento, descarga química, avance, transformación,, Transfiere el lote terminado de Salida Tintura a Producto Terminado (Empaque)., El empaquetado completa los subprocesos y empaca el lote (etiqueta lista). (+4 more)

### Community 15 - "LoteProduccionFactory"
Cohesion: 0.05
Nodes (53): InventoryDashboard(), fakeBlob, mockBodegas, mockProductos, navigateToReportes(), renderDashboard(), toastErrorMock, toastSuccessMock (+45 more)

### Community 16 - "ProductoFactory"
Cohesion: 0.04
Nodes (54): Command, BaseCommand, Pobla clientes, pedidos de venta y pagos para probar el dashboard de Ventas (eje, Cliente, PagoCliente, ClienteListSerializer, ClienteSerializer, _fecha_pedido_to_iso_utc() (+46 more)
...
Cohesion: 0.03
Nodes (28): JefePlantaDashboard(), toastErrorMock, toastSuccessMock, UsuarioBasico, buildProps(), mockAreas, mockBodegas, mockMaquinas (+20 more)
...
Cohesion: 0.05
Nodes (31): Registra una transformación en la OP.          El ``producto_entrada`` NO se con, Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor, AreaFactory, MaquinaFactory, OrdenProduccionFactory, ProductoFactory, TestCase (+23 more)
...
Cohesion: 0.04
Nodes (21): SedeFactory, KPIAreaViewTestCase, KpiEjecutivoViewTestCase, ProduccionResumenTendenciaTestCase, TestCase, Pruebas de gestion/views/kpi_views.py.  Vistas: KPIAreaView, KpiEjecutivoView,, Caja blanca de la autorización por área., Contrato JSON del dashboard ejecutivo + parseo de sede_id. (+13 more)
...
Cohesion: 0.11
Nodes (65): BodegaAdmin, BodegueroInline, CustomUserAdmin, TransformacionProductoAdmin, Command, BaseCommand, Command, BaseCommand (+57 more)
...
Cohesion: 0.05
Nodes (28): Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, Meta, Factories para tests de TexCore — usa factory_boy.  Convención: - Cada factor (+20 more)

### Community 32 - "OrdenProduccionFactory"
Cohesion: 0.08
Nodes (32): ESTADO_BADGE, ManageMaquinas(), ManageMaquinasProps, mockGet, NIVEL_CON_PASOS_Y_SIGUIENTE, NIVEL_SIN_PASOS, TrazabilidadProducto(), TrazabilidadProductoProps (+24 more)

### Community 33 - "AuditRepository"
Cohesion: 0.07
Nodes (19): Maquina, ChemicalViewSet, ProductoViewSet, ProveedorViewSet, KPIAreaView, KpiEjecutivoView, ProduccionResumenView, ProduccionTendenciaView (+11 more)

### Community 34 - ".handle"
Cohesion: 0.09
Nodes (11): ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, AreaProcessStepViewSetTestCase, ComponenteMezclaOPViewSetTestCase, ConsumoLoteDetalleViewSetTestCase, EtapaProduccionViewSetTestCase, OrdenProduccionCreateTestCase, TestCase (+3 more)
...
Cohesion: 0.08
Nodes (10): Crea el despacho (HistorialDespacho + detalles + MovimientoInventario VENTA)., Revierte un pago deshaciendo el abono registrado.          Validaciones:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueE, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - M, Caso 4: Reversión es transaccional          Verifica:         - Si falla un p, Caso 1: Revertir pago restaura deuda del cliente          Verifica:         -, P0-005: pago + reconciliación en una sola transacción, con lock         pesimis, Artefacto RUP: Eliminación de Pago con Reversión         Caso de Uso: CU-Revers (+2 more)
...
### Community 52 - ".get"
Cohesion: 0.07
Nodes (12): ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProveedorViewSetMultiTenancyTestCase, TestCase, Pruebas complementarias de gestion/views/catalog_views.py — ramas que test_cata, ProductoViewSetTestCase (+4 more)
...
Cohesion: 0.16
Nodes (18): PackagingFormValues, packagingSchema, Alert(), AlertDescription(), AlertTitle(), alertVariants, FormControl(), FormDescription() (+10 more)
...
Cohesion: 0.16
Nodes (7): clear_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), CascadeJustificationTestCase, TestCase, EP: valor presente vs ausente tras clear., BodegaViewSet
...
Cohesion: 0.04
Nodes (25): get_user_role(), CustomUserFactory, ProductoViewSetMultiTenancyTestCase, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, SedeViewSetTestCase, BodegaViewSetQuerysetTestCase (+17 more)
...
Cohesion: 0.07
Nodes (21): AbstractUser, CustomUser, APIView, UserProfileView, CustomUserSerializer, GroupSerializer, SedeSerializer, audit_user_delete() (+13 more)
...
Cohesion: 0.12
Nodes (17): 11 de Mayo de 2026, 18 de Mayo de 2026, 19 de Mayo de 2026, 19 de Mayo de 2026, 20 de Mayo de 2026, 22 de Mayo de 2026, 26 de Mayo de 2026, 4 de Mayo de 2026 (+9 more)
...
Cohesion: 0.22
Nodes (7): AuditMiddleware, get_cascade_justification(), get_current_ip(), Middleware para capturar la IP y el usuario de la petición actual,     guardánd, AuditMiddlewareCallTestCase, Pruebas del middleware de auditoría — gestion/middleware.py.  Foco de segurida, Caja blanca: rama feliz (response) y rama de excepción (re-raise).
...
Cohesion: 0.05
Nodes (33): Command, BaseCommand, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente, ClienteManager, CostoHoraMaquina, Meta, Tarifa vigente de un operario; vigente_hasta NULL = sin fecha de fin. (+25 more)

### Community 192 - "@radix-ui/react-navigation-menu"
Cohesion: 0.22
Nodes (3): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 270, JWTServiceAuthenticationExtraTestCase, TestCase
...
Cohesion: 0.67
Nodes (3): 27 de Mayo de 2026, Corrección de Pipelines CI/CD — GitHub Actions y GitLab CI, Independencia Total de Microservicios — API Interna JWT RS256 (Fase 13)
...
Cohesion: 0.22
Nodes (9): 10 de Julio de 2026, 13 de Julio de 2026, 1 de Julio de 2026, 2 de Julio de 2026, Corrección de 3 bugs: 500 en Dashboard Jefe de Planta, "Mínimo (kg)" en NaN (tintorero) y máquinas en blanco (jefe de área), Fase 4d completada — Conversión de smoke tests a tests de comportamiento reales (frontend): 36/36 archivos, +496 tests, cobertura 37.4% → 74.83%, Julio 2026, Plan de cobertura QA (Fases 0-2): +150 tests backend, 3 bugs reales corregidos, cobertura 80.8% → 89.6% (+1 more)
...
Cohesion: 0.67
Nodes (3): Microservicio: reporting_excel, Patron DjangoReportRepository, Variables de Entorno
...
## Knowledge Gaps
- **1504 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1499 more)
...
- **Why does `CustomUserFactory` connect `auth_views.py` to `.handle`, `ManageOrdenesProduccion.tsx`, `TestServiceTokenView`, `CustomUserFactory`, `ClienteFactory`, `react-router-dom`, `pdf.py`, `.get`, `reporting_views.py`, `development`, `EjecutivosDashboard.tsx`, `InventoryDashboard.tsx`, `_audit`, `logger.ts`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `UnifiedBusinessLogicTestCase` connect `AdminSistemasDashboard.tsx` to `Maquina`, `AuditRepository`, `ManageOrdenesProduccion.tsx`, `SubprocesoStateMachineTestCase`, `CustomUserFactory`, `ProductoFactory`, `axios.ts`, `@radix-ui/react-label`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `CustomUserSerializer` connect `SubprocesoStateMachineTestCase` to `AuditRepository`, `OrdenProduccion`, `Maquina`, `ManageOrdenesProduccion.tsx`, `JefeAreaDashboard.tsx`, `CustomUserFactory`, `ClienteFactory`, `ProductoFactory`, `_fecha_a_texto`, `EjecutivosDashboard.tsx`, `InventoryDashboard.tsx`, `_audit`, `axios.ts`, `@radix-ui/react-label`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Are the 80 inferred relationships involving `CustomUserFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`CustomUserFactory` has 80 INFERRED edges - model-reasoned connections that need verification._
