# Graph Report - TexCore  (2026-08-24)

## Corpus Check
- 670 files · ~464,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7205 nodes · 15500 edges · 448 communities (379 shown, 69 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1687 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f75c5c9`
...
## Communities (448 total, 69 thin omitted)

### Community 0 - "cn"
Cohesion: 0.06
Nodes (39): AccordionContent(), AccordionItem(), AccordionTrigger(), AlertDialogOverlay(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+31 more)

### Community 1 - "InventoryDashboard.tsx"
Cohesion: 0.03
Nodes (36): get_user_role(), APIView, UserProfileView, CustomUserFactory, ChemicalViewSetTestCase, ProductoViewSetTestCase, ProveedorViewSetTestCase, TestCase (+28 more)

### Community 2 - "PagoCliente"
Cohesion: 0.08
Nodes (47): HasScope, IsInternalService, BasePermission, Permite acceso solo si el request fue autenticado como ServicePrincipal., Verifica que el ServicePrincipal tiene el scope requerido.     Uso: permission_, HasScopeTestCase, URLs de la API interna. Namespace: internal_api., AgingView (+39 more)

### Community 3 - "AdminSistemasDashboard.tsx"
Cohesion: 0.17
Nodes (10): KpiEjecutivoView, PlantaPulsoDiarioView, ProduccionResumenView, ProduccionTendenciaView, APIView, GET /produccion/pulso-diario/      "Torre de Control" del Jefe de Planta — mét, Resuelve la sede a consultar respetando el aislamiento.         Retorna (sede_i, GET /kpi-ejecutivo/?sede_id=<int>      Retorna el dashboard consolidado de KPI (+2 more)
...
Cohesion: 0.03
Nodes (98): AuditLog, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Pa, DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, AuditoriaMovimiento (+90 more)

### Community 6 - "AreaFactory"
Cohesion: 0.04
Nodes (29): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, Revierte el stock de merma creado por este lote., LoteProduccionFactory, MaquinaConMermaFactory, ParoMaquinaFactory, KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase (+21 more)

### Community 7 - "main.py"
Cohesion: 0.14
Nodes (48): ApprovalRequests(), Group, AuditoriaDialogProps, AlertaStock, ItemIncompleto, ScannedItem, DetalleHistorial, HistorialDespacho (+40 more)

### Community 9 - "TintoreroRBACTestCase"
Cohesion: 0.04
Nodes (28): OrdenProduccionEstadoSerializer, EventoEtiquetaFactory, OrdenProduccionFactory, DescargaQuimicosValidacionesTestCase, TestCase, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Tran, ISTQB STT — Transiciones legales en la máquina de estados. (+20 more)

### Community 10 - "UnifiedBusinessLogicTestCase"
Cohesion: 0.05
Nodes (80): AbstractUser, BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Carga ~1,000,000 registros para estresar el aplicativo TexCore.  Usa bulk_crea (+72 more)

### Community 11 - "HasScope"
Cohesion: 0.05
Nodes (39): claseSeveridadEficiencia(), JefePlantaDashboard(), logger, toastErrorMock, toastSuccessMock, RFC-5424, UsuarioBasico, buildProps() (+31 more)

### Community 12 - "App.tsx"
Cohesion: 0.05
Nodes (21): ClienteFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_c, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3)., EP Clase Inválida + BVA: -0.001 viola el CheckConstraint de BD.         La rest (+13 more)

### Community 13 - "EjecutivosDashboard.tsx"
Cohesion: 0.03
Nodes (71): InventoryDashboard(), InventoryDashboardProps, mockBodegas, mockDelete, mockGet, mockPost, mockProductos, mockProveedores (+63 more)
...
Cohesion: 0.10
Nodes (57): validateTransfer(), TransferViewImpl(), StockItem, EditarMovimientoDialogProps, EliminarMovimientoDialogProps, CALIDAD_OPTIONS, Filtros, FILTROS_INICIALES (+49 more)

### Community 16 - "StockBodega"
Cohesion: 0.09
Nodes (28): clear_cascade_justification(), get_cascade_justification(), get_current_ip(), get_current_user(), _get_object_sede_id(), Validaciones de negocio que requieren contexto de auditoría.         Se llama a, Obtiene sede_id del objeto para filtrar logs de entidades eliminadas.     Prior, audit_user_delete() (+20 more)

### Community 17 - "LineaProduccionViewSetTestCase"
Cohesion: 0.08
Nodes (13): Prueba que el despacho falle si no se proporcionan lotes., Prueba que el despacho falle si se proporciona un código de lote inválido., Prueba que el Kardex se puede filtrar por proveedor_id y devuelve nombres y códi, Suite única de pruebas para validar el funcionamiento del sistema TexCore., Verifica el registro de múltiples pagos y saldo a favor., Verifica que un cliente moroso NO pueda generar nuevos pedidos a crédito., Verifica que un vendedor pueda registrar un pago para su cliente a través de la, Verifica que solo vendedores/admins puedan cambiar el beneficio del cliente. (+5 more)

### Community 18 - "types.ts"
Cohesion: 0.04
Nodes (17): StockBodegaFactory, LoteProduccionViewSetTestCase, MovimientoReversionService, Revierte el efecto de stock de un MovimientoInventario y deja un     movimiento, Revierte una entrada: resta de la bodega donde había entrado., Revierte una salida: devuelve a la bodega de donde había salido., MovimientoMermaCreateTestCase, TestCase (+9 more)

### Community 19 - "ServiceTokenRefreshViewTestCase"
Cohesion: 0.03
Nodes (95): AdminSistemasDashboard(), ManageAreas(), ManageAreasProps, AREA_1, SEDE_1, SEDE_2, toastErrorMock, ManageBodegas() (+87 more)

### Community 20 - "DespachoReversionFKTestCase"
Cohesion: 0.02
Nodes (60): Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), ParoMaquina, Registro de downtime de máquina, con reason code = las Seis Grandes Pérdidas, Meta, ProductoSerializer, ProveedorSerializer, GroupSerializer (+52 more)

### Community 21 - "BodegaFactory"
Cohesion: 0.08
Nodes (7): CustomUserSerializer, Ejecutivos tienen acceso a todo el dashboard de stock: asignar todas las bodegas, ComponenteMezclaOPSerializer, ComponenteMezclaOPSerializerTestCase, CustomUserSerializerCreateUpdateTestCase, CustomUserSerializerValidateTestCase, TestCase

### Community 22 - "pdf_produccion_views.py"
Cohesion: 0.06
Nodes (63): AdminSedeDashboard(), ManageClientesProps, ClienteComprasModal(), ClienteComprasModalProps, ClienteDeudorModal(), ClienteDeudorModalProps, DeudorExtendido, fmt() (+55 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.03
Nodes (52): DjangoModelFactory, DetalleFormulaSerializer, DetallePedidoSerializer, BodegaFactory, DetalleFormulaFactory, FaseRecetaFactory, FormulaColorFactory, Meta (+44 more)

### Community 24 - "InventoryDashboard.reportes.test.tsx"
Cohesion: 0.03
Nodes (80): AppContent(), AuditoriaDialog(), LOG_1, mockGet, AlertasStockView(), BodegueroDashboard(), EditarMovimientoDialog(), DespachoDashboard() (+72 more)

### Community 25 - "ValidateResponse"
Cohesion: 0.06
Nodes (36): OrdenDetalleSheet, Separator(), Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay() (+28 more)
...
Cohesion: 0.12
Nodes (9): FormulaQuimicaTestCase, Suite de pruebas para el modulo de Formulas Quimicas.     Cubre: calculo de dos, Para kg_tela=100 y relacion_bano=10:             volumen = 1000 L, Para kg_tela=100 y relacion_bano=10:             sal (60%): cantidad = (100 * 6, Verifica que kg_tela <= 0 o relacion_bano <= 0 retornen 400., Crear una formula con el mismo quimico dos veces debe retornar 400         con, La accion duplicar debe:         1. Crear una nueva FormulaColor con version >, Crear una formula con detalles anidados en un solo POST debe persistir (+1 more)
...
Cohesion: 0.03
Nodes (59): CostoHoraMaquina, CostoLoteProduccion, Tarifa vigente de un operario; vigente_hasta NULL = sin fecha de fin., Costo operativo por hora de maquina (amortizacion + energia + mantto)., TarifaOperario, MateriaPrimaLote, MateriaPrimaLoteSerializer, Meta (+51 more)
...
Cohesion: 0.07
Nodes (34): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., get_validation_service(), AuditRepository, BackgroundTasks (+26 more)

### Community 36 - "dependencies"
Cohesion: 0.04
Nodes (49): dependencies, axios, class-variance-authority, clsx, cmdk, date-fns, embla-carousel-react, @hookform/resolvers (+41 more)
...
Cohesion: 0.12
Nodes (15): JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación.      `sede, ServicePrincipal, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. C, IsInternalServiceTestCase, TestCase, Pruebas de internal_api/permissions.py — IsInternalService y HasScope.  Técnic, _fake_request() (+7 more)

### Community 42 - "logger.ts"
Cohesion: 0.04
Nodes (45): EventoEtiqueta, Registro inmutable del ciclo de vida de cada etiqueta física impresa para un lot, CostoLoteProduccionSerializer, LoteProduccionSerializer, RegistrarLoteProduccionSerializer, ConsumoMezclaService, SRP: gestiona el consumo de múltiples lotes de entrada para producir un lote de, EventoEtiquetaService (+37 more)
...
Cohesion: 0.07
Nodes (19): generate_zpl_label(), AuditRepository, BackgroundTasks, Genera texto ZPL a partir de un template Jinja2., ZplOutputStrategy, Tests de endpoints e integración para printing_service. Cubre: config, main, he, P0: /pdf/reporte-avance y /pdf/reporte-balance eran llamados por     internal_a, EP: todos los templates presentes → status ok. (+11 more)
...
Cohesion: 0.10
Nodes (29): Environment, Configuración centralizada del printing_service. Elimina dependencias de cwd (f, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., generate_balance_masas_pdf() (+21 more)
...
Cohesion: 0.16
Nodes (17): PrintAuditLog, Base, AuditRepository, IAuditRepository, Protocol, Contrato de auditoría para printing_service., Persiste un registro de auditoría. Nunca propaga excepciones., Implementación SQLite de IAuditRepository.     SRP: solo persiste; no construye (+9 more)
...
Cohesion: 0.11
Nodes (17): EtiquetaContexto, EtiquetaRequest, DTO de entrada para generación de etiqueta ZPL., Contexto enriquecido para el template PDF de etiqueta, generado por     LabelSe, LabelService, LabelService: lógica de negocio del dominio de etiquetas de producción. Respons, Genera las imágenes de código de barras y QR de una etiqueta de lote., Code128 (misma simbología que ^BCN en ZPL) como PNG en base64.         `write_t (+9 more)
...
Cohesion: 0.08
Nodes (36): ESTADO_BADGE, ManageLineasProps, ESTADO_BADGE, ManageMaquinasProps, ahoraLocal(), extraerError(), RegistrarTransformacion(), mockGet (+28 more)

### Community 69 - "test_exports.py"
Cohesion: 0.09
Nodes (13): AuditMiddleware, _extract_client_ip(), _is_trusted_proxy(), Verifica si una IP pertenece a una red de proxy de confianza., Extrae la IP real del cliente de forma segura.     Solo confía en X-Forwarded-F, Middleware para capturar la IP y el usuario de la petición actual,     guardánd, AuditMiddlewareCallTestCase, ExtractClientIpTestCase (+5 more)

### Community 70 - "auth_views.py"
Cohesion: 0.02
Nodes (59): Command, BaseCommand, Command, BaseCommand, make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la, Factory para crear clases de permiso basadas en grupos de Django.      Otorga, ConsumoLoteDetalleSerializer (+51 more)

### Community 71 - "DespachoDashboard.test.tsx"
Cohesion: 0.05
Nodes (24): AreaFactory, ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, MaquinaFactory, MaquinaOeeActionTestCase, ParoMaquinaModelTestCase, ParoMaquinaViewSetTestCase, TestCase (+16 more)
...
Cohesion: 0.09
Nodes (22): Agrupación por dominio (validada contra el archivo actual), Agrupación por dominio (validada, sin ciclos de FK reales), Archivos críticos de referencia para la implementación, Archivos existentes a editar, Archivos existentes a editar, Archivos nuevos a crear (todos en `gestion/views/`), Catálogo actual (validado línea por línea), Checklist de verificación por fase (+14 more)
...
Cohesion: 0.11
Nodes (14): init_db(), Crea las tablas y aplica permisos de archivo.     ISO 27001 A.10: chmod 0o600 —, Escape backslash, double quote, and right bracket as per RFC 5424 §6.3.3, RFC 5424 Syslog Formatter     Format: <PRI>VERSION TIMESTAMP HOSTNAME APP-NAME, RFC5424Formatter, lifespan(), log_requests_rfc5424(), FastAPI (+6 more)
...
Cohesion: 0.15
Nodes (12): OpsEstado, ProduccionKPIs, date, Decimal, RUP - Capa de Servicio: ProduccionKPIService ==================================, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0), Un punto de la serie temporal de producción diaria. (+4 more)
...
Cohesion: 0.27
Nodes (10): Response, Servicio que ejecuta un SP, maneja el caso de DataFrame vacío,     y delega el, Ejecuta el SP y retorna la Response formateada.         Si el DataFrame está va, ReportService, _make_formatter(), _make_repo(), DataFrame, Tests unitarios del ReportService. Usa mocks de IReportRepository y OutputForma (+2 more)
...
Cohesion: 0.12
Nodes (17): Archivos críticos de referencia, Auditoría y división de los 6 dashboards "dios" del frontend (SOLID / Clean Code / ISO 25010), Contexto, Fase 1 — `ejecutivos/EjecutivosDashboard.tsx`, Fase 2 — `admin-sistemas/InventoryDashboard.tsx`, Fase 3 — `jefe-planta/ManageOrdenesProduccion.tsx`, Fase 4 — `jefe-area/JefeAreaDashboard.tsx`, Fase 5 — `admin-sistemas/AdminSistemasDashboard.tsx` (+9 more)
...
Cohesion: 0.15
Nodes (8): DescargaQuimicosOPTestCase, APITestCase, Suite de pruebas para la descarga automática de químicos en órdenes de producció, Caso: Crear OP con fórmula + bodega_quimicos         Esperado: Descarga automát, Caso: Modificar OP (cambiar peso_neto_requerido) requiere justificación, Caso: Eliminar OP sin justificación debe fallar (HTTP 400)         Caso: Elimin, Caso: Consultar stock de químicos vía GET /stock-quimicos/?sede_id=<id>, Caso: Verificar auditoría completa de descarga (usuario, fecha, justificación)
...
Cohesion: 0.08
Nodes (11): _get_required_env(), APIView, Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., Valida que el path del reporte sea seguro.     Previene Path Traversal y acceso, ReportingProxyView, _validate_report_path(), GetRequiredEnvTestCase, TestCase (+3 more)

### Community 191 - "test_database_engine.py"
Cohesion: 0.14
Nodes (14): 13 de Noviembre de 2025, 21 de Agosto de 2026, 22 de Diciembre de 2025, 26 de Enero de 2026, Agosto 2026, Changelog, Correcciones y Mejoras de Estabilidad, Diciembre 2025 (+6 more)
...
Cohesion: 0.06
Nodes (29): StockViewImpl(), useProductionPagination(), AlertasInventarioPanel, AlertasInventarioPanelImpl(), AlertasInventarioPanelProps, LotesRecientesTableImpl(), mockLogin, Alert() (+21 more)
...
Cohesion: 0.24
Nodes (5): Registra una transformación en la OP.          El ``producto_entrada`` NO se con, _data(), TestCase, TransformacionServiceRegistrarTest, TransformacionProducto
...
### Community 227 - "ReportingProxyViewExtraTestCase"
Cohesion: 0.25
...
Cohesion: 0.15
Nodes (3): APITestCase, Pruebas unitarias para vistas de generación de PDFs de producción en internal_ap, TestPdfProduccionViews

### Community 258 - "DespachReversionAPITestCase"
Cohesion: 0.33
...
Cohesion: 0.11
Nodes (16): LayoutProps, useAuthMock, Avatar(), AvatarFallback(), AvatarImage(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent() (+8 more)
...
Cohesion: 0.15
Nodes (8): DespachReversionTestCase, TransactionTestCase, Caso 1: Revertir despacho restaura stock correctamente          Verifica:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueE, Caso 3: PedidoVenta vuelve a estado 'pendiente'          Verifica:         -, Caso 4: Reversión es transaccional          Verifica:         - Si falla un p, Tests para la reversión de despachos.     Usa TransactionTestCase para test tra, Configura datos de prueba comunes
...
Cohesion: 0.22
Nodes (7): HistorialDespacho, DespachoReversionService, Revierte registros de DescargaQuimicoOP asociados a los pedidos del despacho., Servicio para revertir despachos con auditoría completa.     Restaura stock de, Revierte un despacho existente:         1. Restaura stock en cada bodega origen, Endpoint explícito para revertir despacho.         Alternativa POST amigable a, Revierte un despacho con justificación obligatoria.         HTTP 400 si falta j
...
Cohesion: 0.20
Nodes (10): DetalleAvance, DetalleBalanceMasas, DetallePedido, NotaVentaContexto, BaseModel, Renglón individual del balance de masas.     ISP: schema mínimo con solo los ca, Un renglón del pedido con su peso, precio y condición de IVA., Schema enriquecido con cálculos ya realizados por DocumentService.     Es el ob (+2 more)
...
Cohesion: 0.22
Nodes (6): ProcessDespachoAPIView, APIView, Valida si un código de lote (barras) existe y tiene stock disponible., Procesa el despacho de múltiples pedidos y lotes escaneados.     Descuenta inve, Compara requerimientos de los pedidos contra stock de los lotes escaneados., ValidateLoteAPIView
...
### Community 290 - ".revertir_descarga_op"
Cohesion: 0.40
...
### Community 306 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.50
...
### Community 308 - "get_session_factory"
Cohesion: 0.50
...
### Community 310 - "TestBuildScanRecord_ValoresLimite"
Cohesion: 0.50
...
### Community 311 - "8. GOBIERNO DE TI — COBIT 2019"
Cohesion: 0.50
...
### Community 312 - ".test_kardex_running_balance_and_filters"
Cohesion: 0.50
...
Cohesion: 0.25
Nodes (5): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., TransformacionService, PageNumberPagination, StandardResultsSetPagination
...
Cohesion: 0.32
Nodes (3): HistorialDespachoFiltrosFechaTestCase, TestCase, Pruebas complementarias de HistorialDespachoViewSet.get_queryset — filtros por
...
### Community 359 - "Fase 2 — `inventory/views.py` (1193 líneas → 7 archivos, paquete nuevo)"
Cohesion: 0.29
...
### Community 360 - "App.test.tsx"
Cohesion: 0.29
Nodes (4): App(), mockAuthState, queryClient, root

### Community 361 - "TestBuildPrintRecord_ValoresLimite"
Cohesion: 0.29
...
### Community 362 - "StockQuimicosDashboard.test.tsx"
Cohesion: 0.40
...
### Community 403 - "Servicio Satélite: reporting_excel"
Cohesion: 0.67
Nodes (3): Patron DjangoReportRepository, Servicio Satélite: reporting_excel, Variables de Entorno

## Knowledge Gaps
- **1682 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1677 more)
...
- **Why does `CustomUserFactory` connect `InventoryDashboard.tsx` to `test_vendedores.py`, `PagoCliente`, `factories.py`, `AreaFactory`, `TestJWTTokenManager`, `TintoreroRBACTestCase`, `UnifiedBusinessLogicTestCase`, `App.tsx`, `.handle`, `types.ts`, `BodegaFactory`, `EjecutivosDashboard.test.tsx`, `compilerOptions`, `FormulaQuimica.tsx`, `VendedorDashboard.detalle.test.tsx`, `DespachoDashboard.test.tsx`, `Esquema de Base de Datos y Modelo de Negocio`, `_RealDomainRepo`, `.validate`, `🛠 Detalle por Rol`, `ExecutiveKPIService`, `7.2 Desde Otra Máquina en la Red`, `MRPEngine`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `StockBodega` connect `factories.py` to `JefeAreaDashboard.tsx`, `PagoCliente`, `main.py`, `AreaFactory`, `auth_views.py`, `Documento de Contexto y Decisión Arquitectónica: TexCore — Sistema de gestión de órdenes de producción`, `TintoreroRBACTestCase`, `UnifiedBusinessLogicTestCase`, `logger.ts`, `compilerOptions`, `Análisis Comparativo: Monolito con Servicios Satélites vs Monolito Puro en TexCore`, `Docker — Configuración específica por plataforma`, `types.ts`, `EjecutivosDashboard.test.tsx`, `Microservicios Independientes — Plan de Implementación`, `Autenticacion JWT RS256 entre Servicios`, `ExecutiveKPIService`, `OrdenProduccionFactory`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `LoteProduccion` connect `UnifiedBusinessLogicTestCase` to `JefeAreaDashboard.tsx`, `InventoryDashboard.tsx`, `PagoCliente`, `main.py`, `factories.py`, `auth_views.py`, `TintoreroRBACTestCase`, `logger.ts`, `compilerOptions`, `StockBodega`, `DespachoReversionFKTestCase`, `Microservicios Independientes — Plan de Implementación`, `EjecutivosDashboard.test.tsx`, `test_printing_endpoints.py`?**
