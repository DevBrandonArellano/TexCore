# Graph Report - TexCore  (2026-08-21)

## Corpus Check
- 614 files · ~834,301 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7095 nodes · 14520 edges · 469 communities (369 shown, 100 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1649 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `995209a8`
...
- ProductoFactory
- pdf_produccion_views.py
- EjecutivosDashboard.test.tsx
- .consumir_materia_prima
- ValidateResponse
...
- export_lotes_produccion
- .calcular_costo
- SedeFilteringTestCase
- DescargaQuimicosStockInsuficienteTestCase
- TestPdfProduccionViews
- export_top_clientes
- urls.py
- TexCore — Sistema Integral de Gestión para la Industria Textil
- export_top_clientes_gerencial
- Command
...
- CHANGELOG.md
- test_gerencial_errores.py
- test_produccion_errores.py
- deploy.sh script
- Scripts de Utilidad
- SedeResolvableMixin
...
- main.py
- DetalleHistorialDespachoAdmin
- collapsible.tsx
- vitest.setup.ts
- GestionConfig
- HistorialDespachoAdmin
- Módulo Internal API
- scripts
...
- __init__.py
- __init__.py
- .test_auditoria_descarga_quimicos
- __init__.py
- print_service_manual_test.py
- .test_historial_despachos_access
- .test_stock_inventory_access
- .test_process_despacho_post_access
- .test_unauthenticated_access
- get_stock
- .generate_next_lote_codigo
- .duracion_minutos
- .test_despacho_sin_lotes
- .test_despacho_lote_invalido
- .test_despacho_api_historial
- .test_movimiento_inventario_con_proveedor_pais_calidad
- .test_kardex_con_filtro_proveedor_y_campos_adicionales
...
- .test_seguridad_permisos_operario
- .test_salesman_auto_assignment_client
- .test_payment_reconciliation_flow
- .test_despacho_validacion_lote_sin_stock
- .test_despacho_validacion_lote_con_stock

## God Nodes (most connected - your core abstractions)
1. `CustomUserFactory` - 367 edges
2. `cn()` - 221 edges
3. `SedeFactory` - 202 edges
4. `ProductoFactory` - 149 edges
5. `AreaFactory` - 113 edges
6. `OrdenProduccionFactory` - 103 edges
7. `StockBodega` - 100 edges
8. `MaquinaFactory` - 85 edges
9. `Sede` - 83 edges
10. `Producto` - 82 edges
...
- `IsInternalServiceOrUser` --uses--> `CookieJWTAuthentication`  [INFERRED]
  internal_api/views/pdf_produccion_views.py → gestion/auth_backends.py
...
## Communities (469 total, 100 thin omitted)

### Community 0 - "cn"
Cohesion: 0.02
Nodes (164): react, AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage(), BreadcrumbEllipsis() (+156 more)

### Community 1 - "InventoryDashboard.tsx"
Cohesion: 0.03
Nodes (28): get_user_role(), CustomUserFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, SedeViewSetTestCase, BodegaViewSetQuerysetTestCase, BodegaViewSetWriteTestCase (+20 more)

### Community 2 - "FormulaColor"
Cohesion: 0.07
Nodes (46): BaseAuthentication, JWTServiceAuthentication, Request, DRF Authentication backend para JWT de servicio (RS256).     Retorna None si no, IsInternalService, BasePermission, Permite acceso solo si el request fue autenticado como ServicePrincipal., AgingView (+38 more)

### Community 3 - "AdminSistemasDashboard.tsx"
Cohesion: 0.03
Nodes (55): make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la d, Factory para crear clases de permiso basadas en grupos de Django.      Otorga ac, Meta, ProductoSerializer, ProveedorSerializer, OrdenProduccionSubprocesoSerializer, OeeService (+47 more)

### Community 4 - "MovimientoInventario"
Cohesion: 0.16
Nodes (8): Command, BaseCommand, MRPEngine, Devuelve los detalles de una fórmula usando caché en memoria., Ejecuta el cálculo completo del MRP de forma optimizada:         1. Limpia datos, run_mrp(), MRPTest, TestCase

### Community 5 - "ConsumoMezclaServiceConsumir"
Cohesion: 0.04
Nodes (76): Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, Vistas de generación de PDFs de producción para internal_api.  Arquitectura:   -, DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, AuditoriaMovimiento (+68 more)

### Community 6 - "ComponenteMezclaOPFactory"
Cohesion: 0.04
Nodes (37): DjangoModelFactory, AreaFactory, EventoEtiquetaFactory, LoteProduccionFactory, MaquinaFactory, Meta, ParoMaquinaFactory, Factories para tests de TexCore — usa factory_boy.  Convención: - Cada factory c (+29 more)

### Community 7 - "LoteProduccion"
Cohesion: 0.16
Nodes (42): ApprovalRequests(), ManageProductosProps, Group, AuditoriaDialogProps, ItemIncompleto, ScannedItem, DetalleHistorial, HistorialDespacho (+34 more)

### Community 9 - "ManageOrdenesProduccion.tsx"
Cohesion: 0.03
Nodes (24): OrdenProduccionFactory, DescargaQuimicosValidacionesTestCase, TestCase, Pruebas de validaciones de entrada de DescargaQuimicosService.descargar_para_op, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Trans, ISTQB STT — Transiciones legales en la máquina de estados., El modelo actual permite pendiente → finalizada (no tiene validación de estado). (+16 more)

### Community 10 - "UnifiedBusinessLogicTestCase"
Cohesion: 0.06
Nodes (78): AbstractUser, BodegaAdmin, BodegueroInline, LineaProduccionAdmin, TransformacionProductoAdmin, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Carga ~1,000,000 registros para estresar el aplicativo TexCore.  Usa bulk_create, Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente en (+70 more)

### Community 11 - "HasScope"
Cohesion: 0.02
Nodes (99): ManageAreas(), ManageAreasProps, AREA_1, SEDE_1, SEDE_2, toastErrorMock, ManageBodegasProps, ManageFormulas() (+91 more)

### Community 12 - "VendedorDashboard.tsx"
Cohesion: 0.06
Nodes (22): ClienteFactory, SedeFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de Eq, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_cr, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3). (+14 more)

### Community 13 - "AreaFactory"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (33): Bodega, DescargaQuimicosService, Decimal, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, Template Method: secuencia fija revertir → descargar.         Se usa al modifica, Servicio de descarga automática de químicos al crear/modificar/eliminar órdenes, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en lo, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator. (+25 more)

### Community 15 - "EjecutivosDashboard.tsx"
Cohesion: 0.06
Nodes (81): StockItem, StockItem, TransformationView(), TransformationViewProps, EditarMovimientoDialog(), EditarMovimientoDialogProps, EliminarMovimientoDialog(), EliminarMovimientoDialogProps (+73 more)

### Community 16 - "StockBodega"
Cohesion: 0.07
Nodes (29): clear_cascade_justification(), get_cascade_justification(), get_current_ip(), get_current_user(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), _get_object_sede_id(), Validaciones de negocio que requieren contexto de auditoría.         Se llama au (+21 more)

### Community 17 - "LineaProduccionViewSetTestCase"
Cohesion: 0.06
Nodes (16): Prueba que el despacho sea atómico: si falla un lote, se revierten todos los cam, Prueba la transferencia de stock entre dos bodegas incluyendo el campo observaci, Valida que el Retro-Kardex calcule correctamente el stock a una fecha pasada., Valida el reporte de trazabilidad por lote., Verifica que el saldo_pendiente se calcule correctamente según pedidos y pagos., Prueba el flujo avanzado de empaquetado:         1. Códigos secuenciales., Suite única de pruebas para validar el funcionamiento del sistema TexCore.     C, Verifica que al crear un PedidoVenta, la fecha de vencimiento se calcule de form (+8 more)

### Community 18 - "CookieJWTAuthentication"
Cohesion: 0.03
Nodes (31): BodegaFactory, StockBodegaFactory, Revierte una entrada: resta de la bodega donde había entrado., MovimientoMermaCreateTestCase, TestCase, Pruebas de control de Merma en MovimientoInventarioViewSet.create() — `tipo_movi, MovimientoDestroyTestCase, TestCase (+23 more)

### Community 19 - "ServiceTokenRefreshViewTestCase"
Cohesion: 0.08
Nodes (10): ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, ComponenteMezclaOPViewSetTestCase, ConsumoLoteDetalleViewSetTestCase, EtapaProduccionViewSetTestCase, OrdenProduccionCreateTestCase, TestCase, Pruebas complementarias de gestion/views/production_views.py — cubre los ViewSet (+2 more)

### Community 20 - "HistorialDespachoViewSet"
Cohesion: 0.04
Nodes (41): ParoMaquina, Registro de downtime de máquina, con reason code = las Seis Grandes Pérdidas, GroupSerializer, Meta, SedeSerializer, BatchSerializer, DetalleFormulaEscrituraSerializer, FaseRecetaEscrituraSerializer (+33 more)

### Community 21 - "ProductoFactory"
Cohesion: 0.04
Nodes (18): APIView, UserProfileView, CustomUserSerializer, Ejecutivos tienen acceso a todo el dashboard de stock: asignar todas las bodegas, DetalleFormulaSerializer, ComponenteMezclaOPSerializer, OrdenProduccionEstadoSerializer, DetallePedidoSerializer (+10 more)

### Community 22 - "pdf_produccion_views.py"
Cohesion: 0.05
Nodes (51): AdminSedeDashboard(), ManageClientes(), ManageClientesProps, CLIENTE_1, CLIENTE_2, SelectCtx, toastErrorMock, ClienteComprasModal() (+43 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.05
Nodes (28): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, TransformacionService, ProductoFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase (+20 more)

### Community 24 - ".consumir_materia_prima"
Cohesion: 0.03
Nodes (69): AppContent(), AdminSistemasDashboard(), Group, showApiError(), InventoryDashboard(), ManageBodegas(), ManageProductos(), ManageProveedores() (+61 more)

### Community 25 - "ValidateResponse"
Cohesion: 0.06
Nodes (30): AuditLog, AuditLogPagination, AuditLogViewSet, PageNumberPagination, HistorialDespachoViewSet, ProcessDespachoAPIView, APIView, Valida si un código de lote (barras) existe y tiene stock disponible. (+22 more)

### Community 26 - "Auditoría y Mejoras del Rol Jefe de Área"
Cohesion: 0.13
Nodes (8): _fake_request(), Tests de la propagación de identidad de sede en el canal servicio-a-servicio.  C, Request mínimo: resolve_sede_scope solo usa .user y .query_params.get., Caja blanca de la resolución de sede en las vistas internas., ResolveSedeScopeTestCase, _audit(), Resuelve la sede a aplicar en un reporte interno como DEFENSA EN PROFUNDIDAD., resolve_sede_scope()

### Community 27 - "Documentación Técnica: Sistema de Reversión de Pagos del Cliente"
Cohesion: 0.05
Nodes (29): AreaSerializer, DosificacionSerializer, Serializer de entrada para el endpoint de calculo de dosificacion., calcular_dosificacion_gr_l(), calcular_dosificacion_pct(), DosificacionCalculator, Decimal, Servicio de calculo de dosificacion para formulas de tintoreria.  Metodos de cal (+21 more)

### Community 28 - "NotaVentaRequest"
Cohesion: 0.12
Nodes (9): FormulaQuimicaTestCase, Suite de pruebas para el modulo de Formulas Quimicas.     Cubre: calculo de dosi, Para kg_tela=100 y relacion_bano=10:             volumen = 1000 L             co, Para kg_tela=100 y relacion_bano=10:             sal (60%): cantidad = (100 * 60, Verifica que kg_tela <= 0 o relacion_bano <= 0 retornen 400., Crear una formula con el mismo quimico dos veces debe retornar 400         con u, La accion duplicar debe:         1. Crear una nueva FormulaColor con version > o, Crear una formula con detalles anidados en un solo POST debe persistir         l (+1 more)

### Community 29 - "MovimientoInventarioUpdateSerializer"
Cohesion: 0.09
Nodes (18): Bodega, LoteProduccion, OrdenProduccion, Producto, Domain models: objetos de dominio puros, sin acoplamiento a ORM ni HTTP. DIP: Lo, StockBodega, DjangoApiClient, JWTTokenManager (+10 more)

### Community 30 - "_make_pedido"
Cohesion: 0.05
...
### Community 31 - "OrdenProduccionFactory"
Cohesion: 0.13
Nodes (13): Command, BaseCommand, Ingreso directo de stock con Kardex (COMPRA) para químicos/insumos., Replica las transiciones del OrdenProduccionSubprocesoViewSet., El tintorero crea la FormulaColor (en_pruebas -> aprobada) que usará la OP., jefe_planta crea las OPs; jefe_area asigna máquina + operario y genera subproces, OP-SIM-001 finalizada: abastecimiento, descarga química, avance, transformación,, Transfiere el lote terminado de Salida Tintura a Producto Terminado (Empaque). (+5 more)

### Community 32 - "ServiceCredential"
Cohesion: 0.05
Nodes (43): ConsumoMateriaPrima, MateriaPrimaLote, Through-table: LoteProduccion <-> MateriaPrimaLote (inmutable post-registro), MateriaPrimaLoteSerializer, Meta, Entrada del endpoint registrar_entrada — la creación real la hace el servicio., RegistrarMateriaPrimaSerializer, CostoLoteService (+35 more)

### Community 33 - "BodegaFactory"
Cohesion: 0.05
...
### Community 34 - "parse_int_param"
Cohesion: 0.09
Nodes (17): LoteProduccion, Registra el consumo de uno o más lotes de MP en un lote producido.          cons, ConsumoMateriaPrimaTestCase, _crear_lote_produccion(), _fixtures(), MateriaPrimaRegistroTestCase, TestCase, EP inválida: costo < 0 → ValidationError. (+9 more)

### Community 35 - "get_session_factory"
Cohesion: 0.07
Nodes (33): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., AuditRepository, BackgroundTasks, Router HTTP para validación de lotes. DIP: get_validation_service y get_audit_re (+25 more)
...
### Community 39 - ".reconcile_client_orders"
Cohesion: 0.05
...
Cohesion: 0.12
Nodes (12): Identidad de un microservicio autenticado. Inmutable post-creación.      `sede_i, ServicePrincipal, HasScope, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. COB, Verifica que el ServicePrincipal tiene el scope requerido.     Uso: permission_c, HasScopeTestCase, IsInternalServiceTestCase, TestCase (+4 more)

### Community 42 - "logger.ts"
Cohesion: 0.26
Nodes (5): LoteProduccion, Copia idéntica: mantiene la version de datos vigente, solo avanza la secuencia., Cambio de datos: anula la última etiqueta vigente y emite una nueva version., _snapshot_actual(), EventoEtiquetaModelTests

### Community 43 - "FormulaQuimica.tsx"
Cohesion: 0.09
Nodes (8): LineaProduccionFactory, LineaProduccionModelTestCase, LineaProduccionViewSetTestCase, TestCase, Pruebas de LineaProduccion (Células de Manufactura Flexibles).  Cubre el modelo, Célula de manufactura flexible: máquina compartida entre líneas activas., Tabla de decisión RBAC + validaciones del serializer., RecursoCompartidoTestCase

### Community 44 - "seed_data.py"
Cohesion: 0.17
Nodes (11): 1. Contexto del Proyecto TexCore, 2. Descripción de los Enfoques, 4. Conclusión, 5.1 El Problema: Acoplamiento de Base de Datos, 5.2 La Solución: API Gateway Interna JWT RS256, 5.3 Beneficios Concretos Obtenidos, 5.4 Comparativa Final — Tres Enfoques, 5. Evolución Arquitectónica — Aislamiento total con API Interna (Mayo 2026) (+3 more)

### Community 45 - "Diseño: Microservicios Independientes — TexCore"
Cohesion: 0.06
...
### Community 46 - "AuditRepository"
Cohesion: 0.07
Nodes (19): generate_zpl_label(), AuditRepository, BackgroundTasks, Genera texto ZPL a partir de un template Jinja2., ZplOutputStrategy, Tests de endpoints e integración para printing_service. Cubre: config, main, hea, P0: /pdf/reporte-avance y /pdf/reporte-balance eran llamados por     internal_ap, EP: todos los templates presentes → status ok. (+11 more)

### Community 47 - "4. Casos de Prueba Completos"
Cohesion: 0.08
Nodes (17): ErrorBoundary, logger, Props, State, RFC-5424, _consoleMethod(), _format(), LogEntry (+9 more)

### Community 48 - "Diseño: Producción Flexible con Mezclas, Transformación y Merma Vendible"
Cohesion: 0.08
Nodes (36): Environment, Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., generate_balance_masas_pdf() (+28 more)

### Community 49 - "EjecutivosDashboard.reportes.test.tsx"
Cohesion: 0.07
Nodes (35): DetallePedido, NotaVentaRequest, Un renglón del pedido con su peso, precio y condición de IVA., DTO de entrada para generación de nota de venta.     SRP: solo transporta datos, DocumentService, DetallePedido, DocumentService: lógica de negocio del dominio de documentos comerciales. Respon, Servicio que encapsula la lógica de negocio para documentos comerciales.     Mét (+27 more)

### Community 50 - "RFC5424Formatter"
Cohesion: 0.06
...
### Community 51 - "MateriaPrimaRegistroTestCase"
Cohesion: 0.06
...
### Community 52 - "test_audit_middleware.py"
Cohesion: 0.08
Nodes (19): LogRecord, RFC 5424 Syslog Formatter — TexCore Backend (Django) ===========================, PRI = Facility × 8 + Severity., ISO 8601 UTC con precisión de milisegundos — RFC 5424 §6.2.3., MSGID derivado del nombre del logger.         RFC 5424 §6.2.7 — max 32 chars, so, Construye el campo STRUCTURED-DATA.         Incluye siempre module y lineno; mez, Construye un SD-ELEMENT RFC 5424 §6.3:             [SD-ID PARAM-NAME="PARAM-VALU, Escaping obligatorio de valores SD-PARAM — RFC 5424 §6.3.3.         Los tres car (+11 more)

### Community 53 - ".revertir_pago"
Cohesion: 0.15
...
### Community 58 - "VendedorDashboard.detalle.test.tsx"
Cohesion: 0.10
Nodes (13): _make_pedido(), TestCase, Tests de PedidoVenta — Anulación y Modificación (vendedor).  ISTQB:   - EP (Part, Verifica efectos secundarios de la anulación., EP/BVA — validaciones del endpoint modificar., Verifica que los cambios se persisten y se registra auditoría., RBAC — solo grupos permitidos pueden anular., EP/BVA — validaciones de estado, motivo y doble anulación. (+5 more)

### Community 59 - "SedeFactory"
Cohesion: 0.12
...
### Community 60 - "Fase 4: Mejoras de Arquitectura y Seguridad (Propuestas)"
Cohesion: 0.42
Nodes (8): export_deudores_gerencial(), export_top_clientes_gerencial(), export_ventas_gerencial(), AuditRepository, BackgroundTasks, date, Request, Reportes gerenciales consolidados (todos los vendedores) para ejecutivos. DIP: g

### Community 61 - "DjangoApiClient"
Cohesion: 0.07
Nodes (30): 1. Backend — Modelo (`gestion/models.py`), 1. Registrar un lote nuevo (evento ORIGINAL), 2. Backend — Service Layer (`gestion/services/evento_etiqueta_service.py`), 2. Reimprimir (copia idéntica), 3. Backend — Views (`gestion/views/production_views.py`, `LoteProduccionViewSet`), 3. Reetiquetar (cambio de datos), 4. Servicio Satélite `printing_service` (F2 + F5), 5. Frontend — Types (`frontend/src/lib/types.ts`) (+22 more)

### Community 62 - "LoteValidationService"
Cohesion: 0.18
Nodes (17): get_validation_service(), Request, LoteValidationService, Encapsula las reglas de negocio para determinar si un lote puede ser despachado:, _make_bodega(), _make_lote(), _make_orden(), _make_producto() (+9 more)

### Community 63 - "Documentación: Reversión de Despachos con Restauración de Stock"
Cohesion: 0.07
...
### Community 64 - "Datos para Dashboard de Reportes Gerenciales (Ejecutivo)"
Cohesion: 0.09
Nodes (17): AnticipoClienteP1002TestCase, _BasePagosTestCase, PagosParcialesP1003TestCase, TestCase, BVA deuda 0: anticipo puro (cliente paga antes de pedir)., STT flujo completo: anticipo 800 → se crea pedido de 300 (vía API de         det, El vendedor ve el saldo a favor de su cliente en el listado., P1-003: monto_pagado refleja pagos parciales por pedido (FIFO). (+9 more)

### Community 65 - "ManageUsers.test.tsx"
Cohesion: 0.11
Nodes (17): EtiquetaContexto, EtiquetaRequest, DTO de entrada para generación de etiqueta ZPL., Contexto enriquecido para el template PDF de etiqueta, generado por     LabelSer, LabelService, LabelService: lógica de negocio del dominio de etiquetas de producción. Responsa, Genera las imágenes de código de barras y QR de una etiqueta de lote., Code128 (misma simbología que ^BCN en ZPL) como PNG en base64.         `write_te (+9 more)

### Community 66 - "Producción Flexible — Implementation Plan"
Cohesion: 0.07
Nodes (27): 1. Backend - Service Layer (`inventory/services/despacho_reversion.py` - NUEVO), 1. Crear Despacho (SIN CAMBIOS), 2. Backend - Views (`inventory/views.py`), 2. Revertir Despacho (NUEVO), 3. Frontend - HistorialDespachos Component (actualizado), Arquitectura Implementada, Auditoría y Trazabilidad, Backend (+19 more)
...
Cohesion: 0.09
Nodes (28): ESTADO_BADGE, ManageLineas(), ManageLineasProps, mockGet, NIVEL_CON_PASOS_Y_SIGUIENTE, NIVEL_SIN_PASOS, TrazabilidadProducto(), AlertDialog() (+20 more)

### Community 69 - "test_exports.py"
Cohesion: 0.09
Nodes (13): AuditMiddleware, _extract_client_ip(), _is_trusted_proxy(), Verifica si una IP pertenece a una red de proxy de confianza., Extrae la IP real del cliente de forma segura.     Solo confía en X-Forwarded-Fo, Middleware para capturar la IP y el usuario de la petición actual,     guardándo, AuditMiddlewareCallTestCase, ExtractClientIpTestCase (+5 more)

### Community 70 - "auth_views.py"
Cohesion: 0.04
Nodes (33): Command, BaseCommand, Command, BaseCommand, AnulacionPedidoSerializer, ClienteListSerializer, ClienteSerializer, _fecha_pedido_to_iso_utc() (+25 more)

### Community 71 - "DespachoDashboard.test.tsx"
Cohesion: 0.13
Nodes (5): ConsultarTransformacionesAPITest, _payload(), TestCase, Tests de API de transformaciones de producto (endpoints de OrdenProduccionViewSe, RegistrarTransformacionAPITest

### Community 72 - "_extract_message"
Cohesion: 0.08
Nodes (12): OrdenProduccionSerializer, Lectura/escritura de una transformación máquina a máquina.      ``producto_entra, TransformacionProductoSerializer, OrdenProduccionViewSet, Jefe de Planta crea orden básica: código, peso, área, Jefe de Área completa los detalles de la orden:         - Selecciona producto (e, Calcula detalladamente los materiales y químicos necesarios para completar la OP, ISP: Endpoint específico para tintorero para consultar stock de químicos disponi (+4 more)
...
### Community 75 - "TexCore — Estándares de Desarrollo"
Cohesion: 0.07
Nodes (28): Prueba exportación del reporte de rotación de inventario., Prueba exportación de productos con stock cero., Prueba exportación del resumen de movimientos en CSV., Prueba exportación del Kardex a CSV interceptando SQL Server, BVA: formato 'pdf' no soportado en kardex → 400 Bad Request., BVA: formato 'pdf' no soportado en productos → 400 Bad Request., BVA: formato 'pdf' no soportado en stock-actual → 400 Bad Request., BVA: dias=999 fuera del rango válido (30,60,90,180) → se normaliza a 30, retorna (+20 more)

### Community 76 - "TransformacionProductoMermaTest"
Cohesion: 0.08
...
### Community 77 - "VendedorDashboard.cobranza.test.tsx"
Cohesion: 0.08
Nodes (25): 1. Aplicación: `gestion`, 2. Aplicación: `inventory`, 3. Aplicación: `production` y `tintura`, 4. Gestión de Despacho y Servicios Satélite, 4. Reversión de Pagos (Mayo 2026), 5. Diagramas de Proceso, 5. Stored Procedures de Reportes de Producción, `Cliente` (+17 more)

### Community 78 - ".hash_secret"
Cohesion: 0.15
Nodes (9): _extract_message(), Manejo de excepciones centralizado para TexCore.  Formato de respuesta de error, Extrae un mensaje legible de la estructura de datos del error DRF., Handler de excepciones unificado.     Reemplaza los 4 patrones distintos que exi, texcore_exception_handler(), ExtractMessageTestCase, TestCase, Pruebas de gestion/exceptions.py — texcore_exception_handler y _extract_message. (+1 more)
...
### Community 82 - "Recursos Algorítmicos y Técnicas de Optimización en TexCore"
Cohesion: 0.13
Nodes (13): KardexParams, BaseModel, RangoFechaParams, Schemas Pydantic para parámetros de los reportes. ISP: un schema por caso de uso, Parámetros comunes para reportes con rango de fechas y sede opcional., Parámetros para reportes por vendedor., StockParams, VendedorParams (+5 more)

### Community 83 - "CustomUserFactory"
Cohesion: 0.10
Nodes (19): _apply_pragmas(), Base, get_session_factory(), _make_engine(), _make_session_factory(), async_sessionmaker, AsyncSession, DeclarativeBase (+11 more)

### Community 84 - "TransformationView.test.tsx"
Cohesion: 0.11
Nodes (18): 16 de Junio de 2026, 1 de Junio de 2026, 22 de Junio de 2026, 23 de Junio de 2026, 24 de Junio de 2026, 3 de Junio de 2026, 8 de Junio de 2026, Auditoría Local por Microservicio — SQLite + SOLID + RFC 5424 + ISTQB (Fase 15) (+10 more)

### Community 85 - "EmpaquetadoDashboard.test.tsx"
Cohesion: 0.09
...
Cohesion: 0.12
Nodes (17): Agrupación por dominio (validada contra el archivo actual), Archivos críticos de referencia para la implementación, Archivos existentes a editar, Archivos nuevos a crear (todos en `gestion/views/`), Catálogo actual (validado línea por línea), Checklist de verificación por fase, Contexto, Decisiones ya confirmadas con el usuario (+9 more)

### Community 87 - "🛠 Detalle por Rol"
Cohesion: 0.09
Nodes (18): KPI_1, LOTE_1, makeQueryClient(), MAQUINA_1, MAQUINA_2, mockDelete, mockGet, mockPatch (+10 more)

### Community 88 - "MovimientoInventarioViewSet"
Cohesion: 0.09
...
### Community 89 - "DosificacionCalculator"
Cohesion: 0.09
Nodes (21): 1.1. Análisis Teórico del Problema, 1.2. Modelado Matemático y de Complejidad, 1.3. Solución Implementada: Precarga de Datos Relacionados, 1.4. Resultado: Complejidad Constante O(1), 1. Reducción de Complejidad Algorítmica en Consultas (Problema N+1), 2.1. Análisis Teórico, 2.2. Implementación en TexCore, 2.3. Contrapartidas (Trade-offs) (+13 more)

### Community 91 - "Grafo de Conocimiento y Navegación del Código (Graphify)"
Cohesion: 0.07
Nodes (20): init_db(), Crea las tablas y aplica permisos de archivo.     ISO 27001 A.10: chmod 0o600 —, JWTTokenManager, JWTTokenManager: gestiona ciclo de vida del JWT de servicio. SRP: única responsa, Obtiene y renueva automáticamente el JWT RS256 del servicio.     Thread-safe par, Retorna access token válido. Refresca si expira en los próximos 30s., Solicita nuevo access token a Django Internal API., True si el token expira en los próximos REFRESH_BUFFER_SECONDS. (+12 more)

### Community 92 - "Guía de Despliegue en Producción — TexCore"
Cohesion: 0.10
...
### Community 93 - "✅ Funcionalidades Implementadas"
Cohesion: 0.10
...
### Community 94 - "pdf.py"
Cohesion: 0.06
Nodes (25): OpsEstado, ProduccionKPIs, ProduccionKPIService, date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0)         p, Un punto de la serie temporal de producción diaria. (+17 more)
...
### Community 96 - "ManageLineas.test.tsx"
Cohesion: 0.13
...
### Community 97 - "TestServiceTokenView"
Cohesion: 0.10
...
### Community 98 - "TestValidateLoteView"
Cohesion: 0.11
...
### Community 101 - "Junio 2026"
Cohesion: 0.11
Nodes (10): TestCase, IDOR: un no-admin SIN sede que envía ?sede_id ajeno queda con el         parámet, Si falta bodega_id en un reporte restringido, debe dar 400, Sin autenticación no hay acceso, Un bodeguero DEBE poder acceder a reportes de su bodega asignada, Un bodeguero NO DEBE poder acceder a reportes de una bodega no asignada, Un administrador puede acceder a CUALQUIER bodega, El catálogo de productos no requiere bodega_id para el bodeguero (+2 more)

### Community 102 - "3. Puntos Críticos de Comparación"
Cohesion: 0.15
Nodes (10): FASE 3: el material llega — sale de la bodega de tránsito y entra         a la b, TestCase, EP justificación vacía → ValidationError (auditoría obligatoria)., Compatibilidad: un movimiento creado sin protocolo queda 'completado'., FASE 1+2: origen 100→70, tránsito 0→30, estado en_transito., EP insuficiente: 150 > 100 disponibles → error, nada cambia., FASE 3: tránsito 30→0, destino 0→30, estado completado (sin duplicar)., EP estado inválido: completar dos veces → ValidationError. (+2 more)

### Community 103 - "AdminSistemasDashboard.test.tsx"
Cohesion: 0.24
...
### Community 104 - "ReportingProxyViewExtraTestCase"
Cohesion: 0.09
Nodes (18): Arquitectura de Capas, Diagrama de flujo de una solicitud PDF, DIP — Inyección de dependencias vía FastAPI `Depends`, Fragilidad operacional eliminada (config.py), Integración con Django, Patrones de Diseño Aplicados y su Justificación, Servicio Satélite de Impresión (`printing_service`), SRP — Separación de responsabilidades (+10 more)

### Community 105 - "LogoutViewTestCase"
Cohesion: 0.11
Nodes (11): LOTE_1, MAQUINA_1, mockGet, mockPost, ORDEN_1, ORDEN_2, SelectCtx, toastErrorMock (+3 more)

### Community 106 - "ManageBodegas.test.tsx"
Cohesion: 0.19
Nodes (15): ConsumoMezclaService, SRP: gestiona el consumo de múltiples lotes de entrada para producir un lote de, EventoEtiquetaService, EventoEtiquetaService: orquesta la numeración y creación de eventos de etiqueta., MermaStockService, SRP: gestiona el stock de merma vendible por máquina.     ISO 27001 A.12.4: cada, Orquesta el registro de un lote de producción.     - Consume producto_entrada de, RegistroLoteService (+7 more)

### Community 107 - "MRPEngine"
Cohesion: 0.12
Nodes (5): CustomTokenObtainPairViewTestCase, CustomTokenRefreshViewTestCase, LogoutViewTestCase, TestCase, Pruebas de gestion/custom_jwt_views.py — login/refresh/logout basados en JWT por

### Community 108 - "report_service.py"
Cohesion: 0.15
Nodes (8): TestCase, Tests del modelo TransformacionProducto — registro granular máquina a máquina., Unicidad de numero_secuencia dentro de una OP., Datos mínimos válidos para construir una TransformacionProducto., Cálculo de merma y validaciones de peso., _transf_kwargs(), TransformacionProductoMermaTest, TransformacionProductoSecuenciaTest

### Community 109 - "ReportService"
Cohesion: 0.11
...
### Community 110 - "EditarMovimientoDialog.test.tsx"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (12): OutputFormatter, DataFrame, Protocol, Response, Protocol para formateadores de salida (Strategy Pattern). OCP: agregar formato P, Convierte un DataFrame en una Response HTTP descargable., IReportRepository, DataFrame (+4 more)

### Community 113 - "Servicio Satélite de Reportes Excel — TexCore"
Cohesion: 0.27
Nodes (10): Response, Servicio que ejecuta un SP, maneja el caso de DataFrame vacío,     y delega el f, Ejecuta el SP y retorna la Response formateada.         Si el DataFrame está vac, ReportService, _make_formatter(), _make_repo(), DataFrame, Tests unitarios del ReportService. Usa mocks de IReportRepository y OutputFormat (+2 more)

### Community 114 - "DjangoReportRepository"
Cohesion: 0.16
...
### Community 115 - "Mayo 2026"
Cohesion: 0.15
Nodes (11): CustomTokenObtainPairSerializer, CustomTokenObtainPairView, CustomTokenRefreshView, LogoutView, APIView, health_check(), URL configuration for TexCore project.  The `urlpatterns` list routes URLs to vi, Endpoint de salud para CI/CD y load balancers (sin autenticación). (+3 more)

### Community 116 - "DespachReversionAPITestCase"
Cohesion: 0.07
Nodes (9): Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 2700, JWTServiceAuthenticationExtraTestCase, TestCase, Pruebas complementarias de internal_api/authentication.py — ramas que test_authe, APITestCase, TestPdfProduccionViews, TestCase, Round-trip del claim de sede firmado en el JWT de servicio. (+1 more)

### Community 117 - "Microservicios Independientes — Plan de Implementación"
Cohesion: 0.13
Nodes (20): _audit(), BalanceMasasPdfView, _build_balance_masas_payload(), _build_reporte_avance_payload(), _get_printing_url(), _now_iso(), _proxy_pdf(), APIView (+12 more)
...
### Community 119 - "TransformacionAPIViewTestCase"
Cohesion: 0.12
Nodes (16): Arquitectura, Auditoría Local (ISO 27001 A.12.4), Autenticación con Backend (Fase 13), Despliegue, Endpoints (15 total), Estructura, Gerencial — `GET /gerencial/...`, Inventario — `GET /export/{recurso}` (+8 more)

### Community 120 - "Servicio Satélite de Impresión — TexCore"
Cohesion: 0.15
Nodes (8): DjangoReportRepository, DataFrame, JWTTokenManager, Ejecuta un SP (mapeado a endpoint REST) y retorna el resultado como DataFrame., Adapter que implementa IReportRepository via Django Internal API., Extrae 'sp_GetKardexBodega' de 'EXEC sp_GetKardexBodega @BodegaID=?, ..., Tests para DjangoReportRepository. EP por endpoint representativo., TestDjangoReportRepository

### Community 121 - "produccion_kpi_service.py"
Cohesion: 0.12
...
### Community 126 - "ReportingProxyRBACtest"
Cohesion: 0.12
Nodes (13): LOTE_1, LOTE_CON_MERMA, LOTE_MAS_ANTIGUO, mockGet, mockPatch, mockPost, mockUseAuth, ORDEN_1 (+5 more)

### Community 128 - "test_vendedores.py"
Cohesion: 0.18
Nodes (8): Servicio de lectura que estructura la trazabilidad de una OP., Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor, TrazabilidadService, _crear_transf(), TestCase, Tests de TrazabilidadService — reconstrucción del flujo completo de producción., TrazabilidadServiceTest

### Community 129 - "Documentación: Gestión de Etiquetas (Reetiquetado, Búsqueda por Fechas e Impresión Real)"
Cohesion: 0.10
Nodes (14): _get_user_audit_data(), Extrae datos auditables del usuario (solo PKs para FKs)., _FakeField, _FakeMeta, _FakeModeloConCampoRoto, _FakeUsuarioConCampoRoto, GetModelAuditDataTestCase, GetUserAuditDataTestCase (+6 more)

### Community 130 - "Servicio Satélite de Escaneo — TexCore"
Cohesion: 0.14
...
### Community 131 - "PrecisionDecimalInventoryTestCase"
Cohesion: 0.13
...
### Community 132 - "Diagramas de Secuencia — Usuarios Principales del Sistema TexCore"
Cohesion: 0.15
Nodes (11): ManageQuimicosProps, BuscadorQuimicoProps, calcularCantidad(), DetalleSchema, FaseSchema, FormulaFormValues, FormulaQuimica(), FormulaQuimicaProps (+3 more)

### Community 133 - "TestPdfEndpoint"
Cohesion: 0.12
Nodes (11): Revierte un pago deshaciendo el abono registrado.          Validaciones:, PagoReversionTestCase, TransactionTestCase, Caso 2: Reversión sin justificación falla          Verifica:         - ValueErro, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - Múlt, Caso 4: Reversión es transaccional          Verifica:         - Si falla un paso, Tests para la reversión de pagos.     Usa TransactionTestCase para test transacc, Configura datos de prueba comunes (+3 more)

### Community 134 - "OptionalPaginationTestCase"
Cohesion: 0.07
Nodes (29): Command, BaseCommand, Registra las credenciales de los microservicios en la BD (ServiceCredential). De, Command, BaseCommand, Management command: crea ServiceCredentials para los microservicios si no existe, Meta, ServiceCredential: identidad de un microservicio autorizado. ISO 27001 A.9.2 — G (+21 more)
...
### Community 137 - "Análisis del Rol de Vendedor - Sistema TexCore"
Cohesion: 0.11
...
### Community 138 - "AUDITORÍA DE CALIDAD DE SOFTWARE — TEXCORE"
Cohesion: 0.22
Nodes (3): TestFechaATexto, TestFechaATexto, _fecha_a_texto()

### Community 139 - "EtapasProduccion.test.tsx"
Cohesion: 0.13
...
### Community 140 - "RegistrarTransformacion.test.tsx"
Cohesion: 0.14
...
### Community 141 - "EliminarMovimientoDialog.test.tsx"
Cohesion: 0.16
Nodes (12): enterDespachoMode(), mockGet, mockNavigate, mockPedidosResponse(), mockPost, PEDIDO_1, PEDIDO_2, PEDIDO_3 (+4 more)

### Community 142 - "FrontendLogViewTestCase"
Cohesion: 0.18
Nodes (7): abrirExpedienteCliente(), abrirVentaNueva(), CLIENTE_1, esperarDirectorio(), irAReportes(), PEDIDO_1, PRODUCTO_1

### Community 143 - "report_factory.py"
Cohesion: 0.11
Nodes (11): fakeBlob, mockBodegas, mockProductos, navigateToReportes(), renderDashboard(), toastErrorMock, toastSuccessMock, LOG_CREATE (+3 more)

### Community 144 - "TestJWTTokenManager"
Cohesion: 0.15
Nodes (7): LoteProduccionViewSet, Ajusta stock de salida/entrada/químicos cuando el peso neto de un lote cambia., Retorna la genealogía y trazabilidad inversa del lote.         Muestra la máquin, Construye el payload base para el microservicio de impresión a partir del lote., GET /lotes-produccion/{id}/etiquetas/ — historial de eventos de etiqueta del lot, POST /lotes-produccion/{id}/reimprimir/ — reimpresión idéntica gobernada., POST /lotes-produccion/{id}/reetiquetar/ — reetiquetado con cambio de datos.

### Community 145 - "CONTEXTO — Análisis Exhaustivo de TexCore para Revisión Fable 5"
Cohesion: 0.21
Nodes (5): OptionalPagination, PageNumberPagination, OptionalPaginationTestCase, TestCase, Pruebas de gestion/pagination.py — OptionalPagination.  Extiende PageNumberPagin

### Community 146 - "Hotspots Detallados"
Cohesion: 0.14
Nodes (3): FrontendLogViewTestCase, TestCase, Pruebas de las vistas de sistema — gestion/views/system_views.py.  FrontendLogVi

### Community 147 - "TexCore — Registro de Riesgos"
Cohesion: 0.37
...
### Community 148 - "Interfaz de Usuario (Frontend) - Sistema TexCore"
Cohesion: 0.23
...
### Community 149 - "ComponenteMezclaPanel.test.tsx"
Cohesion: 0.15
...
### Community 150 - "ExtractClientIpTestCase"
Cohesion: 0.15
...
### Community 154 - "test_exports_errores.py"
Cohesion: 0.17
Nodes (10): CsvFormatter, DataFrame, Response, Formateador de salida CSV., Convierte DataFrames a archivos .csv descargables., _get_repo(), ReportFactory: crea el ReportService con DjangoReportRepository. Factory Pattern, Importa el singleton desde main.py (inicializado al arrancar el servicio). (+2 more)

### Community 155 - "test_gerencial.py"
Cohesion: 0.28
Nodes (5): _make_token(), Tests para JWTTokenManager. EP + BVA., Genera un par RSA temporal para tests., rsa_keys(), TestJWTTokenManager

### Community 156 - "test_produccion.py"
Cohesion: 0.17
...
### Community 158 - "🛠️ Implementación Sprint 1 (Fable 5 — 10 Junio 2026) — TDD"
Cohesion: 0.17
Nodes (11): BUG-01: URLs inexistentes retornan `TemplateDoesNotExist: index.html`, Datos de Carga (stress test), Hotspots Detallados, Informe de Rendimiento — TexCore API, PERF-03: `OrdenProduccionViewSet` — 660ms para 21K órdenes, PERF-04: `MovimientoInventarioViewSet` — sin `select_related`, sin ordering explícito, PERF-05: `AuditableModelMixin.__init__` + `only()` — N+1 oculto, PERF-CRIT-01: `ClienteManager` — 3 subconsultas correlacionadas (+3 more)

### Community 159 - "2. Scripts SQL de Eliminación Directa"
Cohesion: 0.17
...
### Community 160 - "Guía de Comandos para Operaciones en Producción"
Cohesion: 0.17
...
### Community 161 - "Documentación de la Configuración de Docker en TexCore"
Cohesion: 0.17
Nodes (11): Cómo ejecutar la suite, Defectos detectados y corregidos durante el refuerzo, Estado de cobertura, Frontend (React), Leyenda de técnicas ISTQB, Matriz, Matriz de Trazabilidad de Pruebas — TexCore (Backend), Seguridad y autenticación (+3 more)

### Community 162 - "Matriz"
Cohesion: 0.17
...
### Community 163 - "Servicio Satélite: scanning_service"
Cohesion: 0.17
...
### Community 164 - "12. PLAN DE ACCIÓN"
Cohesion: 0.23
...
### Community 165 - "2. Plan de Mejora Arquitectónica (S.O.L.I.D. & Patrones)"
Cohesion: 0.15
...
### Community 167 - "ManageMaquinas.test.tsx"
Cohesion: 0.13
...
### Community 168 - ".calcular_oee_area"
Cohesion: 0.17
...
### Community 169 - "EventoEtiqueta"
Cohesion: 0.15
Nodes (8): DescargaQuimicosOPTestCase, APITestCase, Suite de pruebas para la descarga automática de químicos en órdenes de producció, Caso: Crear OP con fórmula + bodega_quimicos         Esperado: Descarga automáti, Caso: Modificar OP (cambiar peso_neto_requerido) requiere justificación, Caso: Eliminar OP sin justificación debe fallar (HTTP 400)         Caso: Elimina, Caso: Consultar stock de químicos vía GET /stock-quimicos/?sede_id=<id>, Caso: Verificar auditoría completa de descarga (usuario, fecha, justificación)

### Community 170 - "ManageProductos.test.tsx"
Cohesion: 0.22
Nodes (3): _make_service_token(), TestCase, TestReportingEndpoints

### Community 171 - "1. Evaluación de Cumplimiento por Norma"
Cohesion: 0.17
Nodes (11): devDependencies, vitest, vitest, name, private, scripts, build, dev (+3 more)

### Community 172 - "_fecha_a_texto"
Cohesion: 0.17
...
### Community 174 - "6. APIs y Contratos"
Cohesion: 0.14
Nodes (13): Tests de integración para el router de Reportes Gerenciales., EP: rango de fechas válido → Excel con datos de ventas gerenciales., EP: con sede_id específico → Excel con top clientes de esa sede., EP: sin deuda pendiente → retorna Excel vacío (no 404)., BVA: formato 'pdf' no soportado en ventas gerencial → 400 Bad Request., BVA: formato 'pdf' no soportado en top-clientes gerencial → 400 Bad Request., BVA: formato 'pdf' no soportado en deudores gerencial → 400 Bad Request., test_deudores_gerencial_dado_dataframe_vacio_cuando_exporta_entonces_retorna_xlsx() (+5 more)

### Community 175 - "4. HALLAZGOS DE SEGURIDAD — OWASP TOP 10"
Cohesion: 0.14
Nodes (13): Tests de integración para el router de Reportes de Producción., EP: rango válido → Excel con órdenes de producción., EP: rango válido → Excel con lotes de producción., EP: rango válido → Excel con tendencia semanal de producción., BVA: formato 'pdf' no soportado en órdenes de producción → 400 Bad Request., BVA: formato 'pdf' no soportado en lotes de producción → 400 Bad Request., BVA: formato 'pdf' no soportado en tendencia de producción → 400 Bad Request., test_lotes_produccion_dado_rango_valido_cuando_exporta_entonces_retorna_xlsx() (+5 more)

### Community 176 - "_get_object_sede_id"
Cohesion: 0.18
...
### Community 177 - "async_export_report"
Cohesion: 0.29
...
### Community 178 - "TestReportingEndpoints"
Cohesion: 0.18
...
### Community 182 - "3. Servicios y Componentes"
Cohesion: 0.20
Nodes (5): fakeBlob, navigateToReportes(), renderDashboard(), toastErrorMock, toastSuccessMock

### Community 183 - "Guía de Deployment en Producción - TexCore"
Cohesion: 0.18
Nodes (8): MAQUINA_1, mockDelete, mockGet, mockPatch, mockPost, SelectCtx, toastErrorMock, toastSuccessMock

### Community 184 - "Manual de Roles y Flujo de Trabajo (Producción TexCore)"
Cohesion: 0.18
Nodes (6): FORMULA_1, FORMULA_2, QUIMICO_1, QUIMICO_2, SelectCtx, toastErrorMock

### Community 185 - "Análisis del Sistema de Despacho - TexCore"
Cohesion: 0.26
Nodes (4): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, MaquinaConMermaFactory, MermaStockServiceRegistrarTest, TDD — MermaStockService.registrar(). ISO 27001 A.12.4 + COBIT MEA01.

### Community 187 - "ReportingViewsExtraTestCase"
Cohesion: 0.18
Nodes (6): Suite de pruebas para verificar el Control de Acceso basado en Roles (RBAC)., Matrix test para /api/inventory/historial-despachos/         Permitidos: admin_s, Matrix test para /api/inventory/stock/         Permitidos: Casi todos excepto op, Matrix test para /api/inventory/process-despacho/ (Endpoint crítico de escritura, Verifica que sin login no haya acceso a nada, RBACMatrixTestCase

### Community 188 - "export_lotes_produccion"
Cohesion: 0.25
Nodes (4): _create_credential(), TestCase, Tests para endpoints de autenticación de servicios. EP + STT., TestServiceTokenView

### Community 190 - "SedeFilteringTestCase"
Cohesion: 0.10
Nodes (8): _get_required_env(), Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., Valida que el path del reporte sea seguro.     Previene Path Traversal y acceso, _validate_report_path(), GetRequiredEnvTestCase, TestCase, ReportingProxyViewExtraTestCase, ValidateReportPathTestCase

### Community 191 - "DescargaQuimicosStockInsuficienteTestCase"
Cohesion: 0.15
Nodes (13): 13 de Noviembre de 2025, 21 de Agosto de 2026, 22 de Diciembre de 2025, 26 de Enero de 2026, Agosto 2026, Changelog, Correcciones y Mejoras de Estabilidad, Diciembre 2025 (+5 more)

### Community 192 - "TestPdfProduccionViews"
Cohesion: 0.20
...
### Community 193 - "export_top_clientes"
Cohesion: 0.20
...
### Community 195 - "TexCore — Sistema Integral de Gestión para la Industria Textil"
Cohesion: 0.20
Nodes (7): BODEGA_CENTRAL, BODEGA_SECUNDARIA, SEDE_NORTE, SEDE_SUR, toastErrorMock, USER_NORTE, USER_SUR

### Community 196 - "export_top_clientes_gerencial"
Cohesion: 0.20
Nodes (8): mockDelete, mockGet, mockPatch, mockPost, mockPut, MOVIMIENTO_1, toastErrorMock, toastSuccessMock

### Community 197 - "Command"
Cohesion: 0.20
Nodes (8): FORMULA_1, mockDelete, mockGet, mockPost, mockPut, QUIMICO_1, toastErrorMock, toastSuccessMock

### Community 198 - "🛠️ Implementación Sprint 6 (Fable 5 — 10 Junio 2026) — F0-001 + F0-002 + Protocolo 3-Fase"
Cohesion: 0.20
...
### Community 199 - "Funcionalidades Faltantes para Industria Textil"
Cohesion: 0.16
Nodes (9): AuditLogger, Registra en log estructurado (RFC 5424) cada acceso a la API interna     con ide, Emite log estructurado para trazabilidad ISO 27001 A.12.4.          Args:, AuditLoggerTestCase, TestCase, Pruebas de internal_api/audit.py — AuditLogger.log.  Técnicas ISTQB aplicadas: -, APIView, GET /api/internal/v1/lotes/{codigo_barras}/validate/      Retorna información de (+1 more)

### Community 200 - "5. CALIDAD DE CÓDIGO — PRINCIPIOS SOLID Y DRY"
Cohesion: 0.20
...
### Community 202 - "8. Infraestructura y Despliegue"
Cohesion: 0.15
...
### Community 203 - "✅ Funcionalidades Implementadas"
Cohesion: 0.27
Nodes (4): DjangoReportRepository: implementa IReportRepository via Django Internal API. Pa, JWTTokenManager, JWTTokenManager: gestiona ciclo de vida del JWT de servicio. SRP: única responsa, SRP: gestiona ciclo de vida del JWT. ISO 27001 A.10: en memoria.

### Community 204 - "InventoryForm.test.tsx"
Cohesion: 0.20
Nodes (9): bypass_jwt(), mock_db_connection(), mock_pandas_read_sql(), mock_repo(), conftest.py del reporting_excel. Proporciona fixtures compartidos para tests., Reemplaza jwt.decode por un mock que acepta cualquier Bearer token en tests., No-op: pyodbc fue reemplazado por DjangoReportRepository. Fixture mantenido por, Mockea DjangoReportRepository.execute_sp (reemplaza la anterior capa pyodbc/pd.r (+1 more)

### Community 205 - "manifest.json"
Cohesion: 0.22
...
### Community 206 - "ProduccionKPIService"
Cohesion: 0.22
...
### Community 207 - "TestJWTServiceAuthentication"
Cohesion: 0.17
...
### Community 208 - "HistorialDespachoFiltrosFechaTestCase"
Cohesion: 0.17
Nodes (12): Análisis del Sistema de Despacho - TexCore, Archivos Clave de Referencia, Arquitectura General, Checklist de Funcionalidades, Diagrama de Componentes, Flujo Completo de Despacho (end-to-end), Implementado, Modelo ServiceCredential (+4 more)

### Community 209 - "KardexFilterTests"
Cohesion: 0.22
...
### Community 210 - "🛠️ Implementación Sprint 2 (Fable 5 — 10 Junio 2026) — Anticipos y Pagos Parciales"
Cohesion: 0.22
...
### Community 212 - "Marzo 2026"
Cohesion: 0.22
Nodes (5): PRODUCTO_1, PRODUCTO_2, PRODUCTO_MERMA, SelectCtx, toastErrorMock

### Community 213 - "Análisis de Errores Críticos (P0)"
Cohesion: 0.22
Nodes (8): mockGet, mockPost, ORDEN_1, ORDEN_2, SelectCtx, toastErrorMock, toastSuccessMock, TRANSFERENCIA_1

### Community 214 - "9. Testing y Calidad"
Cohesion: 0.25
Nodes (7): ChartConfig, ChartType, DEFAULT_COLORS, SharedKPIChart(), SharedKPIChartProps, CONFIG, DATA

### Community 216 - "🐛 Troubleshooting"
Cohesion: 0.25
...
### Community 220 - "PedidoVentaOptimizationTest"
Cohesion: 0.24
...
### Community 221 - "4. Autenticacion y Seguridad"
Cohesion: 0.25
Nodes (3): _make_service_token(), TestCase, TestValidateLoteView

### Community 222 - "🗄️ Paso 6: Inicializar la Base de Datos"
Cohesion: 0.22
...
### Community 223 - "7.2 Desde Otra Máquina en la Red"
Cohesion: 0.36
...
### Community 225 - "Django Internal API (/api/internal/v1/)"
Cohesion: 0.25
...
### Community 226 - "ProcessDespachoAPIView"
Cohesion: 0.25
...
### Community 227 - "JefeAreaDashboard.tsx"
Cohesion: 0.25
...
### Community 228 - "ImageWithFallback.tsx"
Cohesion: 0.25
...
### Community 230 - "SharedKPIChart.tsx"
Cohesion: 0.25
...
### Community 232 - "OutputStrategy"
Cohesion: 0.25
Nodes (7): background_color, display, icons, name, short_name, start_url, theme_color

### Community 233 - "5 de Junio de 2026"
Cohesion: 0.25
...
### Community 234 - "ClienteImprovementsTestCase"
Cohesion: 0.22
...
### Community 236 - "deploy_prod.sh script"
Cohesion: 0.28
Nodes (4): Escape backslash, double quote, and right bracket as per RFC 5424 §6.3.3, RFC 5424 Syslog Formatter     Format: <PRI>VERSION TIMESTAMP HOSTNAME APP-NAME P, RFC5424Formatter, _setup_logging()

### Community 237 - "Julio 2026"
Cohesion: 0.32
Nodes (3): getCellValue(), rowComparator(), sortColumn()

### Community 238 - "Plan de Acción Prioritario"
Cohesion: 0.29
...
### Community 239 - "Problemas de Degradación (P1)"
Cohesion: 0.29
...
### Community 240 - "1. Vision General del Sistema"
Cohesion: 0.29
...
### Community 241 - "2. Diagrama de Arquitectura C4"
Cohesion: 0.29
...
### Community 242 - "5. Modelos de Datos"
Cohesion: 0.29
...
### Community 245 - "📊 Monitoreo y Mantenimiento"
Cohesion: 0.29
...
### Community 246 - "🔧 Paso 1: Instalación de Dependencias Base"
Cohesion: 0.29
Nodes (4): QUIMICO_1, QUIMICO_2, SelectCtx, toastErrorMock

### Community 247 - "Autenticacion JWT RS256 entre Servicios"
Cohesion: 0.33
Nodes (4): mockDelete, MOVIMIENTO, toastErrorMock, toastSuccessMock

### Community 248 - "Scripts y Comandos de Gestion"
Cohesion: 0.29
Nodes (5): ETAPA, mockGet, ORDEN_CON_ETAPAS, ORDEN_SIN_ETAPAS, toastErrorMock

### Community 249 - "13. MÉTRICAS DE DEUDA TÉCNICA"
Cohesion: 0.43
Nodes (5): FIELD_LABELS, formatApiError(), FormattedError, getFieldLabel(), sanitizeMessage()

### Community 250 - "TintoreroDashboard.test.tsx"
Cohesion: 0.31
Nodes (4): PrintingServiceUrlResolutionTestCase, PrintingServiceZplTestCase, TestCase, Antes PRINTING_SERVICE_URL era una constante de módulo leída de     os.environ d

### Community 252 - "FlujoProduccion.test.tsx"
Cohesion: 0.44
Nodes (8): export_lotes_produccion(), export_ordenes_produccion(), export_tendencia_produccion(), AuditRepository, BackgroundTasks, date, Request, Reportes de Producción para descarga ejecutiva. DIP: get_audit_repo crea la depe

### Community 253 - "conftest.py"
Cohesion: 0.42
Nodes (8): export_deudores(), export_top_clientes(), export_ventas_vendedor(), AuditRepository, BackgroundTasks, date, Request, Router de reportes por vendedor. DIP: get_audit_repo crea la dependencia; el rou

### Community 254 - "get_current_user"
Cohesion: 0.33
...
### Community 257 - "3. MODELO DE CALIDAD ISO/IEC 25010"
Cohesion: 0.33
Nodes (6): 3.1. Aislamiento de Procesos Pesados (CPU-Bound), 3.2. Idoneidad Tecnológica y Rendimiento, 3.3. Gestión de Dependencias a Nivel de Sistema Operativo, 3.4. Resiliencia y Tolerancia a Fallos, 3.5. Escalabilidad Independiente, 3. Puntos Críticos de Comparación

### Community 258 - "get_session_factory"
Cohesion: 0.33
...
### Community 259 - "Módulo de Gestión (Core Business)"
Cohesion: 0.33
...
### Community 260 - "Módulo de Inventario"
Cohesion: 0.33
...
### Community 262 - "test_gerencial_errores.py"
Cohesion: 0.33
...
### Community 264 - "deploy.sh script"
Cohesion: 0.25
...
### Community 266 - "SedeResolvableMixin"
Cohesion: 0.18
Nodes (5): AuditLogger: registra accesos de servicios internos. ISO 27001 A.12.4 — Registro, JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Pruebas unitarias para vistas de generación de PDFs de producción en internal_ap, Endpoint interno para validación de lotes por scanning_service. SRP: solo expone, Pruebas complementarias de inventory/reporting_proxy.py — ramas que test_reporti

### Community 267 - "Problemas de Arquitectura y Patrones"
Cohesion: 0.29
Nodes (4): CookieJWTAuthentication, Backend de autenticación que lee el JWT desde una cookie httponly     en lugar d, Pruebas del backend de autenticación JWT por cookie — gestion/auth_backends.py., JWTAuthentication

### Community 268 - "Estado del Proyecto"
Cohesion: 0.33
...
### Community 269 - "Resumen Ejecutivo"
Cohesion: 0.29
Nodes (5): Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., ConsumoMezclaServiceRevertir, TestCase, STT: mezcla consumida → revertir → stock restaurado.

### Community 270 - "Auditoría y Optimización de Base de Datos SQL Server 2022 — TexCore"
Cohesion: 0.17
...
### Community 271 - "Docker — Configuración específica por plataforma"
Cohesion: 0.25
...
### Community 272 - "⚙️ Paso 3: Configuración de Variables de Entorno"
Cohesion: 0.60
Nodes (5): print_cyan(), print_error(), print_green(), print_yellow(), deploy_prod.sh script

### Community 273 - "🔐 Paso 4: Configurar Certificados SSL"
Cohesion: 0.40
Nodes (4): 1. Graphify Knowledge Graph, 2. Estándares de Testing y Verificación, 3. Normas de Arquitectura y Base de Datos (SQL Server 2022), TexCore Agent Guidelines (Gemini / Antigravity)

### Community 274 - "🚀 Paso 5: Construir y Levantar los Contenedores"
Cohesion: 0.40
Nodes (4): Backend & Servicios Satélite, Frontend, Recursos de Diseño y Medios, TexCore — Atribuciones y Licencias de Terceros

### Community 275 - "✅ Paso 8: Verificación del Deployment"
Cohesion: 0.29
Nodes (7): Endpoints, `GET /health`, `POST /pdf/etiqueta`, `POST /pdf/nota-venta`, `POST /pdf/reporte-avance`, `POST /pdf/reporte-balance`, `POST /zpl/etiqueta`

### Community 276 - "🔄 Paso 9: Gestión del Deployment"
Cohesion: 0.17
Nodes (5): TexCore Testing & Quality Standards, 1. Graphify Knowledge Graph, 2. Testing & Verification Commands, 3. Architecture & Database Rules (SQL Server 2022), TexCore Claude Code Guidelines

### Community 277 - "Trazabilidad y Auditoria"
Cohesion: 0.40
...
### Community 279 - "DetalleHistorialDespachoAdmin"
Cohesion: 0.40
...
### Community 283 - "HistorialDespachoAdmin"
Cohesion: 0.40
...
### Community 284 - "Módulo Internal API"
Cohesion: 0.40
...
### Community 286 - "run_backend_tests.sh"
Cohesion: 0.40
...
### Community 287 - "Docker Compose (produccion)"
Cohesion: 0.40
...
### Community 288 - "📦 Paso 2: Preparar el Proyecto"
Cohesion: 0.40
...
### Community 289 - "Checklist de Funcionalidades"
Cohesion: 0.40
...
### Community 292 - "TintoreroRBACTestCase"
Cohesion: 0.40
Nodes (3): Command, BaseCommand, Aplica las optimizaciones DDL de SQL Server (RCSI, índices, CHECK constraints) y

### Community 293 - "axios.test.ts"
Cohesion: 0.40
Nodes (3): Command, BaseCommand, Management command to seed production master roles and permissions for a clean T

### Community 294 - "date-fns"
Cohesion: 0.40
Nodes (3): Command, BaseCommand, Comando para verificar que la auditoría está funcionando. Uso: python manage.py

### Community 295 - "@hookform/resolvers"
Cohesion: 0.40
Nodes (4): Comandos Útiles, Estructura Principal, Módulo de Gestión (Core Business), Responsabilidades

### Community 296 - "InternalApiConfig"
Cohesion: 0.40
Nodes (4): Estructura Principal, Integraciones, Módulo de Inventario, Responsabilidades

### Community 299 - "Nginx API Gateway"
Cohesion: 0.29
Nodes (7): Archivos existentes a editar, Archivos nuevos a crear (todos en `inventory/views/`), Catálogo actual, Fase 2 — `inventory/views.py` (1193 líneas → 7 archivos, paquete nuevo), `__init__.py` nuevo (no existe hoy), Ruptura conocida y obligatoria — un archivo de test, Sin cambios necesarios

### Community 300 - "Scripts de Test Manual"
Cohesion: 0.29
Nodes (4): App(), mockAuthState, queryClient, root

### Community 301 - "TexCore (Configuración Global)"
Cohesion: 0.70
Nodes (4): print_cyan(), print_error(), print_green(), deploy.sh script

### Community 302 - "HistorialDespachos.test.tsx"
Cohesion: 0.40
...
### Community 307 - "22 de Junio de 2026"
Cohesion: 0.50
...
### Community 311 - "@radix-ui/react-accordion"
Cohesion: 0.50
...
### Community 312 - "@radix-ui/react-aspect-ratio"
Cohesion: 0.50
...
### Community 313 - "@radix-ui/react-avatar"
Cohesion: 0.50
Nodes (4): 1. RESUMEN EJECUTIVO, Dictamen General, Puntuación por Dimensión, Resumen de Defectos — Estado Final

### Community 317 - "@radix-ui/react-dropdown-menu"
Cohesion: 0.33
Nodes (4): Revierte el stock de merma creado por este lote., MermaStockServiceRevertirTest, TestCase, STT: merma registrada → lote rechazado → stock revertido.

### Community 318 - "@radix-ui/react-label"
Cohesion: 0.50
Nodes (3): Módulo Internal API, Responsabilidades, Seguridad

### Community 320 - "@radix-ui/react-progress"
Cohesion: 0.67
Nodes (3): 2.1 Navegar al Directorio del Proyecto, 2.2 Verificar la Estructura del Proyecto, 📦 Paso 2: Preparar el Proyecto

### Community 321 - "@radix-ui/react-radio-group"
Cohesion: 0.33
...
### Community 373 - "wsgi.py"
Cohesion: 0.40
Nodes (5): Agrupación por dominio (validada, sin ciclos de FK reales), Archivos existentes a editar, Fase 4 — `gestion/models.py` (1655 líneas → 7 archivos, paquete nuevo), `__init__.py` nuevo (no existe hoy), Verificación específica de esta fase (la más sensible)

### Community 390 - "__init__.py"
Cohesion: 0.40
...
### Community 392 - "__init__.py"
Cohesion: 0.50
Nodes (4): 19 de Junio de 2026, Fix CI: Crash en `TransferenciasInterarea` y 500 en `reporting_proxy` por claves JWT ausentes, Fix: Transferencias Interárea para Jefe de Planta, Panel de Detalle de Órdenes de Producción y Corrección de Áreas en Jefe de Planta

### Community 403 - ".test_auditoria_descarga_quimicos"
Cohesion: 0.67
Nodes (3): Patron DjangoReportRepository, Servicio Satélite: reporting_excel, Variables de Entorno

## Knowledge Gaps
- **1678 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1673 more)
...
- **Why does `CustomUserFactory` connect `InventoryDashboard.tsx` to `test_vendedores.py`, `ConsumoMezclaServiceConsumir`, `ComponenteMezclaOPFactory`, `TestJWTTokenManager`, `ManageOrdenesProduccion.tsx`, `UnifiedBusinessLogicTestCase`, `VendedorDashboard.tsx`, `Resumen Ejecutivo`, `Command`, `CookieJWTAuthentication`, `ServiceTokenRefreshViewTestCase`, `ProductoFactory`, `EjecutivosDashboard.test.tsx`, `Documentación Técnica: Sistema de Reversión de Pagos del Cliente`, `compilerOptions`, `FormulaQuimica.tsx`, `Análisis del Sistema de Despacho - TexCore`, `VendedorDashboard.detalle.test.tsx`, `@radix-ui/react-dropdown-menu`, `DespachoDashboard.test.tsx`, `Esquema de Base de Datos y Modelo de Negocio`, `ExecutiveKPIService`, `7.2 Desde Otra Máquina en la Red`, `MRPEngine`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `SedeFactory` connect `VendedorDashboard.tsx` to `InventoryDashboard.tsx`, `ConsumoMezclaServiceConsumir`, `ComponenteMezclaOPFactory`, `DespachoDashboard.test.tsx`, `ManageOrdenesProduccion.tsx`, `FormulaQuimica.tsx`, `Command`, `CookieJWTAuthentication`, `ServiceTokenRefreshViewTestCase`, `ProductoFactory`, `EjecutivosDashboard.test.tsx`, `VendedorDashboard.detalle.test.tsx`, `Documentación Técnica: Sistema de Reversión de Pagos del Cliente`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `StockBodega` connect `ConsumoMezclaServiceConsumir` to `ServiceCredential`, `7.2 Desde Otra Máquina en la Red`, `Análisis del Sistema de Despacho - TexCore`, `main.py`, `AdminSistemasDashboard.tsx`, `Documentación: Descarga Automática de Químicos en Tintorería`, `3. Puntos Críticos de Comparación`, `5. CALIDAD DE CÓDIGO — PRINCIPIOS SOLID Y DRY`, `ManageOrdenesProduccion.tsx`, `UnifiedBusinessLogicTestCase`, `ManageBodegas.test.tsx`, `SedeResolvableMixin`, `Command`, `TestJWTTokenManager`, `StockBodega`, `CookieJWTAuthentication`, `.test_process_despacho_post_access`, `OrdenProduccionFactory`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 96 inferred relationships involving `CustomUserFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`CustomUserFactory` has 96 INFERRED edges - model-reasoned connections that need verification._
- **Are the 88 inferred relationships involving `SedeFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`SedeFactory` has 88 INFERRED edges - model-reasoned connections that need verification._
- **Are the 66 inferred relationships involving `ProductoFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`ProductoFactory` has 66 INFERRED edges - model-reasoned connections that need verification._
- **Are the 50 inferred relationships involving `AreaFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`AreaFactory` has 50 INFERRED edges - model-reasoned connections that need verification._