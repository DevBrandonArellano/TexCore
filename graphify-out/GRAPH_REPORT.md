# Graph Report - TexCore  (2026-09-02)

## Corpus Check
- 713 files · ~527,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7628 nodes · 16725 edges · 461 communities (379 shown, 82 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1951 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2f1d492`
...
## Communities (461 total, 82 thin omitted)

### Community 0 - "cn"
Cohesion: 0.04
Nodes (76): AuditLog, DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, AuditoriaMovimiento, DetalleHistorialDespacho (+68 more)

### Community 1 - "InventoryDashboard.tsx"
Cohesion: 0.03
Nodes (87): AdminSistemasDashboard(), ManageAreas(), ManageAreasProps, AREA_1, SEDE_1, SEDE_2, toastErrorMock, ManageBodegasProps (+79 more)

### Community 2 - "PagoCliente"
Cohesion: 0.03
Nodes (31): CustomUserFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProductoViewSetMultiTenancyTestCase, ProveedorViewSetMultiTenancyTestCase, TestCase (+23 more)

### Community 3 - "AdminSistemasDashboard.tsx"
Cohesion: 0.04
Nodes (95): AbstractUser, BodegaAdmin, BodegueroInline, LineaProduccionAdmin, TransformacionProductoAdmin, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Carga ~1,000,000 registros para estresar el aplicativo TexCore.  Usa bulk_crea, Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente (+87 more)

### Community 4 - "AuditLog"
Cohesion: 0.02
Nodes (101): Command, BaseCommand, make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la, Factory para crear clases de permiso basadas en grupos de Django.      Otorga, AnulacionPedidoSerializer, ModificacionPedidoSerializer, ConsumoMezclaService (+93 more)

### Community 5 - "factories.py"
Cohesion: 0.07
Nodes (42): URLs de la API interna. Namespace: internal_api., AgingView, _audit(), DeudoresGerencialView, DeudoresVendedorView, KardexView, LotesProduccionView, OrdenesProduccionView (+34 more)
...
### Community 7 - "main.py"
Cohesion: 0.05
Nodes (46): ManageBodegas(), ManageClientes(), CLIENTE_1, CLIENTE_2, SelectCtx, toastErrorMock, ManageFormulas(), FORMULA_1 (+38 more)
...
Cohesion: 0.09
Nodes (20): CostoLoteProduccionSerializer, CostoLoteService, Tarifa vigente a la fecha; vigente_hasta NULL = contrato abierto., Costo/hora vigente a la fecha; vigente_hasta NULL = sin fecha fin., Calcula y persiste el desglose de costos de un lote de producción., CosteoCalculoTestCase, CosteoEndpointTestCase, CosteoLoteBaseTestCase (+12 more)

### Community 10 - "UnifiedBusinessLogicTestCase"
Cohesion: 0.03
Nodes (38): ClienteFactory, SedeFactory, ClienteAuditoriaJustificacionTestCase, TestCase, Pruebas de ClienteViewSet — requisito de justificación de auditoría en updates., TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_c (+30 more)

### Community 11 - "HasScope"
Cohesion: 0.04
Nodes (25): LoteProduccionFactory, ParoMaquinaFactory, LoteProduccionPresentacionEmpaqueTestCase, KPIAreaCalidadRendimientoTestCase, KPIAreaViewTestCase, KpiEjecutivoViewTestCase, ParsearRangoFechasTestCase, ProduccionHistorialProductoViewTestCase (+17 more)

### Community 12 - "App.tsx"
Cohesion: 0.18
Nodes (10): clear_cascade_justification(), get_cascade_justification(), get_current_user(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), CascadeJustificationTestCase, GetCurrentUserTestCase, Pruebas del middleware de auditoría — gestion/middleware.py.  Foco de segurida (+2 more)
...
### Community 14 - ".handle"
Cohesion: 0.08
Nodes (60): InventoryDashboardProps, StockItem, KardexView, KardexViewProps, ManageProductosProps, ManageProveedoresProps, RegistrarEntradaView, RegistrarEntradaViewProps (+52 more)

### Community 15 - "ConsumoMezclaServiceConsumir"
Cohesion: 0.03
Nodes (37): DetalleFormulaSerializer, ComponenteMezclaOPSerializer, OrdenProduccionEstadoSerializer, DetallePedidoSerializer, Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., ComponenteMezclaOPFactory, OrdenProduccionFactory (+29 more)
...
Cohesion: 0.08
Nodes (23): Continuidad de cadena: entrada = salida de la transformación previa., Servicio de aplicación para registrar transformaciones de producto., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, TransformacionService, Servicio de lectura que estructura la trazabilidad de una OP., Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor, TrazabilidadService (+15 more)

### Community 19 - "ServiceTokenRefreshViewTestCase"
Cohesion: 0.03
Nodes (48): Meta, ProductoSerializer, ProveedorSerializer, GroupSerializer, Meta, SedeSerializer, BatchSerializer, DetalleFormulaEscrituraSerializer (+40 more)
...
Cohesion: 0.06
Nodes (71): AdminSedeDashboard(), InventoryDashboard(), ManageClientesProps, OverviewTab, ProduccionTab, RolesPanel, ClienteComprasModal(), ClienteComprasModalProps (+63 more)

### Community 22 - "pdf_produccion_views.py"
Cohesion: 0.12
Nodes (11): Si la máquina del lote tiene producto_merma configurado y         peso_merma > 0, MaquinaConMermaFactory, MermaStockServiceRegistrarTest, MermaStockServiceRevertirTest, TestCase, TDD — MermaStockService.registrar(). ISO 27001 A.12.4 + COBIT MEA01., STT: merma registrada → lote rechazado → stock revertido., TestCase (+3 more)

### Community 23 - "EjecutivosDashboard.test.tsx"
Cohesion: 0.03
Nodes (69): calcularSaldoAcumulado(), normalizeBodegaKey(), TransferFormData, validateTransfer(), KardexViewImpl(), StockView, ITEM_1, ITEM_2 (+61 more)

### Community 24 - "InventoryDashboard.reportes.test.tsx"
Cohesion: 0.02
Nodes (125): input-otp, react, AccordionContent(), AccordionItem(), AccordionTrigger(), Avatar(), AvatarFallback(), AvatarImage() (+117 more)

### Community 25 - "ValidateResponse"
Cohesion: 0.03
Nodes (28): AreaFactory, ConsumoLoteDetalleFactory, MaquinaFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, Pruebas de gestion/views/core_views.py — SedeViewSet, AreaViewSet, CustomUserVi, SedeViewSetTestCase (+20 more)

### Community 26 - "Auditoría y Mejoras del Rol Jefe de Área"
Cohesion: 0.11
Nodes (67): ApprovalRequests(), Group, AuditoriaDialogProps, AlertaStock, EditarMovimientoDialogProps, EliminarMovimientoDialogProps, ItemIncompleto, ScannedItem (+59 more)
...
Cohesion: 0.04
Nodes (56): AppContent(), AuditoriaDialog(), LOG_1, mockGet, BodegueroDashboard(), EditarMovimientoDialog(), DespachoDashboard(), GuiaRemisionModal() (+48 more)

### Community 29 - "MovimientoInventarioUpdateSerializer"
Cohesion: 0.20
Nodes (11): _get_object_sede_id(), Obtiene sede_id del objeto para filtrar logs de entidades eliminadas.     Prior, audit_user_delete(), _create_audit_for_model(), _delete_audit_for_model(), _get_model_audit_data(), Registra eliminación de usuarios en auditoría., Extrae datos auditables de cualquier modelo (solo campos normales, no M2M). (+3 more)

### Community 30 - "_make_pedido"
Cohesion: 0.06
Nodes (27): AreaSerializer, DosificacionSerializer, Serializer de entrada para el endpoint de calculo de dosificacion., calcular_dosificacion_gr_l(), calcular_dosificacion_pct(), DosificacionCalculator, Decimal, Servicio de calculo de dosificacion para formulas de tintoreria.  Metodos de c (+19 more)
...
Cohesion: 0.06
Nodes (37): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., AuditRepository, BackgroundTasks, Router HTTP para validación de lotes. DIP: get_validation_service y get_audit_r (+29 more)
...
Cohesion: 0.10
Nodes (17): JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Identidad de un microservicio autenticado. Inmutable post-creación.      `sede, ServicePrincipal, HasScope, IsInternalService, BasePermission, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. C, Permite acceso solo si el request fue autenticado como ServicePrincipal. (+9 more)
...
Cohesion: 0.02
Nodes (77): Command, BaseCommand, MateriaPrimaLoteSerializer, Entrada del endpoint registrar_entrada — la creación real la hace el servicio., RegistrarMateriaPrimaSerializer, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Pa, Decimal, Reversión manual de stock al rechazar un lote: salida producida,         materia (+69 more)
...
Cohesion: 0.02
Nodes (37): BodegaFactory, StockBodegaFactory, BodegaViewSetQuerysetTestCase, BodegaViewSetWriteTestCase, TestCase, Pruebas de gestion/views/inventory_views.py — BodegaViewSet.  Cubre el filtrad, Caja blanca de get_queryset: admin ve todo, bodeguero solo asignadas., get_permissions: escritura exige admin_sistemas/admin_sede. (+29 more)
...
Cohesion: 0.09
Nodes (26): BuildBalanceMasasPayloadTestCase, BuildReporteAvancePayloadTestCase, APITestCase, Función pura (sin ORM en su firma): mapea registros ya materializados     (dict, Función pura: reconcilia stock actual + movimientos del mes por producto.     C, _audit(), BalanceMasasPdfView, _build_balance_masas_payload() (+18 more)
...
Cohesion: 0.11
Nodes (10): TestCase, IDOR: un no-admin CON sede que envía ?sede_id ajeno es sobrescrito por, IDOR: un no-admin SIN sede que envía ?sede_id ajeno queda con el         paráme, Si falta bodega_id en un reporte restringido, debe dar 400, Sin autenticación no hay acceso, Un bodeguero DEBE poder acceder a reportes de su bodega asignada, Un bodeguero NO DEBE poder acceder a reportes de una bodega no asignada, Un administrador puede acceder a CUALQUIER bodega (+2 more)
...
Cohesion: 0.05
Nodes (20): CustomTokenObtainPairSerializer, CustomTokenObtainPairView, CustomTokenRefreshView, LogoutView, APIView, get_user_role(), APIView, UserProfileView (+12 more)
...
Cohesion: 0.10
Nodes (14): DefaultContentNegotiation, async_export_report(), Tarea asíncrona para generar reportes pesados sin bloquear a Gunicorn.      Ig, AsyncExportReportTestCase, TestCase, Pruebas de gestion/tasks.py — tareas asíncronas Celery.  async_export_report:, report_path: uno de los paths whitelisteados en reporting_proxy.py (ej.     "ex, resolve_report() (+6 more)

### Community 145 - "CONTEXTO — Análisis Exhaustivo de TexCore para Revisión Fable 5"
Cohesion: 0.19
Nodes (5): PrintingServiceNotaVentaPdfTestCase, PrintingServiceUrlResolutionTestCase, PrintingServiceZplTestCase, TestCase, Antes PRINTING_SERVICE_URL era una constante de módulo leída de     os.environ
...
Cohesion: 0.05
Nodes (34): Command, BaseCommand, Registra las credenciales de los microservicios en la BD (ServiceCredential). D, Meta, ServiceCredential: identidad de un microservicio autorizado. ISO 27001 A.9.2 — G, Representa la identidad de un microservicio que consume la API interna., Genera hash seguro del secret usando el hasher de Django (PBKDF2/bcrypt)., ServiceCredential (+26 more)
...
Cohesion: 0.03
Nodes (52): Bodega, DjangoModelFactory, DescargaQuimicosService, Decimal, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se us, Template Method: secuencia fija revertir → descargar.         Se usa al modific, Servicio de descarga automática de químicos al crear/modificar/eliminar órdenes, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en l (+44 more)
...
Cohesion: 0.24
Nodes (6): AuditMiddleware, get_current_ip(), Middleware para capturar la IP y el usuario de la petición actual,     guardánd, AuditMiddlewareCallTestCase, TestCase, Caja blanca: rama feliz (response) y rama de excepción (re-raise).
...
Cohesion: 0.29
Nodes (6): 5.1 — ConfiguracionEmpaqueSede (completado tras checkpoint con Brandon), Barrido de Higiene — Fase 5: Mejoras Arquitectónicas (SOLID/DRY), Completados (resto de la fase), Descartado tras investigación — NO se tocó, Pendiente — requiere decisión de Brandon antes de tocarse, Verificación de cierre
...
Cohesion: 0.20
Nodes (5): apply_movement(), get_stock(), Obtiene el stock actual de un producto en una bodega., Actualiza la cantidad de un StockBodega., Genera el siguiente código de lote secuencial para esta orden.         Ejemplo:
...
## Knowledge Gaps
- **1872 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1867 more)
...
- **Are the 85 inferred relationships involving `ProductoFactory` (e.g. with `AreaViewSetTestCase` and `ChemicalViewSetTestCase`) actually correct?**
  _`ProductoFactory` has 85 INFERRED edges - model-reasoned connections that need verification._
