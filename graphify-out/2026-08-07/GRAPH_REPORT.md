...
## Corpus Check
- 577 files · ~774,708 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6778 nodes · 17365 edges · 414 communities (344 shown, 70 thin omitted)
...
## Communities (414 total, 70 thin omitted)

### Community 0 - "Producto"
Cohesion: 0.02
Nodes (174): react, TransformationView(), OrdenDetalleSheetProps, LayoutProps, useAuthMock, AccordionContent(), AccordionItem(), AccordionTrigger() (+166 more)

### Community 1 - "Maquina"
Cohesion: 0.04
Nodes (101): StockItem, CALIDAD_OPTIONS, Filtros, FILTROS_INICIALES, PackagingFormValues, packagingSchema, CALIDAD_OPTIONS, MENSAJE_POR_RESULTADO (+93 more)

### Community 2 - "OrdenProduccion"
Cohesion: 0.06
Nodes (80): AreaProcessStep, ComponenteMezclaOP, ConsumoLoteDetalle, DescargaQuimicoOP, EtapaProduccion, LineaProduccion, OrdenProduccionSubproceso, ParoMaquina (+72 more)

### Community 3 - "Bodega"
Cohesion: 0.12
Nodes (62): ApprovalRequests(), Group, InventoryDashboard(), StockItem, ManageBodegas(), ManageProductos(), ManageProveedoresProps, ManageQuimicos() (+54 more)
...
Cohesion: 0.06
Nodes (28): Bodega, Transfiere un lote terminado entre áreas (con lote) + registra TransferenciaInte, Decimal, Artefacto RUP: Módulo de Servicio Caso de Uso: CU-DescargaQuimicaAutomatica Patr, Template Method: paso de reversión dentro de ajustar_descarga_op.         Se usa, Verifica si el stock ha caído por debajo del mínimo.         Emite warning en lo, Ajusta stock de salida/entrada/químicos cuando el peso neto de un lote cambia., HistorialDespacho (+20 more)

### Community 7 - "BodegaFactory"
Cohesion: 0.07
Nodes (34): Configuración centralizada del printing_service. Elimina dependencias de cwd (fr, build_print_record(), get_audit_repo(), AuditRepository de printing_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye PrintAuditLog. SRP: separa construcción de persiste, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., generate_etiqueta_pdf(), generate_nota_venta_pdf() (+26 more)
...
Cohesion: 0.18
Nodes (6): HasScope, BasePermission, Permisos para la API interna. ISP: una clase por responsabilidad de permiso. COB, Verifica que el ServicePrincipal tiene el scope requerido.     Uso: permission_c, HasScopeTestCase, Pruebas de internal_api/permissions.py — IsInternalService y HasScope.  Técnicas
...
Cohesion: 0.09
Nodes (12): Ingreso directo de stock con Kardex (COMPRA) para químicos/insumos., Un OrdenProduccionSubproceso por cada AreaProcessStep del área (estado pendiente, Replica las transiciones del OrdenProduccionSubprocesoViewSet., Crea el despacho (HistorialDespacho + detalles + MovimientoInventario VENTA)., El tintorero crea la FormulaColor (en_pruebas -> aprobada) que usará la OP., jefe_planta crea las OPs; jefe_area asigna máquina + operario y genera subproces, Transfiere el lote terminado de Salida Tintura a Producto Terminado (Empaque)., El empaquetado completa los subprocesos y empaca el lote (etiqueta lista). (+4 more)

### Community 15 - "LoteProduccionFactory"
Cohesion: 0.06
Nodes (18): Devuelve un dict con los pasos de transformación, mermas y el enlace a la, Encadena con la OP de la siguiente área vía TransferenciaInterarea.          Cor, OrdenProduccionFactory, TestCase, Tests de OrdenProduccion — máquina de estados. Aplica técnica ISTQB: State Trans, ISTQB STT — Transiciones legales en la máquina de estados., El modelo actual permite pendiente → finalizada (no tiene validación de estado)., Tests de creación de OrdenProduccion con validaciones de campos. (+10 more)

### Community 16 - "ProductoFactory"
Cohesion: 0.04
Nodes (88): BaseAuthentication, Bodega, OrdenProduccion, Producto, Genera el siguiente código de lote secuencial para esta orden.         Ejemplo:, Configuración de ambiente para tests de descarga de químicos., _crear_lote(), _crear_orden() (+80 more)
...
Cohesion: 0.02
Nodes (114): fakeBlob, mockBodegas, mockProductos, navigateToReportes(), renderDashboard(), toastErrorMock, toastSuccessMock, mockBodegas (+106 more)
...
Cohesion: 0.03
Nodes (24): BodegaFactory, StockBodegaFactory, DescargaQuimicosValidacionesTestCase, TestCase, Pruebas de validaciones de entrada de DescargaQuimicosService.descargar_para_op, LoteProduccionViewSetTestCase, MovimientoMermaCreateTestCase, TestCase (+16 more)
...
Cohesion: 0.20
Nodes (6): Request, Identidad de un microservicio autenticado. Inmutable post-creación., ServicePrincipal, IsInternalServiceOrUser, BasePermission, ISO 27001 A.9.4 / COBIT DSS06:     Permite acceso tanto a microservicios autoriz

### Community 25 - ".calcular_costo"
Cohesion: 0.07
Nodes (32): build_scan_record(), get_audit_repo(), AuditRepository de scanning_service: persiste eventos de auditoría en SQLite. DI, Factory function — construye ScanAuditLog desde los datos del dominio.     SRP:, Dependency provider para FastAPI Depends. DIP: el router no construye el repo., AuditRepository, BackgroundTasks, Router HTTP para validación de lotes. DIP: get_validation_service y get_audit_re (+24 more)
...
Cohesion: 0.15
Nodes (6): MovimientoInventarioUpdateSerializer, Serializer para actualizar movimientos de inventario.     Solo permite editar ca, MovimientoUpdateSerializerTestCase, TestCase, TransferenciaSerializerTestCase, Permite editar un movimiento de inventario existente.         Solo se permiten e
...
Cohesion: 0.03
Nodes (49): DjangoModelFactory, EventoEtiqueta, Registro inmutable del ciclo de vida de cada etiqueta física impresa para un lot, Template Method: secuencia fija revertir → descargar.         Se usa al modifica, SRP: solo ejecuta descarga inicial. Cálculo delegado a DosificacionCalculator., DetalleFormulaFactory, EventoEtiquetaFactory, FaseRecetaFactory (+41 more)
...
Cohesion: 0.05
Nodes (41): AREA_1, AREA_3, BODEGA_1, BODEGA_3, CLIENTE_1, crearSedeSinSeleccionarla(), FORMULA_1, GROUP_1 (+33 more)

### Community 44 - "ExecutiveKPIService"
Cohesion: 0.04
Nodes (63): Command, BaseCommand, Elimina toda la población de datos creada para pruebas (stress_test_data y seed_, Command, BaseCommand, Seed de SIMULACIÓN INTEGRAL de TexCore.  Puebla la base con un caso coherente en, Migration, CostoHoraMaquina (+55 more)
...
Cohesion: 0.15
Nodes (6): Registra la recepción de un lote de materia prima del proveedor.          Crea e, EP inválida: costo < 0 → ValidationError., EP duplicado: mismo (proveedor, lote, fecha) viola unique_together., Si el movimiento de Kardex falla, ni MP ni stock persisten., EP válida: crea MP, suma stock y registra movimiento COMPRA., BVA límite: cantidad == 0 → ValidationError, nada persiste.

### Community 52 - ".get"
Cohesion: 0.04
Nodes (25): Continuidad de cadena: entrada = salida de la transformación previa., Registra una transformación en la OP.          El ``producto_entrada`` NO se con, AreaFactory, MaquinaFactory, AreaViewSetTestCase, CustomUserViewSetTestCase, TestCase, Pruebas de gestion/views/core_views.py — SedeViewSet, AreaViewSet, CustomUserVie (+17 more)

### Community 53 - "main.py"
Cohesion: 0.07
Nodes (11): Revierte un pago deshaciendo el abono registrado.          Validaciones:, Caso 2: Reversión sin justificación falla          Verifica:         - ValueErro, Caso 3: Reversión correcta con múltiples pagos          Verifica:         - Múlt, Caso 4: Reversión es transaccional          Verifica:         - Si falla un paso, Caso 1: Revertir pago restaura deuda del cliente          Verifica:         - De, STT: pedido1 ANULADO (1000) + pedido2 activo (500); pago de 500.         El pago, P0-005: pago + reconciliación en una sola transacción, con lock         pesimist, Artefacto RUP: Eliminación de Pago con Reversión         Caso de Uso: CU-Reversi (+3 more)
...
### Community 59 - "_audit"
Cohesion: 0.04
Nodes (30): ClienteFactory, SedeFactory, TestCase, Tests de Cliente — límite de crédito. Aplica técnicas ISTQB:   - Partición de Eq, ISTQB EP — Clases de equivalencia para limite_credito:       Válida:   limite_cr, BVA: valor mínimo exacto del límite., EP Clase Válida: cualquier valor positivo., BVA: valor alto permitido por el campo (max_digits=12, decimal_places=3). (+22 more)
...
Cohesion: 0.09
Nodes (17): Command, BaseCommand, Registra las credenciales de los microservicios en la BD (ServiceCredential). De, Command, BaseCommand, Management command: crea ServiceCredentials para los microservicios si no existe, Meta, ServiceCredential: identidad de un microservicio autorizado. ISO 27001 A.9.2 — G (+9 more)

### Community 79 - "AreaNombreValidatorTestCase"
Cohesion: 0.08
Nodes (15): Emite log estructurado para trazabilidad ISO 27001 A.12.4.          Args:, AuditLoggerTestCase, TestCase, Pruebas de internal_api/audit.py — AuditLogger.log.  Técnicas ISTQB aplicadas: -, _audit(), _build_balance_masas_payload(), _build_reporte_avance_payload(), _now_iso() (+7 more)

### Community 80 - "auth_views.py"
Cohesion: 0.06
Nodes (18): Decimal, Revierte todos los ConsumoLoteDetalle de un lote_output., ComponenteMezclaOPFactory, ConsumoLoteDetalleFactory, ConsumoMezclaServiceConsumir, ConsumoMezclaServiceRevertir, TestCase, TDD — ConsumoMezclaService. COBIT DSS06 + ISO 27001 A.12.4. (+10 more)
...
Cohesion: 0.03
Nodes (35): CustomUserFactory, ProveedorFactory, AreaViewSetTestCase, ChemicalViewSetTestCase, ChemicalViewSetExtraTestCase, ProductoViewSetMultiTenancyTestCase, ProveedorViewSetMultiTenancyTestCase, TestCase (+27 more)
...
Cohesion: 0.11
Nodes (4): Revierte un despacho con justificación obligatoria.         HTTP 400 si falta ju, Endpoint explícito para revertir despacho.         Alternativa POST amigable a D, Revierte el efecto de stock del movimiento (vía MovimientoReversionService), Compara requerimientos de los pedidos contra stock de los lotes escaneados.
...
Cohesion: 0.13
Nodes (11): OP-SIM-001 finalizada: abastecimiento, descarga química, avance, transformación,, FASE 3: el material llega — sale de la bodega de tránsito y entra         a la b, TestCase, EP justificación vacía → ValidationError (auditoría obligatoria)., Compatibilidad: un movimiento creado sin protocolo queda 'completado'., FASE 1+2: origen 100→70, tránsito 0→30, estado en_transito., EP insuficiente: 150 > 100 disponibles → error, nada cambia., FASE 3: tránsito 30→0, destino 0→30, estado completado (sin duplicar). (+3 more)

### Community 99 - "TestJWTTokenManager"
Cohesion: 0.10
Nodes (20): Base, get_session_factory(), _make_session_factory(), async_sessionmaker, AsyncSession, DeclarativeBase, Módulo de infraestructura de base de datos de auditoría — reporting_excel. SRP:, DIP: los repositorios solicitan la fábrica; no importan el global directamente. (+12 more)
...
Cohesion: 0.19
Nodes (7): _get_required_env(), Obtiene una variable de entorno requerida. Falla si no existe (Fail-Fast)., Valida que el path del reporte sea seguro.     Previene Path Traversal y acceso, _validate_report_path(), GetRequiredEnvTestCase, TestCase, ValidateReportPathTestCase
...
Cohesion: 0.32
Nodes (4): date, Decimal, Endpoint dedicado para la tendencia de 30 días (usado independientemente)., Genera la serie temporal completa (incluyendo días sin producción = 0)         p
...
Cohesion: 0.17
Nodes (10): AuditMiddleware, get_cascade_justification(), get_current_ip(), Middleware para capturar la IP y el usuario de la petición actual,     guardándo, AuditMiddlewareCallTestCase, CascadeJustificationTestCase, TestCase, Pruebas del middleware de auditoría — gestion/middleware.py.  Foco de seguridad: (+2 more)
...
Cohesion: 0.08
Nodes (11): clear_cascade_justification(), Justificación para borrados en cascada (ej. DetalleFormula al borrar FormulaColo, set_cascade_justification(), make_group_permission(), Permisos de acceso para TexCore.  Usa make_group_permission() para eliminar la d, Factory para crear clases de permiso basadas en grupos de Django.      Otorga ac, ProductoSerializer, ChemicalViewSet (+3 more)
...
Cohesion: 0.06
Nodes (19): Tarifa vigente a la fecha; vigente_hasta NULL = contrato abierto., Costo/hora vigente a la fecha; vigente_hasta NULL = sin fecha fin., LoteProduccion, Registra el consumo de uno o más lotes de MP en un lote producido.          cons, Operario $10/h y máquina $5/h; 2 horas → $20 + $10., STT: MP $500 + químicos $100 + operario $20 + máquina $10 = $630., EP sin catálogo de tarifas: operario y máquina quedan en 0., BVA: tarifa con vigente_hasta NULL (contrato abierto) SÍ aplica. (+11 more)
...
Cohesion: 0.15
Nodes (5): JWTServiceAuthentication: valida JWT RS256 de microservicios. ISO 27001 A.9.4 —, Genera un JWT RS256 firmado para autenticación entre servicios.         ISO 2700, JWTServiceAuthenticationExtraTestCase, TestCase, Pruebas complementarias de internal_api/authentication.py — ramas que test_authe
...
Cohesion: 0.16
Nodes (7): ProduccionKPIService, Calcula KPIs de producción filtrados opcionalmente por sede.      Uso:         s, Punto de entrada único — Fachada sobre los métodos privados., ProduccionKPIServiceTendenciaTest, ProduccionKPIServiceTest, SimpleTestCase, TestCase
...
Cohesion: 0.11
Nodes (22): DetalleHistorialDespachoAdmin, DetalleHistorialDespachoInline, HistorialDespachoAdmin, MovimientoInventarioAdmin, StockBodegaAdmin, DetalleHistorialDespacho, HistorialDespacho, MovimientoInventario (+14 more)
...
Cohesion: 0.20
Nodes (11): _get_object_sede_id(), Obtiene sede_id del objeto para filtrar logs de entidades eliminadas.     Priori, audit_user_delete(), audit_user_save(), _get_pending_skip(), _get_user_audit_data(), _mark_created_and_skip_next_update(), Registra eliminación de usuarios en auditoría. (+3 more)
...
Cohesion: 0.02
Nodes (120): AbstractUser, apply_movement(), Command, get_stock(), BaseCommand, Pobla la base de datos con datos de estrés para pruebas. Simula 1 mes de uso del, Obtiene el stock actual de un producto en una bodega., Actualiza la cantidad de un StockBodega. (+112 more)
...
Cohesion: 0.07
Nodes (16): AreaSerializer, CustomUserSerializer, GroupSerializer, Ejecutivos tienen acceso a todo el dashboard de stock: asignar todas las bodegas, SedeSerializer, AreaNombreValidatorTestCase, DosificacionSerializerTestCase, TestCase (+8 more)
...
Cohesion: 0.08
Nodes (66): BodegaAdmin, BodegueroInline, CustomUserAdmin, LineaProduccionAdmin, TransformacionProductoAdmin, Command, BaseCommand, Area (+58 more)
...
## Knowledge Gaps
- **1579 isolated node(s):** `name`, `version`, `private`, `@hookform/resolvers`, `@radix-ui/react-accordion` (+1574 more)
...
- **Why does `CustomUserFactory` connect `_fecha_a_texto` to `0032_ventas_sp_include_full_fecha_fin.py`, `ManageOrdenesProduccion.tsx`, `NotaVentaRequest`, `CustomUserFactory`, `LoteProduccionFactory`, `pdf.py`, `reporting_views.py`, `axios.ts`, `DescargaQuimicosStockInsuficienteTestCase`, `logger.ts`, `AuditRepository`, `0068_materia_prima_trazabilidad.py`, `.get`, `custom_jwt_views.py`, `_audit`, `auth_views.py`, `react-router-dom`, `0003_producto_calidad_producto_pais_origen_and_more.py`, `TestServiceTokenView`, `development`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `PedidoVenta` connect `0068_materia_prima_trazabilidad.py` to `OrdenProduccion`, `ManageOrdenesProduccion.tsx`, `dataframe_to_excel_bytes`, `LoteProduccion`, `AdminSistemasDashboard.tsx`, `ProductoFactory`, `DescargaQuimicosStockInsuficienteTestCase`, `logger.ts`, `OrdenProduccionFactory`, `AuditRepository`, `ExecutiveKPIService`, `.genealogia`, `test_views_extra.py`, `_audit`, `ReportingProxyRBACtest`, `FrontendLogViewTestCase`, `MateriaPrimaRegistroTestCase`, `0003_producto_calidad_producto_pais_origen_and_more.py`, `navigation-menu.tsx`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `LoteProduccion` connect `ExecutiveKPIService` to `OrdenProduccion`, `ManageOrdenesProduccion.tsx`, `dataframe_to_excel_bytes`, `AuditLog`, `LoteProduccion`, `AdminSistemasDashboard.tsx`, `LoteProduccionFactory`, `ProductoFactory`, `cn`, `reporting_views.py`, `KardexSerializer`, `EjecutivosDashboard.tsx`, `axios.ts`, `compilerOptions`, `logger.ts`, `0068_materia_prima_trazabilidad.py`, `embla-carousel-react`, `.genealogia`, `test_views_extra.py`, `@radix-ui/react-dropdown-menu`, `react-hook-form`, `ReportingProxyRBACtest`, `test_audit_middleware.py`, `MateriaPrimaRegistroTestCase`, `0003_producto_calidad_producto_pais_origen_and_more.py`, `development`?**
