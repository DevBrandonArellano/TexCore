...
print_cyan "Superusuario:"
echo " - Usuario:    el definido en DJANGO_SUPERUSER_USERNAME en .env (por defecto: sistemas)"
print_yellow " - Contraseña: la definida en DJANGO_SUPERUSER_PASSWORD en .env."
print_yellow "   Si no la definiste, create_admin generó una aleatoria — revisa el log del paso anterior, no se vuelve a mostrar."
print_green "======================================================================"
