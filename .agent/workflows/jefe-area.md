---
description: Gestión de maquinaria y supervisión técnica.
---

1.  **Dashboard de Control**: Monitorear el estado de cada máquina (Operativa, Mantenimiento, Inactiva) y su carga de trabajo actual.
