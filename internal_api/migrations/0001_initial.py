    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Nombre único del servicio (ej: scanning_service)', max_length=100, unique=True)),
                ('secret_hash', models.CharField(help_text='Hash bcrypt del secret del servicio', max_length=255)),
